...
# Source files:
#     C:/Users/kauder/Documents/installer/Github/playground/nim/nim-webgl-example/node_modules/typescript/lib/lib.d.ts
#     src/tsGlue.ts
...
proc splice*(self: Array, start: float, deleteCount: float, items: Array) : Array {.importcpp.}
...
proc indexOf*(self: String, searchString: cstring, position: float) : float {.importcpp.}
proc lastIndexOf*(self: String, searchString: cstring, position: float) : float {.importcpp.}
...
proc replace*(self: String, searchValue: cstring, replaceValue: cstring) : cstring {.importcpp.}
proc replace*(self: String, searchValue: RegExp, replaceValue: cstring) : cstring {.importcpp.}
...
var NumberNEGATIVE_INFINITY* {.importc:"Number.NEGATIVE_INFINITY", nodecl.}: float
var NumberPOSITIVE_INFINITY* {.importc:"Number.POSITIVE_INFINITY", nodecl.}: float
...
proc newDate*(year: float, month: float, date: float, hours: float, minutes: float, seconds: float, ms: float) : Date {.importcpp:"new Date(@)".}
...
proc setMinutes*(self: Date, min: float, sec: float, ms: float) : float {.importcpp.}
proc setUTCMinutes*(self: Date, min: float, sec: float, ms: float) : float {.importcpp.}
proc setHours*(self: Date, hours: float, min: float, sec: float, ms: float) : float {.importcpp.}
proc setUTCHours*(self: Date, hours: float, min: float, sec: float, ms: float) : float {.importcpp.}
...
proc setFullYear*(self: Date, year: float, month: float, date: float) : float {.importcpp.}
proc setUTCFullYear*(self: Date, year: float, month: float, date: float) : float {.importcpp.}
...
proc DateUTC*(year: float, month: float, date: float, hours: float, minutes: float, seconds: float, ms: float) : float {.importc:"Date.UTC".}
...
proc slice*(self: ArrayBuffer, begin: float, xEnd: float) : ArrayBuffer {.importcpp.}
...
type DataView* {.importc.} = ref object of RootObj
    ...
    byteLength* {.importc.}: float
    byteOffset* {.importc.}: float
proc newDataView*(buffer: ArrayBuffer, byteOffset: float, byteLength: float) : DataView {.importcpp:"new DataView(@)".}
proc getFloat32*(self: DataView, byteOffset: float, littleEndian: bool) : float {.importcpp.}
proc getFloat64*(self: DataView, byteOffset: float, littleEndian: bool) : float {.importcpp.}
proc getInt8*(self: DataView, byteOffset: float) : float {.importcpp.}
proc getInt16*(self: DataView, byteOffset: float, littleEndian: bool) : float {.importcpp.}
proc getInt32*(self: DataView, byteOffset: float, littleEndian: bool) : float {.importcpp.}
proc getUint8*(self: DataView, byteOffset: float) : float {.importcpp.}
proc getUint16*(self: DataView, byteOffset: float, littleEndian: bool) : float {.importcpp.}
proc getUint32*(self: DataView, byteOffset: float, littleEndian: bool) : float {.importcpp.}
proc setFloat32*(self: DataView, byteOffset: float, value: float, littleEndian: bool) : void {.importcpp.}
proc setFloat64*(self: DataView, byteOffset: float, value: float, littleEndian: bool) : void {.importcpp.}
proc setInt8*(self: DataView, byteOffset: float, value: float) : void {.importcpp.}
proc setInt16*(self: DataView, byteOffset: float, value: float, littleEndian: bool) : void {.importcpp.}
proc setInt32*(self: DataView, byteOffset: float, value: float, littleEndian: bool) : void {.importcpp.}
proc setUint8*(self: DataView, byteOffset: float, value: float) : void {.importcpp.}
proc setUint16*(self: DataView, byteOffset: float, value: float, littleEndian: bool) : void {.importcpp.}
proc setUint32*(self: DataView, byteOffset: float, value: float, littleEndian: bool) : void {.importcpp.}
...
proc newInt8Array*(buffer: ArrayBuffer, byteOffset: float, length: float) : Int8Array {.importcpp:"new Int8Array(@)".}
proc copyWithin*(self: Int8Array, target: float, start: float, xEnd: float) : Int8Array {.importcpp.}
proc fill*(self: Int8Array, value: float, start: float, xEnd: float) : Int8Array {.importcpp.}
proc indexOf*(self: Int8Array, searchElement: float, fromIndex: float) : float {.importcpp.}
proc join*(self: Int8Array, separator: cstring) : cstring {.importcpp.}
proc lastIndexOf*(self: Int8Array, searchElement: float, fromIndex: float) : float {.importcpp.}
proc reduce*(self: Int8Array, callbackfn: proc (previousValue: float, currentValue: float, currentIndex: float, array: Int8Array) : float, initialValue: float) : float {.importcpp.}
proc reduceRight*(self: Int8Array, callbackfn: proc (previousValue: float, currentValue: float, currentIndex: float, array: Int8Array) : float, initialValue: float) : float {.importcpp.}
...
proc sort*(self: Int8Array, compareFn: proc (a: float, b: float) : float) : Int8Array {.importcpp.}
proc subarray*(self: Int8Array, begin: float, xEnd: float) : Int8Array {.importcpp.}
proc toLocaleString*(self: Int8Array) : cstring {.importcpp.}
proc toString*(self: Int8Array) : cstring {.importcpp.}
var Int8ArrayBYTES_PER_ELEMENT* {.importc:"Int8Array.BYTES_PER_ELEMENT", nodecl.}: float
...
proc newUint8Array*(buffer: ArrayBuffer, byteOffset: float, length: float) : Uint8Array {.importcpp:"new Uint8Array(@)".}
proc copyWithin*(self: Uint8Array, target: float, start: float, xEnd: float) : Uint8Array {.importcpp.}
proc fill*(self: Uint8Array, value: float, start: float, xEnd: float) : Uint8Array {.importcpp.}
proc indexOf*(self: Uint8Array, searchElement: float, fromIndex: float) : float {.importcpp.}
proc join*(self: Uint8Array, separator: cstring) : cstring {.importcpp.}
proc lastIndexOf*(self: Uint8Array, searchElement: float, fromIndex: float) : float {.importcpp.}
proc reduce*(self: Uint8Array, callbackfn: proc (previousValue: float, currentValue: float, currentIndex: float, array: Uint8Array) : float, initialValue: float) : float {.importcpp.}
proc reduceRight*(self: Uint8Array, callbackfn: proc (previousValue: float, currentValue: float, currentIndex: float, array: Uint8Array) : float, initialValue: float) : float {.importcpp.}
proc reverse*(self: Uint8Array) : Uint8Array {.importcpp.}
proc set*(self: Uint8Array, index: float, value: float) : void {.importcpp.}
proc slice*(self: Uint8Array, start: float, xEnd: float) : Uint8Array {.importcpp.}
proc sort*(self: Uint8Array, compareFn: proc (a: float, b: float) : float) : Uint8Array {.importcpp.}
proc subarray*(self: Uint8Array, begin: float, xEnd: float) : Uint8Array {.importcpp.}
proc toLocaleString*(self: Uint8Array) : cstring {.importcpp.}
proc toString*(self: Uint8Array) : cstring {.importcpp.}
var Uint8ArrayBYTES_PER_ELEMENT* {.importc:"Uint8Array.BYTES_PER_ELEMENT", nodecl.}: float
...
proc newUint8ClampedArray*(buffer: ArrayBuffer, byteOffset: float, length: float) : Uint8ClampedArray {.importcpp:"new Uint8ClampedArray(@)".}
proc copyWithin*(self: Uint8ClampedArray, target: float, start: float, xEnd: float) : Uint8ClampedArray {.importcpp.}
proc fill*(self: Uint8ClampedArray, value: float, start: float, xEnd: float) : Uint8ClampedArray {.importcpp.}
proc indexOf*(self: Uint8ClampedArray, searchElement: float, fromIndex: float) : float {.importcpp.}
proc join*(self: Uint8ClampedArray, separator: cstring) : cstring {.importcpp.}
proc lastIndexOf*(self: Uint8ClampedArray, searchElement: float, fromIndex: float) : float {.importcpp.}
proc reduce*(self: Uint8ClampedArray, callbackfn: proc (previousValue: float, currentValue: float, currentIndex: float, array: Uint8ClampedArray) : float, initialValue: float) : float {.importcpp.}
proc reduceRight*(self: Uint8ClampedArray, callbackfn: proc (previousValue: float, currentValue: float, currentIndex: float, array: Uint8ClampedArray) : float, initialValue: float) : float {.importcpp.}
proc reverse*(self: Uint8ClampedArray) : Uint8ClampedArray {.importcpp.}
proc set*(self: Uint8ClampedArray, index: float, value: float) : void {.importcpp.}
proc set*(self: Uint8ClampedArray, array: Uint8ClampedArray, offset: float) : void {.importcpp.}
proc slice*(self: Uint8ClampedArray, start: float, xEnd: float) : Uint8ClampedArray {.importcpp.}
proc sort*(self: Uint8ClampedArray, compareFn: proc (a: float, b: float) : float) : Uint8ClampedArray {.importcpp.}
proc subarray*(self: Uint8ClampedArray, begin: float, xEnd: float) : Uint8ClampedArray {.importcpp.}
proc toLocaleString*(self: Uint8ClampedArray) : cstring {.importcpp.}
proc toString*(self: Uint8ClampedArray) : cstring {.importcpp.}
var Uint8ClampedArrayBYTES_PER_ELEMENT* {.importc:"Uint8ClampedArray.BYTES_PER_ELEMENT", nodecl.}: float
...
proc newInt16Array*(buffer: ArrayBuffer, byteOffset: float, length: float) : Int16Array {.importcpp:"new Int16Array(@)".}
proc copyWithin*(self: Int16Array, target: float, start: float, xEnd: float) : Int16Array {.importcpp.}
proc fill*(self: Int16Array, value: float, start: float, xEnd: float) : Int16Array {.importcpp.}
proc indexOf*(self: Int16Array, searchElement: float, fromIndex: float) : float {.importcpp.}
proc join*(self: Int16Array, separator: cstring) : cstring {.importcpp.}
proc lastIndexOf*(self: Int16Array, searchElement: float, fromIndex: float) : float {.importcpp.}
proc reduce*(self: Int16Array, callbackfn: proc (previousValue: float, currentValue: float, currentIndex: float, array: Int16Array) : float, initialValue: float) : float {.importcpp.}
proc reduceRight*(self: Int16Array, callbackfn: proc (previousValue: float, currentValue: float, currentIndex: float, array: Int16Array) : float, initialValue: float) : float {.importcpp.}
proc reverse*(self: Int16Array) : Int16Array {.importcpp.}
proc set*(self: Int16Array, index: float, value: float) : void {.importcpp.}
proc slice*(self: Int16Array, start: float, xEnd: float) : Int16Array {.importcpp.}
proc sort*(self: Int16Array, compareFn: proc (a: float, b: float) : float) : Int16Array {.importcpp.}
proc subarray*(self: Int16Array, begin: float, xEnd: float) : Int16Array {.importcpp.}
proc toLocaleString*(self: Int16Array) : cstring {.importcpp.}
proc toString*(self: Int16Array) : cstring {.importcpp.}
var Int16ArrayBYTES_PER_ELEMENT* {.importc:"Int16Array.BYTES_PER_ELEMENT", nodecl.}: float
...
proc newUint16Array*(buffer: ArrayBuffer, byteOffset: float, length: float) : Uint16Array {.importcpp:"new Uint16Array(@)".}
proc copyWithin*(self: Uint16Array, target: float, start: float, xEnd: float) : Uint16Array {.importcpp.}
proc fill*(self: Uint16Array, value: float, start: float, xEnd: float) : Uint16Array {.importcpp.}
proc indexOf*(self: Uint16Array, searchElement: float, fromIndex: float) : float {.importcpp.}
proc join*(self: Uint16Array, separator: cstring) : cstring {.importcpp.}
proc lastIndexOf*(self: Uint16Array, searchElement: float, fromIndex: float) : float {.importcpp.}
proc reduce*(self: Uint16Array, callbackfn: proc (previousValue: float, currentValue: float, currentIndex: float, array: Uint16Array) : float, initialValue: float) : float {.importcpp.}
proc reduceRight*(self: Uint16Array, callbackfn: proc (previousValue: float, currentValue: float, currentIndex: float, array: Uint16Array) : float, initialValue: float) : float {.importcpp.}
proc reverse*(self: Uint16Array) : Uint16Array {.importcpp.}
proc set*(self: Uint16Array, index: float, value: float) : void {.importcpp.}
proc slice*(self: Uint16Array, start: float, xEnd: float) : Uint16Array {.importcpp.}
proc sort*(self: Uint16Array, compareFn: proc (a: float, b: float) : float) : Uint16Array {.importcpp.}
proc subarray*(self: Uint16Array, begin: float, xEnd: float) : Uint16Array {.importcpp.}
proc toLocaleString*(self: Uint16Array) : cstring {.importcpp.}
proc toString*(self: Uint16Array) : cstring {.importcpp.}
var Uint16ArrayBYTES_PER_ELEMENT* {.importc:"Uint16Array.BYTES_PER_ELEMENT", nodecl.}: float
...
proc newInt32Array*(buffer: ArrayBuffer, byteOffset: float, length: float) : Int32Array {.importcpp:"new Int32Array(@)".}
proc copyWithin*(self: Int32Array, target: float, start: float, xEnd: float) : Int32Array {.importcpp.}
proc fill*(self: Int32Array, value: float, start: float, xEnd: float) : Int32Array {.importcpp.}
proc indexOf*(self: Int32Array, searchElement: float, fromIndex: float) : float {.importcpp.}
proc join*(self: Int32Array, separator: cstring) : cstring {.importcpp.}
proc lastIndexOf*(self: Int32Array, searchElement: float, fromIndex: float) : float {.importcpp.}
proc reduce*(self: Int32Array, callbackfn: proc (previousValue: float, currentValue: float, currentIndex: float, array: Int32Array) : float, initialValue: float) : float {.importcpp.}
proc reduceRight*(self: Int32Array, callbackfn: proc (previousValue: float, currentValue: float, currentIndex: float, array: Int32Array) : float, initialValue: float) : float {.importcpp.}
proc reverse*(self: Int32Array) : Int32Array {.importcpp.}
proc set*(self: Int32Array, index: float, value: float) : void {.importcpp.}
proc slice*(self: Int32Array, start: float, xEnd: float) : Int32Array {.importcpp.}
proc sort*(self: Int32Array, compareFn: proc (a: float, b: float) : float) : Int32Array {.importcpp.}
proc subarray*(self: Int32Array, begin: float, xEnd: float) : Int32Array {.importcpp.}
proc toLocaleString*(self: Int32Array) : cstring {.importcpp.}
proc toString*(self: Int32Array) : cstring {.importcpp.}
var Int32ArrayBYTES_PER_ELEMENT* {.importc:"Int32Array.BYTES_PER_ELEMENT", nodecl.}: float
...
proc newUint32Array*(buffer: ArrayBuffer, byteOffset: float, length: float) : Uint32Array {.importcpp:"new Uint32Array(@)".}
proc copyWithin*(self: Uint32Array, target: float, start: float, xEnd: float) : Uint32Array {.importcpp.}
proc fill*(self: Uint32Array, value: float, start: float, xEnd: float) : Uint32Array {.importcpp.}
proc indexOf*(self: Uint32Array, searchElement: float, fromIndex: float) : float {.importcpp.}
proc join*(self: Uint32Array, separator: cstring) : cstring {.importcpp.}
proc lastIndexOf*(self: Uint32Array, searchElement: float, fromIndex: float) : float {.importcpp.}
proc reduce*(self: Uint32Array, callbackfn: proc (previousValue: float, currentValue: float, currentIndex: float, array: Uint32Array) : float, initialValue: float) : float {.importcpp.}
proc reduceRight*(self: Uint32Array, callbackfn: proc (previousValue: float, currentValue: float, currentIndex: float, array: Uint32Array) : float, initialValue: float) : float {.importcpp.}
proc reverse*(self: Uint32Array) : Uint32Array {.importcpp.}
proc set*(self: Uint32Array, index: float, value: float) : void {.importcpp.}
proc slice*(self: Uint32Array, start: float, xEnd: float) : Uint32Array {.importcpp.}
proc sort*(self: Uint32Array, compareFn: proc (a: float, b: float) : float) : Uint32Array {.importcpp.}
proc subarray*(self: Uint32Array, begin: float, xEnd: float) : Uint32Array {.importcpp.}
proc toLocaleString*(self: Uint32Array) : cstring {.importcpp.}
proc toString*(self: Uint32Array) : cstring {.importcpp.}
var Uint32ArrayBYTES_PER_ELEMENT* {.importc:"Uint32Array.BYTES_PER_ELEMENT", nodecl.}: float
...
proc newFloat32Array*(buffer: ArrayBuffer, byteOffset: float, length: float) : Float32Array {.importcpp:"new Float32Array(@)".}
proc copyWithin*(self: Float32Array, target: float, start: float, xEnd: float) : Float32Array {.importcpp.}
proc fill*(self: Float32Array, value: float, start: float, xEnd: float) : Float32Array {.importcpp.}
proc indexOf*(self: Float32Array, searchElement: float, fromIndex: float) : float {.importcpp.}
proc join*(self: Float32Array, separator: cstring) : cstring {.importcpp.}
proc lastIndexOf*(self: Float32Array, searchElement: float, fromIndex: float) : float {.importcpp.}
proc reduce*(self: Float32Array, callbackfn: proc (previousValue: float, currentValue: float, currentIndex: float, array: Float32Array) : float, initialValue: float) : float {.importcpp.}
proc reduceRight*(self: Float32Array, callbackfn: proc (previousValue: float, currentValue: float, currentIndex: float, array: Float32Array) : float, initialValue: float) : float {.importcpp.}
proc reverse*(self: Float32Array) : Float32Array {.importcpp.}
proc set*(self: Float32Array, index: float, value: float) : void {.importcpp.}
proc slice*(self: Float32Array, start: float, xEnd: float) : Float32Array {.importcpp.}
proc sort*(self: Float32Array, compareFn: proc (a: float, b: float) : float) : Float32Array {.importcpp.}
proc subarray*(self: Float32Array, begin: float, xEnd: float) : Float32Array {.importcpp.}
proc toLocaleString*(self: Float32Array) : cstring {.importcpp.}
proc toString*(self: Float32Array) : cstring {.importcpp.}
var Float32ArrayBYTES_PER_ELEMENT* {.importc:"Float32Array.BYTES_PER_ELEMENT", nodecl.}: float
...
proc newFloat64Array*(buffer: ArrayBuffer, byteOffset: float, length: float) : Float64Array {.importcpp:"new Float64Array(@)".}
proc copyWithin*(self: Float64Array, target: float, start: float, xEnd: float) : Float64Array {.importcpp.}
proc fill*(self: Float64Array, value: float, start: float, xEnd: float) : Float64Array {.importcpp.}
proc indexOf*(self: Float64Array, searchElement: float, fromIndex: float) : float {.importcpp.}
proc join*(self: Float64Array, separator: cstring) : cstring {.importcpp.}
proc lastIndexOf*(self: Float64Array, searchElement: float, fromIndex: float) : float {.importcpp.}
proc reduce*(self: Float64Array, callbackfn: proc (previousValue: float, currentValue: float, currentIndex: float, array: Float64Array) : float, initialValue: float) : float {.importcpp.}
proc reduceRight*(self: Float64Array, callbackfn: proc (previousValue: float, currentValue: float, currentIndex: float, array: Float64Array) : float, initialValue: float) : float {.importcpp.}
proc reverse*(self: Float64Array) : Float64Array {.importcpp.}
proc set*(self: Float64Array, index: float, value: float) : void {.importcpp.}
proc slice*(self: Float64Array, start: float, xEnd: float) : Float64Array {.importcpp.}
proc sort*(self: Float64Array, compareFn: proc (a: float, b: float) : float) : Float64Array {.importcpp.}
proc subarray*(self: Float64Array, begin: float, xEnd: float) : Float64Array {.importcpp.}
proc toLocaleString*(self: Float64Array) : cstring {.importcpp.}
proc toString*(self: Float64Array) : cstring {.importcpp.}
var Float64ArrayBYTES_PER_ELEMENT* {.importc:"Float64Array.BYTES_PER_ELEMENT", nodecl.}: float
...
proc toggle*(self: DOMTokenList, token: cstring, force: bool) : bool {.importcpp.}
...
proc getPropertyPriority*(self: CSSStyleDeclaration, propertyName: cstring) : cstring {.importcpp.}
proc getPropertyValue*(self: CSSStyleDeclaration, propertyName: cstring) : cstring {.importcpp.}
proc item*(self: CSSStyleDeclaration, index: float) : cstring {.importcpp.}
proc removeProperty*(self: CSSStyleDeclaration, propertyName: cstring) : cstring {.importcpp.}
proc setProperty*(self: CSSStyleDeclaration, propertyName: cstring, value: cstring, priority: cstring) : void {.importcpp.}
...
proc rotateFromVector*(self: SVGMatrix, x: float, y: float) : SVGMatrix {.importcpp.}
proc scale*(self: SVGMatrix, scaleFactor: float) : SVGMatrix {.importcpp.}
proc scaleNonUniform*(self: SVGMatrix, scaleFactorX: float, scaleFactorY: float) : SVGMatrix {.importcpp.}
...
proc convertToSpecifiedUnits*(self: SVGLength, unitType: float) : void {.importcpp.}
proc newValueSpecifiedUnits*(self: SVGLength, unitType: float, valueInSpecifiedUnits: float) : void {.importcpp.}
var SVGLengthUnitType* {.importc:"SVGLength.unitType", nodecl.}: float
var SVGLengthValue* {.importc:"SVGLength.value", nodecl.}: float
var SVGLengthValueAsString* {.importc:"SVGLength.valueAsString", nodecl.}: cstring
var SVGLengthValueInSpecifiedUnits* {.importc:"SVGLength.valueInSpecifiedUnits", nodecl.}: float
var SVGLengthSVG_LENGTHTYPE_CM* {.importc:"SVGLength.SVG_LENGTHTYPE_CM", nodecl.}: float
var SVGLengthSVG_LENGTHTYPE_EMS* {.importc:"SVGLength.SVG_LENGTHTYPE_EMS", nodecl.}: float
var SVGLengthSVG_LENGTHTYPE_EXS* {.importc:"SVGLength.SVG_LENGTHTYPE_EXS", nodecl.}: float
var SVGLengthSVG_LENGTHTYPE_IN* {.importc:"SVGLength.SVG_LENGTHTYPE_IN", nodecl.}: float
var SVGLengthSVG_LENGTHTYPE_MM* {.importc:"SVGLength.SVG_LENGTHTYPE_MM", nodecl.}: float
var SVGLengthSVG_LENGTHTYPE_NUMBER* {.importc:"SVGLength.SVG_LENGTHTYPE_NUMBER", nodecl.}: float
var SVGLengthSVG_LENGTHTYPE_PC* {.importc:"SVGLength.SVG_LENGTHTYPE_PC", nodecl.}: float
var SVGLengthSVG_LENGTHTYPE_PERCENTAGE* {.importc:"SVGLength.SVG_LENGTHTYPE_PERCENTAGE", nodecl.}: float
var SVGLengthSVG_LENGTHTYPE_PT* {.importc:"SVGLength.SVG_LENGTHTYPE_PT", nodecl.}: float
var SVGLengthSVG_LENGTHTYPE_PX* {.importc:"SVGLength.SVG_LENGTHTYPE_PX", nodecl.}: float
var SVGLengthSVG_LENGTHTYPE_UNKNOWN* {.importc:"SVGLength.SVG_LENGTHTYPE_UNKNOWN", nodecl.}: float
proc SVGLengthConvertToSpecifiedUnits*(unitType: float) : void {.importc:"SVGLength.convertToSpecifiedUnits".}
proc SVGLengthNewValueSpecifiedUnits*(unitType: float, valueInSpecifiedUnits: float) : void {.importc:"SVGLength.newValueSpecifiedUnits".}
...
proc convertToSpecifiedUnits*(self: SVGAngle, unitType: float) : void {.importcpp.}
proc newValueSpecifiedUnits*(self: SVGAngle, unitType: float, valueInSpecifiedUnits: float) : void {.importcpp.}
var SVGAngleSVG_ANGLETYPE_DEG* {.importc:"SVGAngle.SVG_ANGLETYPE_DEG", nodecl.}: float
var SVGAngleSVG_ANGLETYPE_GRAD* {.importc:"SVGAngle.SVG_ANGLETYPE_GRAD", nodecl.}: float
var SVGAngleSVG_ANGLETYPE_RAD* {.importc:"SVGAngle.SVG_ANGLETYPE_RAD", nodecl.}: float
var SVGAngleSVG_ANGLETYPE_UNKNOWN* {.importc:"SVGAngle.SVG_ANGLETYPE_UNKNOWN", nodecl.}: float
var SVGAngleSVG_ANGLETYPE_UNSPECIFIED* {.importc:"SVGAngle.SVG_ANGLETYPE_UNSPECIFIED", nodecl.}: float
...
proc setRotate*(self: SVGTransform, angle: float, cx: float, cy: float) : void {.importcpp.}
...
var SVGTransformSVG_TRANSFORM_MATRIX* {.importc:"SVGTransform.SVG_TRANSFORM_MATRIX", nodecl.}: float
var SVGTransformSVG_TRANSFORM_ROTATE* {.importc:"SVGTransform.SVG_TRANSFORM_ROTATE", nodecl.}: float
var SVGTransformSVG_TRANSFORM_SCALE* {.importc:"SVGTransform.SVG_TRANSFORM_SCALE", nodecl.}: float
var SVGTransformSVG_TRANSFORM_SKEWX* {.importc:"SVGTransform.SVG_TRANSFORM_SKEWX", nodecl.}: float
var SVGTransformSVG_TRANSFORM_SKEWY* {.importc:"SVGTransform.SVG_TRANSFORM_SKEWY", nodecl.}: float
var SVGTransformSVG_TRANSFORM_TRANSLATE* {.importc:"SVGTransform.SVG_TRANSFORM_TRANSLATE", nodecl.}: float
var SVGTransformSVG_TRANSFORM_UNKNOWN* {.importc:"SVGTransform.SVG_TRANSFORM_UNKNOWN", nodecl.}: float
proc SVGTransformSetMatrix*(matrix: SVGMatrix) : void {.importc:"SVGTransform.setMatrix".}
proc SVGTransformSetRotate*(angle: float, cx: float, cy: float) : void {.importc:"SVGTransform.setRotate".}
...
proc SVGTransformSetTranslate*(tx: float, ty: float) : void {.importc:"SVGTransform.setTranslate".}
...
proc lookupNamespaceURI*(self: XPathNSResolver, prefix: cstring) : cstring {.importcpp.}
proc XPathNSResolverLookupNamespaceURI*(prefix: cstring) : cstring {.importc:"XPathNSResolver.lookupNamespaceURI".}
...
var PerformanceNavigationRedirectCount* {.importc:"PerformanceNavigation.redirectCount", nodecl.}: float
var PerformanceNavigationType* {.importc:"PerformanceNavigation.type", nodecl.}: float
var PerformanceNavigationTYPE_BACK_FORWARD* {.importc:"PerformanceNavigation.TYPE_BACK_FORWARD", nodecl.}: float
var PerformanceNavigationTYPE_NAVIGATE* {.importc:"PerformanceNavigation.TYPE_NAVIGATE", nodecl.}: float
var PerformanceNavigationTYPE_RELOAD* {.importc:"PerformanceNavigation.TYPE_RELOAD", nodecl.}: float
var PerformanceNavigationTYPE_RESERVED* {.importc:"PerformanceNavigation.TYPE_RESERVED", nodecl.}: float
...
var PerformanceTimingConnectEnd* {.importc:"PerformanceTiming.connectEnd", nodecl.}: float
var PerformanceTimingConnectStart* {.importc:"PerformanceTiming.connectStart", nodecl.}: float
var PerformanceTimingDomComplete* {.importc:"PerformanceTiming.domComplete", nodecl.}: float
var PerformanceTimingDomContentLoadedEventEnd* {.importc:"PerformanceTiming.domContentLoadedEventEnd", nodecl.}: float
var PerformanceTimingDomContentLoadedEventStart* {.importc:"PerformanceTiming.domContentLoadedEventStart", nodecl.}: float
var PerformanceTimingDomInteractive* {.importc:"PerformanceTiming.domInteractive", nodecl.}: float
var PerformanceTimingDomLoading* {.importc:"PerformanceTiming.domLoading", nodecl.}: float
var PerformanceTimingDomainLookupEnd* {.importc:"PerformanceTiming.domainLookupEnd", nodecl.}: float
var PerformanceTimingDomainLookupStart* {.importc:"PerformanceTiming.domainLookupStart", nodecl.}: float
var PerformanceTimingFetchStart* {.importc:"PerformanceTiming.fetchStart", nodecl.}: float
var PerformanceTimingLoadEventEnd* {.importc:"PerformanceTiming.loadEventEnd", nodecl.}: float
var PerformanceTimingLoadEventStart* {.importc:"PerformanceTiming.loadEventStart", nodecl.}: float
var PerformanceTimingMsFirstPaint* {.importc:"PerformanceTiming.msFirstPaint", nodecl.}: float
var PerformanceTimingNavigationStart* {.importc:"PerformanceTiming.navigationStart", nodecl.}: float
var PerformanceTimingRedirectEnd* {.importc:"PerformanceTiming.redirectEnd", nodecl.}: float
var PerformanceTimingRedirectStart* {.importc:"PerformanceTiming.redirectStart", nodecl.}: float
var PerformanceTimingRequestStart* {.importc:"PerformanceTiming.requestStart", nodecl.}: float
var PerformanceTimingResponseEnd* {.importc:"PerformanceTiming.responseEnd", nodecl.}: float
var PerformanceTimingResponseStart* {.importc:"PerformanceTiming.responseStart", nodecl.}: float
var PerformanceTimingUnloadEventEnd* {.importc:"PerformanceTiming.unloadEventEnd", nodecl.}: float
var PerformanceTimingUnloadEventStart* {.importc:"PerformanceTiming.unloadEventStart", nodecl.}: float
...
proc measure*(self: Performance, measureName: cstring, startMarkName: cstring, endMarkName: cstring) : void {.importcpp.}
proc now*(self: Performance) : float {.importcpp.}
proc setResourceTimingBufferSize*(self: Performance, maxSize: float) : void {.importcpp.}
...
proc removeListener*(self: MediaQueryList, listener: MediaQueryListListener) : void {.importcpp.}
...
proc addEventListener*(self: EventTarget, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: EventTarget, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
proc dispatchEvent*(self: EventTarget, evt: Event) : bool {.importcpp.}
proc removeEventListener*(self: EventTarget, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc removeEventListener*(self: EventTarget, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
proc newScreen*() : Screen {.importcpp:"new Screen".}
proc msUnlockOrientation*(self: Screen) : void {.importcpp.}
proc addEventListener*(self: Screen, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: Screen, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
proc newNavigator*() : Navigator {.importcpp:"new Navigator".}
proc javaEnabled*(self: Navigator) : bool {.importcpp.}
proc msLaunchUri*(self: Navigator, uri: cstring, successCallback: MSLaunchUriCallback, noHandlerCallback: MSLaunchUriCallback) : void {.importcpp.}
proc addEventListener*(self: Navigator, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: Navigator, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
proc item*(self: MSRangeCollection, index: float) : Range {.importcpp.}
var MSRangeCollectionLength* {.importc:"MSRangeCollection.length", nodecl.}: float
...
proc collapse*(self: Selection, parentNode: Node, offset: float) : void {.importcpp.}
proc collapseToEnd*(self: Selection) : void {.importcpp.}
proc collapseToStart*(self: Selection) : void {.importcpp.}
proc containsNode*(self: Selection, node: Node, partlyContained: bool) : bool {.importcpp.}
...
proc setBaseAndExtent*(self: Selection, baseNode: Node, baseOffset: float, extentNode: Node, extentOffset: float) : void {.importcpp.}
...
proc SelectionCollapse*(parentNode: Node, offset: float) : void {.importc:"Selection.collapse".}
...
proc SelectionSetBaseAndExtent*(baseNode: Node, baseOffset: float, extentNode: Node, extentOffset: float) : void {.importc:"Selection.setBaseAndExtent".}
...
proc compareBoundaryPoints*(self: Range, how: float, sourceRange: Range) : float {.importcpp.}
proc createContextualFragment*(self: Range, fragment: cstring) : DocumentFragment {.importcpp.}
...
proc RangeCompareBoundaryPoints*(how: float, sourceRange: Range) : float {.importc:"Range.compareBoundaryPoints".}
...
proc insertBefore*(self: Node, newChild: Node, refChild: Node) : Node {.importcpp.}
...
proc replaceChild*(self: Node, newChild: Node, oldChild: Node) : Node {.importcpp.}
...
proc deleteData*(self: CharacterData, offset: float, count: float) : void {.importcpp.}
proc insertData*(self: CharacterData, offset: float, arg: cstring) : void {.importcpp.}
proc replaceData*(self: CharacterData, offset: float, count: float, arg: cstring) : void {.importcpp.}
proc substringData*(self: CharacterData, offset: float, count: float) : cstring {.importcpp.}
proc addEventListener*(self: CharacterData, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: CharacterData, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var ProcessingInstructionTarget* {.importc:"ProcessingInstruction.target", nodecl.}: cstring
...
var NodeIteratorExpandEntityReferences* {.importc:"NodeIterator.expandEntityReferences", nodecl.}: bool
...
var NodeIteratorWhatToShow* {.importc:"NodeIterator.whatToShow", nodecl.}: float
...
var XPathResultNumberValue* {.importc:"XPathResult.numberValue", nodecl.}: float
...
var XPathResultSnapshotLength* {.importc:"XPathResult.snapshotLength", nodecl.}: float
var XPathResultStringValue* {.importc:"XPathResult.stringValue", nodecl.}: cstring
var XPathResultANY_TYPE* {.importc:"XPathResult.ANY_TYPE", nodecl.}: float
var XPathResultANY_UNORDERED_NODE_TYPE* {.importc:"XPathResult.ANY_UNORDERED_NODE_TYPE", nodecl.}: float
var XPathResultBOOLEAN_TYPE* {.importc:"XPathResult.BOOLEAN_TYPE", nodecl.}: float
var XPathResultFIRST_ORDERED_NODE_TYPE* {.importc:"XPathResult.FIRST_ORDERED_NODE_TYPE", nodecl.}: float
var XPathResultNUMBER_TYPE* {.importc:"XPathResult.NUMBER_TYPE", nodecl.}: float
var XPathResultORDERED_NODE_ITERATOR_TYPE* {.importc:"XPathResult.ORDERED_NODE_ITERATOR_TYPE", nodecl.}: float
var XPathResultORDERED_NODE_SNAPSHOT_TYPE* {.importc:"XPathResult.ORDERED_NODE_SNAPSHOT_TYPE", nodecl.}: float
var XPathResultSTRING_TYPE* {.importc:"XPathResult.STRING_TYPE", nodecl.}: float
var XPathResultUNORDERED_NODE_ITERATOR_TYPE* {.importc:"XPathResult.UNORDERED_NODE_ITERATOR_TYPE", nodecl.}: float
var XPathResultUNORDERED_NODE_SNAPSHOT_TYPE* {.importc:"XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE", nodecl.}: float
...
proc evaluate*(self: XPathExpression, contextNode: Node, xType: float, result: XPathResult) : XPathExpression {.importcpp.}
proc XPathExpressionEvaluate*(contextNode: Node, xType: float, result: XPathResult) : XPathExpression {.importc:"XPathExpression.evaluate".}
proc addEventListener*(self: DocumentFragment, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: DocumentFragment, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
proc DocumentFragmentAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"DocumentFragment.addEventListener".}
proc DocumentFragmentAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"DocumentFragment.addEventListener".}
...
proc getAttributeNS*(self: Element, namespaceURI: cstring, localName: cstring) : cstring {.importcpp.}
proc getAttributeNode*(self: Element, name: cstring) : Attr {.importcpp.}
proc getAttributeNodeNS*(self: Element, namespaceURI: cstring, localName: cstring) : Attr {.importcpp.}
...
proc hasAttributeNS*(self: Element, namespaceURI: cstring, localName: cstring) : bool {.importcpp.}
...
proc msReleasePointerCapture*(self: Element, pointerId: float) : void {.importcpp.}
...
proc removeAttributeNS*(self: Element, namespaceURI: cstring, localName: cstring) : void {.importcpp.}
...
proc setAttribute*(self: Element, name: cstring, value: cstring) : void {.importcpp.}
proc setAttributeNS*(self: Element, namespaceURI: cstring, qualifiedName: cstring, value: cstring) : void {.importcpp.}
...
proc webkitMatchesSelector*(self: Element, selectors: cstring) : bool {.importcpp.}
proc webkitRequestFullscreen*(self: Element) : void {.importcpp.}
proc matches*(self: Element, selector: cstring) : bool {.importcpp.}
proc addEventListener*(self: Element, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: Element, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
var ElementMsContentZoomFactor* {.importc:"Element.msContentZoomFactor", nodecl.}: float
var ElementMsRegionOverflow* {.importc:"Element.msRegionOverflow", nodecl.}: cstring
...
proc ElementGetAttributeNS*(namespaceURI: cstring, localName: cstring) : cstring {.importc:"Element.getAttributeNS".}
proc ElementGetAttributeNode*(name: cstring) : Attr {.importc:"Element.getAttributeNode".}
proc ElementGetAttributeNodeNS*(namespaceURI: cstring, localName: cstring) : Attr {.importc:"Element.getAttributeNodeNS".}
...
proc ElementHasAttributeNS*(namespaceURI: cstring, localName: cstring) : bool {.importc:"Element.hasAttributeNS".}
...
proc ElementRemoveAttributeNS*(namespaceURI: cstring, localName: cstring) : void {.importc:"Element.removeAttributeNS".}
...
proc ElementSetAttribute*(name: cstring, value: cstring) : void {.importc:"Element.setAttribute".}
proc ElementSetAttributeNS*(namespaceURI: cstring, qualifiedName: cstring, value: cstring) : void {.importc:"Element.setAttributeNS".}
...
proc ElementAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"Element.addEventListener".}
proc ElementAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"Element.addEventListener".}
...
proc insertAdjacentElement*(self: HTMLElement, position: cstring, insertedElement: Element) : Element {.importcpp.}
proc insertAdjacentHTML*(self: HTMLElement, where: cstring, html: cstring) : void {.importcpp.}
proc insertAdjacentText*(self: HTMLElement, where: cstring, text: cstring) : void {.importcpp.}
...
proc addEventListener*(self: HTMLElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: HTMLElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var HTMLElementAccessKey* {.importc:"HTMLElement.accessKey", nodecl.}: cstring
var HTMLElementChildren* {.importc:"HTMLElement.children", nodecl.}: HTMLCollection
var HTMLElementContentEditable* {.importc:"HTMLElement.contentEditable", nodecl.}: cstring
...
var HTMLElementOffsetHeight* {.importc:"HTMLElement.offsetHeight", nodecl.}: float
var HTMLElementOffsetLeft* {.importc:"HTMLElement.offsetLeft", nodecl.}: float
var HTMLElementOffsetParent* {.importc:"HTMLElement.offsetParent", nodecl.}: Element
var HTMLElementOffsetTop* {.importc:"HTMLElement.offsetTop", nodecl.}: float
var HTMLElementOffsetWidth* {.importc:"HTMLElement.offsetWidth", nodecl.}: float
...
var HTMLElementStyle* {.importc:"HTMLElement.style", nodecl.}: CSSStyleDeclaration
...
proc HTMLElementInsertAdjacentElement*(position: cstring, insertedElement: Element) : Element {.importc:"HTMLElement.insertAdjacentElement".}
proc HTMLElementInsertAdjacentHTML*(where: cstring, html: cstring) : void {.importc:"HTMLElement.insertAdjacentHTML".}
proc HTMLElementInsertAdjacentText*(where: cstring, text: cstring) : void {.importc:"HTMLElement.insertAdjacentText".}
...
proc HTMLElementAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"HTMLElement.addEventListener".}
proc HTMLElementAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"HTMLElement.addEventListener".}
var HTMLScriptElementAsync* {.importc:"HTMLScriptElement.async", nodecl.}: bool
var HTMLScriptElementCharset* {.importc:"HTMLScriptElement.charset", nodecl.}: cstring
var HTMLScriptElementDefer* {.importc:"HTMLScriptElement.defer", nodecl.}: bool
var HTMLScriptElementEvent* {.importc:"HTMLScriptElement.event", nodecl.}: cstring
var HTMLScriptElementHtmlFor* {.importc:"HTMLScriptElement.htmlFor", nodecl.}: cstring
var HTMLScriptElementSrc* {.importc:"HTMLScriptElement.src", nodecl.}: cstring
var HTMLScriptElementText* {.importc:"HTMLScriptElement.text", nodecl.}: cstring
var HTMLScriptElementType* {.importc:"HTMLScriptElement.type", nodecl.}: cstring
...
proc addEventListener*(self: SVGElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
proc checkEnclosure*(self: SVGSVGElement, element: SVGElement, rect: SVGRect) : bool {.importcpp.}
proc checkIntersection*(self: SVGSVGElement, element: SVGElement, rect: SVGRect) : bool {.importcpp.}
...
proc createSVGTransformFromMatrix*(self: SVGSVGElement, matrix: SVGMatrix) : SVGTransform {.importcpp.}
proc deselectAll*(self: SVGSVGElement) : void {.importcpp.}
proc forceRedraw*(self: SVGSVGElement) : void {.importcpp.}
proc getComputedStyle*(self: SVGSVGElement, elt: Element, pseudoElt: cstring) : CSSStyleDeclaration {.importcpp.}
proc getCurrentTime*(self: SVGSVGElement) : float {.importcpp.}
proc getElementById*(self: SVGSVGElement, elementId: cstring) : Element {.importcpp.}
proc getEnclosureList*(self: SVGSVGElement, rect: SVGRect, referenceElement: SVGElement) : NodeList {.importcpp.}
proc getIntersectionList*(self: SVGSVGElement, rect: SVGRect, referenceElement: SVGElement) : NodeList {.importcpp.}
...
proc suspendRedraw*(self: SVGSVGElement, maxWaitMilliseconds: float) : float {.importcpp.}
proc unpauseAnimations*(self: SVGSVGElement) : void {.importcpp.}
proc unsuspendRedraw*(self: SVGSVGElement, suspendHandleID: float) : void {.importcpp.}
proc unsuspendRedrawAll*(self: SVGSVGElement) : void {.importcpp.}
proc addEventListener*(self: SVGSVGElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGSVGElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var SVGSVGElementContentScriptType* {.importc:"SVGSVGElement.contentScriptType", nodecl.}: cstring
var SVGSVGElementContentStyleType* {.importc:"SVGSVGElement.contentStyleType", nodecl.}: cstring
var SVGSVGElementCurrentScale* {.importc:"SVGSVGElement.currentScale", nodecl.}: float
var SVGSVGElementCurrentTranslate* {.importc:"SVGSVGElement.currentTranslate", nodecl.}: SVGPoint
var SVGSVGElementHeight* {.importc:"SVGSVGElement.height", nodecl.}: SVGAnimatedLength
var SVGSVGElementPixelUnitToMillimeterX* {.importc:"SVGSVGElement.pixelUnitToMillimeterX", nodecl.}: float
var SVGSVGElementPixelUnitToMillimeterY* {.importc:"SVGSVGElement.pixelUnitToMillimeterY", nodecl.}: float
var SVGSVGElementScreenPixelToMillimeterX* {.importc:"SVGSVGElement.screenPixelToMillimeterX", nodecl.}: float
var SVGSVGElementScreenPixelToMillimeterY* {.importc:"SVGSVGElement.screenPixelToMillimeterY", nodecl.}: float
var SVGSVGElementViewport* {.importc:"SVGSVGElement.viewport", nodecl.}: SVGRect
var SVGSVGElementWidth* {.importc:"SVGSVGElement.width", nodecl.}: SVGAnimatedLength
...
proc SVGSVGElementCheckEnclosure*(element: SVGElement, rect: SVGRect) : bool {.importc:"SVGSVGElement.checkEnclosure".}
proc SVGSVGElementCheckIntersection*(element: SVGElement, rect: SVGRect) : bool {.importc:"SVGSVGElement.checkIntersection".}
...
proc SVGSVGElementCreateSVGTransformFromMatrix*(matrix: SVGMatrix) : SVGTransform {.importc:"SVGSVGElement.createSVGTransformFromMatrix".}
...
proc SVGSVGElementGetComputedStyle*(elt: Element, pseudoElt: cstring) : CSSStyleDeclaration {.importc:"SVGSVGElement.getComputedStyle".}
...
proc SVGSVGElementGetEnclosureList*(rect: SVGRect, referenceElement: SVGElement) : NodeList {.importc:"SVGSVGElement.getEnclosureList".}
proc SVGSVGElementGetIntersectionList*(rect: SVGRect, referenceElement: SVGElement) : NodeList {.importc:"SVGSVGElement.getIntersectionList".}
...
proc SVGSVGElementAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"SVGSVGElement.addEventListener".}
proc SVGSVGElementAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"SVGSVGElement.addEventListener".}
proc newDOMImplementation*() : DOMImplementation {.importcpp:"new DOMImplementation".}
proc createDocument*(self: DOMImplementation, namespaceURI: cstring, qualifiedName: cstring, doctype: DocumentType) : Document {.importcpp.}
proc createDocumentType*(self: DOMImplementation, qualifiedName: cstring, publicId: cstring, systemId: cstring) : DocumentType {.importcpp.}
proc createHTMLDocument*(self: DOMImplementation, title: cstring) : Document {.importcpp.}
proc hasFeature*(self: DOMImplementation, feature: cstring, version: cstring) : bool {.importcpp.}
var HTMLHeadElementProfile* {.importc:"HTMLHeadElement.profile", nodecl.}: cstring
proc addEventListener*(self: DocumentType, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: DocumentType, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var DocumentTypeEntities* {.importc:"DocumentType.entities", nodecl.}: NamedNodeMap
var DocumentTypeInternalSubset* {.importc:"DocumentType.internalSubset", nodecl.}: cstring
var DocumentTypeName* {.importc:"DocumentType.name", nodecl.}: cstring
var DocumentTypeNotations* {.importc:"DocumentType.notations", nodecl.}: NamedNodeMap
...
proc DocumentTypeAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"DocumentType.addEventListener".}
proc DocumentTypeAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"DocumentType.addEventListener".}
...
proc addEventListener*(self: MSInputMethodContext, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: MSInputMethodContext, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var MSInputMethodContextCompositionEndOffset* {.importc:"MSInputMethodContext.compositionEndOffset", nodecl.}: float
var MSInputMethodContextCompositionStartOffset* {.importc:"MSInputMethodContext.compositionStartOffset", nodecl.}: float
var MSInputMethodContextTarget* {.importc:"MSInputMethodContext.target", nodecl.}: HTMLElement
...
proc MSInputMethodContextAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"MSInputMethodContext.addEventListener".}
proc MSInputMethodContextAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"MSInputMethodContext.addEventListener".}
...
proc createAttributeNS*(self: Document, namespaceURI: cstring, qualifiedName: cstring) : Attr {.importcpp.}
proc createCDATASection*(self: Document, data: cstring) : CDATASection {.importcpp.}
...
proc createElementNS*(self: Document, namespaceURI: cstring, qualifiedName: cstring) : Element {.importcpp.}
proc createExpression*(self: Document, expression: cstring, resolver: XPathNSResolver) : XPathExpression {.importcpp.}
proc createNSResolver*(self: Document, nodeResolver: Node) : XPathNSResolver {.importcpp.}
proc createNodeIterator*(self: Document, root: Node, whatToShow: float, filter: NodeFilter, entityReferenceExpansion: bool) : NodeIterator {.importcpp.}
proc createProcessingInstruction*(self: Document, target: cstring, data: cstring) : ProcessingInstruction {.importcpp.}
proc createRange*(self: Document) : Range {.importcpp.}
proc createTextNode*(self: Document, data: cstring) : Text {.importcpp.}
proc createTreeWalker*(self: Document, root: Node, whatToShow: float, filter: NodeFilter, entityReferenceExpansion: bool) : TreeWalker {.importcpp.}
proc elementFromPoint*(self: Document, x: float, y: float) : Element {.importcpp.}
proc evaluate*(self: Document, expression: cstring, contextNode: Node, resolver: XPathNSResolver, xType: float, result: XPathResult) : XPathResult {.importcpp.}
proc execCommandShowHelp*(self: Document, commandId: cstring) : bool {.importcpp.}
...
proc importNode*(self: Document, importedNode: Node, deep: bool) : Node {.importcpp.}
proc msElementsFromPoint*(self: Document, x: float, y: float) : NodeList {.importcpp.}
proc msElementsFromRect*(self: Document, left: float, top: float, width: float, height: float) : NodeList {.importcpp.}
proc open*(self: Document, url: cstring, name: cstring, features: cstring, replace: bool) : Document {.importcpp.}
proc queryCommandEnabled*(self: Document, commandId: cstring) : bool {.importcpp.}
proc queryCommandIndeterm*(self: Document, commandId: cstring) : bool {.importcpp.}
proc queryCommandState*(self: Document, commandId: cstring) : bool {.importcpp.}
proc queryCommandSupported*(self: Document, commandId: cstring) : bool {.importcpp.}
...
proc addEventListener*(self: Document, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: Document, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var DocumentURL* {.importc:"Document.URL", nodecl.}: cstring
var DocumentURLUnencoded* {.importc:"Document.URLUnencoded", nodecl.}: cstring
var DocumentActiveElement* {.importc:"Document.activeElement", nodecl.}: Element
...
var DocumentDefaultCharset* {.importc:"Document.defaultCharset", nodecl.}: cstring
...
var DocumentDocumentElement* {.importc:"Document.documentElement", nodecl.}: HTMLElement
...
var DocumentFullscreenElement* {.importc:"Document.fullscreenElement", nodecl.}: Element
...
var DocumentImplementation* {.importc:"Document.implementation", nodecl.}: DOMImplementation
var DocumentInputEncoding* {.importc:"Document.inputEncoding", nodecl.}: cstring
...
var DocumentMsCSSOMElementFloatMetrics* {.importc:"Document.msCSSOMElementFloatMetrics", nodecl.}: bool
...
var DocumentMsVisibilityState* {.importc:"Document.msVisibilityState", nodecl.}: cstring
var DocumentPlugins* {.importc:"Document.plugins", nodecl.}: HTMLCollection
var DocumentPointerLockElement* {.importc:"Document.pointerLockElement", nodecl.}: Element
...
var DocumentRootElement* {.importc:"Document.rootElement", nodecl.}: SVGSVGElement
...
var DocumentStyleSheets* {.importc:"Document.styleSheets", nodecl.}: StyleSheetList
var DocumentTitle* {.importc:"Document.title", nodecl.}: cstring
var DocumentVisibilityState* {.importc:"Document.visibilityState", nodecl.}: cstring
var DocumentVlinkColor* {.importc:"Document.vlinkColor", nodecl.}: cstring
var DocumentWebkitCurrentFullScreenElement* {.importc:"Document.webkitCurrentFullScreenElement", nodecl.}: Element
var DocumentWebkitFullscreenElement* {.importc:"Document.webkitFullscreenElement", nodecl.}: Element
...
var DocumentCurrentScript* {.importc:"Document.currentScript", nodecl.}: HTMLScriptElement
...
proc DocumentCreateAttributeNS*(namespaceURI: cstring, qualifiedName: cstring) : Attr {.importc:"Document.createAttributeNS".}
...
proc DocumentCreateElementNS*(namespaceURI: cstring, qualifiedName: cstring) : Element {.importc:"Document.createElementNS".}
proc DocumentCreateExpression*(expression: cstring, resolver: XPathNSResolver) : XPathExpression {.importc:"Document.createExpression".}
proc DocumentCreateNSResolver*(nodeResolver: Node) : XPathNSResolver {.importc:"Document.createNSResolver".}
proc DocumentCreateNodeIterator*(root: Node, whatToShow: float, filter: NodeFilter, entityReferenceExpansion: bool) : NodeIterator {.importc:"Document.createNodeIterator".}
proc DocumentCreateProcessingInstruction*(target: cstring, data: cstring) : ProcessingInstruction {.importc:"Document.createProcessingInstruction".}
...
proc DocumentCreateTreeWalker*(root: Node, whatToShow: float, filter: NodeFilter, entityReferenceExpansion: bool) : TreeWalker {.importc:"Document.createTreeWalker".}
proc DocumentElementFromPoint*(x: float, y: float) : Element {.importc:"Document.elementFromPoint".}
proc DocumentEvaluate*(expression: cstring, contextNode: Node, resolver: XPathNSResolver, xType: float, result: XPathResult) : XPathResult {.importc:"Document.evaluate".}
...
proc DocumentImportNode*(importedNode: Node, deep: bool) : Node {.importc:"Document.importNode".}
proc DocumentMsElementsFromPoint*(x: float, y: float) : NodeList {.importc:"Document.msElementsFromPoint".}
proc DocumentMsElementsFromRect*(left: float, top: float, width: float, height: float) : NodeList {.importc:"Document.msElementsFromRect".}
proc DocumentOpen*(url: cstring, name: cstring, features: cstring, replace: bool) : Document {.importc:"Document.open".}
...
proc DocumentAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"Document.addEventListener".}
proc DocumentAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"Document.addEventListener".}
...
proc getNamedItemNS*(self: NamedNodeMap, namespaceURI: cstring, localName: cstring) : Attr {.importcpp.}
proc item*(self: NamedNodeMap, index: float) : Attr {.importcpp.}
proc removeNamedItem*(self: NamedNodeMap, name: cstring) : Attr {.importcpp.}
proc removeNamedItemNS*(self: NamedNodeMap, namespaceURI: cstring, localName: cstring) : Attr {.importcpp.}
...
proc NamedNodeMapGetNamedItemNS*(namespaceURI: cstring, localName: cstring) : Attr {.importc:"NamedNodeMap.getNamedItemNS".}
...
proc NamedNodeMapRemoveNamedItemNS*(namespaceURI: cstring, localName: cstring) : Attr {.importc:"NamedNodeMap.removeNamedItemNS".}
...
proc initEvent*(self: Event, eventTypeArg: cstring, canBubbleArg: bool, cancelableArg: bool) : void {.importcpp.}
...
proc EventInitEvent*(eventTypeArg: cstring, canBubbleArg: bool, cancelableArg: bool) : void {.importc:"Event.initEvent".}
...
proc addEventListener*(self: ApplicationCache, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: ApplicationCache, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var ApplicationCacheCHECKING* {.importc:"ApplicationCache.CHECKING", nodecl.}: float
var ApplicationCacheDOWNLOADING* {.importc:"ApplicationCache.DOWNLOADING", nodecl.}: float
var ApplicationCacheIDLE* {.importc:"ApplicationCache.IDLE", nodecl.}: float
var ApplicationCacheOBSOLETE* {.importc:"ApplicationCache.OBSOLETE", nodecl.}: float
var ApplicationCacheUNCACHED* {.importc:"ApplicationCache.UNCACHED", nodecl.}: float
var ApplicationCacheUPDATEREADY* {.importc:"ApplicationCache.UPDATEREADY", nodecl.}: float
...
proc getComputedStyle*(self: Window, elt: Element, pseudoElt: cstring) : CSSStyleDeclaration {.importcpp.}
proc getMatchedCSSRules*(self: Window, elt: Element, pseudoElt: cstring) : CSSRuleList {.importcpp.}
...
proc msCancelRequestAnimationFrame*(self: Window, handle: float) : void {.importcpp.}
proc msMatchMedia*(self: Window, mediaQuery: cstring) : MediaQueryList {.importcpp.}
proc msRequestAnimationFrame*(self: Window, callback: FrameRequestCallback) : float {.importcpp.}
proc msWriteProfilerMark*(self: Window, profilerMarkName: cstring) : void {.importcpp.}
proc open*(self: Window, url: cstring, target: cstring, features: cstring, replace: bool) : Window {.importcpp.}
proc print*(self: Window) : void {.importcpp.}
proc prompt*(self: Window, message: cstring, zDefault: cstring) : cstring {.importcpp.}
proc releaseEvents*(self: Window) : void {.importcpp.}
proc requestAnimationFrame*(self: Window, callback: FrameRequestCallback) : float {.importcpp.}
...
proc webkitConvertPointFromNodeToPage*(self: Window, node: Node, pt: WebKitPoint) : WebKitPoint {.importcpp.}
proc webkitConvertPointFromPageToNode*(self: Window, node: Node, pt: WebKitPoint) : WebKitPoint {.importcpp.}
proc addEventListener*(self: Window, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: Window, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var WindowAnimationStartTime* {.importc:"Window.animationStartTime", nodecl.}: float
var WindowApplicationCache* {.importc:"Window.applicationCache", nodecl.}: ApplicationCache
var WindowClientInformation* {.importc:"Window.clientInformation", nodecl.}: Navigator
...
var WindowDevicePixelRatio* {.importc:"Window.devicePixelRatio", nodecl.}: float
...
var WindowMsAnimationStartTime* {.importc:"Window.msAnimationStartTime", nodecl.}: float
...
proc WindowGetComputedStyle*(elt: Element, pseudoElt: cstring) : CSSStyleDeclaration {.importc:"Window.getComputedStyle".}
proc WindowGetMatchedCSSRules*(elt: Element, pseudoElt: cstring) : CSSRuleList {.importc:"Window.getMatchedCSSRules".}
...
proc WindowMsCancelRequestAnimationFrame*(handle: float) : void {.importc:"Window.msCancelRequestAnimationFrame".}
...
proc WindowOpen*(url: cstring, target: cstring, features: cstring, replace: bool) : Window {.importc:"Window.open".}
...
proc WindowWebkitConvertPointFromNodeToPage*(node: Node, pt: WebKitPoint) : WebKitPoint {.importc:"Window.webkitConvertPointFromNodeToPage".}
proc WindowWebkitConvertPointFromPageToNode*(node: Node, pt: WebKitPoint) : WebKitPoint {.importc:"Window.webkitConvertPointFromPageToNode".}
proc WindowAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"Window.addEventListener".}
proc WindowAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"Window.addEventListener".}
...
type ConfirmSiteSpecificExceptionsInformation* {.importc.} = ref object of ExceptionInformation
...
type StoreSiteSpecificExceptionsInformation* {.importc.} = ref object of StoreExceptionsInformation
...
proc drawArraysInstancedANGLE*(self: ANGLE_instanced_arrays, mode: float, first: float, count: float, primcount: float) : void {.importcpp.}
proc drawElementsInstancedANGLE*(self: ANGLE_instanced_arrays, mode: float, count: float, xType: float, offset: float, primcount: float) : void {.importcpp.}
proc vertexAttribDivisorANGLE*(self: ANGLE_instanced_arrays, index: float, divisor: float) : void {.importcpp.}
var ANGLE_instanced_arraysVERTEX_ATTRIB_ARRAY_DIVISOR_ANGLE* {.importc:"ANGLE_instanced_arrays.VERTEX_ATTRIB_ARRAY_DIVISOR_ANGLE", nodecl.}: float

type AudioListener* {.importc.} = ref object of RootObj
    dopplerFactor* {.importc.}: float
    speedOfSound* {.importc.}: float
proc setOrientation*(self: AudioListener, x: float, y: float, z: float, xUp: float, yUp: float, zUp: float) : void {.importcpp.}
proc setPosition*(self: AudioListener, x: float, y: float, z: float) : void {.importcpp.}
proc setVelocity*(self: AudioListener, x: float, y: float, z: float) : void {.importcpp.}
var AudioListenerDopplerFactor* {.importc:"AudioListener.dopplerFactor", nodecl.}: float
var AudioListenerSpeedOfSound* {.importc:"AudioListener.speedOfSound", nodecl.}: float
proc AudioListenerSetOrientation*(x: float, y: float, z: float, xUp: float, yUp: float, zUp: float) : void {.importc:"AudioListener.setOrientation".}
proc AudioListenerSetPosition*(x: float, y: float, z: float) : void {.importc:"AudioListener.setPosition".}
proc AudioListenerSetVelocity*(x: float, y: float, z: float) : void {.importc:"AudioListener.setVelocity".}

type AudioParam* {.importc.} = ref object of RootObj
    defaultValue* {.importc.}: float
    value* {.importc.}: float
proc cancelScheduledValues*(self: AudioParam, startTime: float) : void {.importcpp.}
proc exponentialRampToValueAtTime*(self: AudioParam, value: float, endTime: float) : void {.importcpp.}
proc linearRampToValueAtTime*(self: AudioParam, value: float, endTime: float) : void {.importcpp.}
proc setTargetAtTime*(self: AudioParam, target: float, startTime: float, timeConstant: float) : void {.importcpp.}
proc setValueAtTime*(self: AudioParam, value: float, startTime: float) : void {.importcpp.}
proc setValueCurveAtTime*(self: AudioParam, values: Float32Array, startTime: float, duration: float) : void {.importcpp.}
var AudioParamDefaultValue* {.importc:"AudioParam.defaultValue", nodecl.}: float
...
proc AudioParamExponentialRampToValueAtTime*(value: float, endTime: float) : void {.importc:"AudioParam.exponentialRampToValueAtTime".}
proc AudioParamLinearRampToValueAtTime*(value: float, endTime: float) : void {.importc:"AudioParam.linearRampToValueAtTime".}
proc AudioParamSetTargetAtTime*(target: float, startTime: float, timeConstant: float) : void {.importc:"AudioParam.setTargetAtTime".}
proc AudioParamSetValueAtTime*(value: float, startTime: float) : void {.importc:"AudioParam.setValueAtTime".}
proc AudioParamSetValueCurveAtTime*(values: Float32Array, startTime: float, duration: float) : void {.importc:"AudioParam.setValueCurveAtTime".}
...
proc addEventListener*(self: VideoTrackList, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: VideoTrackList, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var VideoTrackListLength* {.importc:"VideoTrackList.length", nodecl.}: float
var VideoTrackListSelectedIndex* {.importc:"VideoTrackList.selectedIndex", nodecl.}: float
...
proc VideoTrackListAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"VideoTrackList.addEventListener".}
proc VideoTrackListAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"VideoTrackList.addEventListener".}
...
proc appendStream*(self: SourceBuffer, stream: MSStream, maxSize: float) : void {.importcpp.}
proc remove*(self: SourceBuffer, start: float, xEnd: float) : void {.importcpp.}
var SourceBufferAppendWindowEnd* {.importc:"SourceBuffer.appendWindowEnd", nodecl.}: float
var SourceBufferAppendWindowStart* {.importc:"SourceBuffer.appendWindowStart", nodecl.}: float
var SourceBufferAudioTracks* {.importc:"SourceBuffer.audioTracks", nodecl.}: AudioTrackList
var SourceBufferBuffered* {.importc:"SourceBuffer.buffered", nodecl.}: TimeRanges
var SourceBufferMode* {.importc:"SourceBuffer.mode", nodecl.}: cstring
var SourceBufferTimestampOffset* {.importc:"SourceBuffer.timestampOffset", nodecl.}: float
var SourceBufferUpdating* {.importc:"SourceBuffer.updating", nodecl.}: bool
var SourceBufferVideoTracks* {.importc:"SourceBuffer.videoTracks", nodecl.}: VideoTrackList
...
proc SourceBufferAppendStream*(stream: MSStream, maxSize: float) : void {.importc:"SourceBuffer.appendStream".}
...
proc addEventListener*(self: AudioTrackList, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: AudioTrackList, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
var MediaErrorMsExtendedCode* {.importc:"MediaError.msExtendedCode", nodecl.}: float
var MediaErrorMEDIA_ERR_ABORTED* {.importc:"MediaError.MEDIA_ERR_ABORTED", nodecl.}: float
var MediaErrorMEDIA_ERR_DECODE* {.importc:"MediaError.MEDIA_ERR_DECODE", nodecl.}: float
var MediaErrorMEDIA_ERR_NETWORK* {.importc:"MediaError.MEDIA_ERR_NETWORK", nodecl.}: float
var MediaErrorMEDIA_ERR_SRC_NOT_SUPPORTED* {.importc:"MediaError.MEDIA_ERR_SRC_NOT_SUPPORTED", nodecl.}: float
var MediaErrorMS_MEDIA_ERR_ENCRYPTED* {.importc:"MediaError.MS_MEDIA_ERR_ENCRYPTED", nodecl.}: float
...
var MSGraphicsTrustStatus* {.importc:"MSGraphicsTrust.status", nodecl.}: cstring
...
var MSMediaKeyErrorMS_MEDIA_KEYERR_CLIENT* {.importc:"MSMediaKeyError.MS_MEDIA_KEYERR_CLIENT", nodecl.}: float
var MSMediaKeyErrorMS_MEDIA_KEYERR_DOMAIN* {.importc:"MSMediaKeyError.MS_MEDIA_KEYERR_DOMAIN", nodecl.}: float
var MSMediaKeyErrorMS_MEDIA_KEYERR_HARDWARECHANGE* {.importc:"MSMediaKeyError.MS_MEDIA_KEYERR_HARDWARECHANGE", nodecl.}: float
var MSMediaKeyErrorMS_MEDIA_KEYERR_OUTPUT* {.importc:"MSMediaKeyError.MS_MEDIA_KEYERR_OUTPUT", nodecl.}: float
var MSMediaKeyErrorMS_MEDIA_KEYERR_SERVICE* {.importc:"MSMediaKeyError.MS_MEDIA_KEYERR_SERVICE", nodecl.}: float
var MSMediaKeyErrorMS_MEDIA_KEYERR_UNKNOWN* {.importc:"MSMediaKeyError.MS_MEDIA_KEYERR_UNKNOWN", nodecl.}: float
...
type MSMediaKeys* {.importc.} = ref object of RootObj
    keySystem* {.importc.}: cstring
proc createSession*(self: MSMediaKeys, xType: cstring, initData: Uint8Array, cdmData: Uint8Array) : MSMediaKeySession {.importcpp.}
var MSMediaKeysKeySystem* {.importc:"MSMediaKeys.keySystem", nodecl.}: cstring
proc MSMediaKeysCreateSession*(xType: cstring, initData: Uint8Array, cdmData: Uint8Array) : MSMediaKeySession {.importc:"MSMediaKeys.createSession".}
...
proc addEventListener*(self: TextTrackCue, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: TextTrackCue, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
proc getCueById*(self: TextTrackCueList, id: cstring) : TextTrackCue {.importcpp.}
proc item*(self: TextTrackCueList, index: float) : TextTrackCue {.importcpp.}
var TextTrackCueListLength* {.importc:"TextTrackCueList.length", nodecl.}: float
...
proc addEventListener*(self: TextTrack, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: TextTrack, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var TextTrackActiveCues* {.importc:"TextTrack.activeCues", nodecl.}: TextTrackCueList
var TextTrackCues* {.importc:"TextTrack.cues", nodecl.}: TextTrackCueList
var TextTrackInBandMetadataTrackDispatchType* {.importc:"TextTrack.inBandMetadataTrackDispatchType", nodecl.}: cstring
...
proc TextTrackAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"TextTrack.addEventListener".}
proc TextTrackAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"TextTrack.addEventListener".}

type TextTrackList* {.importc.} = ref object of EventTarget
    length* {.importc.}: float
proc item*(self: TextTrackList, index: float) : TextTrack {.importcpp.}
proc addEventListener*(self: TextTrackList, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: TextTrackList, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc TextTrackListAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"TextTrackList.addEventListener".}
proc TextTrackListAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"TextTrackList.addEventListener".}
...
proc addTextTrack*(self: HTMLMediaElement, kind: cstring, label: cstring, language: cstring) : TextTrack {.importcpp.}
...
proc msSetMediaKeys*(self: HTMLMediaElement, mediaKeys: MSMediaKeys) : void {.importcpp.}
proc pause*(self: HTMLMediaElement) : void {.importcpp.}
proc play*(self: HTMLMediaElement) : void {.importcpp.}
proc addEventListener*(self: HTMLMediaElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: HTMLMediaElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var HTMLMediaElementAudioTracks* {.importc:"HTMLMediaElement.audioTracks", nodecl.}: AudioTrackList
var HTMLMediaElementAutoplay* {.importc:"HTMLMediaElement.autoplay", nodecl.}: bool
var HTMLMediaElementBuffered* {.importc:"HTMLMediaElement.buffered", nodecl.}: TimeRanges
var HTMLMediaElementControls* {.importc:"HTMLMediaElement.controls", nodecl.}: bool
var HTMLMediaElementCurrentSrc* {.importc:"HTMLMediaElement.currentSrc", nodecl.}: cstring
var HTMLMediaElementCurrentTime* {.importc:"HTMLMediaElement.currentTime", nodecl.}: float
var HTMLMediaElementDefaultMuted* {.importc:"HTMLMediaElement.defaultMuted", nodecl.}: bool
var HTMLMediaElementDefaultPlaybackRate* {.importc:"HTMLMediaElement.defaultPlaybackRate", nodecl.}: float
var HTMLMediaElementDuration* {.importc:"HTMLMediaElement.duration", nodecl.}: float
var HTMLMediaElementEnded* {.importc:"HTMLMediaElement.ended", nodecl.}: bool
var HTMLMediaElementError* {.importc:"HTMLMediaElement.error", nodecl.}: MediaError
var HTMLMediaElementLoop* {.importc:"HTMLMediaElement.loop", nodecl.}: bool
var HTMLMediaElementMsAudioCategory* {.importc:"HTMLMediaElement.msAudioCategory", nodecl.}: cstring
var HTMLMediaElementMsAudioDeviceType* {.importc:"HTMLMediaElement.msAudioDeviceType", nodecl.}: cstring
var HTMLMediaElementMsGraphicsTrustStatus* {.importc:"HTMLMediaElement.msGraphicsTrustStatus", nodecl.}: MSGraphicsTrust
var HTMLMediaElementMsKeys* {.importc:"HTMLMediaElement.msKeys", nodecl.}: MSMediaKeys
var HTMLMediaElementMsPlayToDisabled* {.importc:"HTMLMediaElement.msPlayToDisabled", nodecl.}: bool
var HTMLMediaElementMsPlayToPreferredSourceUri* {.importc:"HTMLMediaElement.msPlayToPreferredSourceUri", nodecl.}: cstring
...
var HTMLMediaElementNetworkState* {.importc:"HTMLMediaElement.networkState", nodecl.}: float
var HTMLMediaElementPaused* {.importc:"HTMLMediaElement.paused", nodecl.}: bool
var HTMLMediaElementPlaybackRate* {.importc:"HTMLMediaElement.playbackRate", nodecl.}: float
var HTMLMediaElementPlayed* {.importc:"HTMLMediaElement.played", nodecl.}: TimeRanges
var HTMLMediaElementPreload* {.importc:"HTMLMediaElement.preload", nodecl.}: cstring
var HTMLMediaElementReadyState* {.importc:"HTMLMediaElement.readyState", nodecl.}: float
var HTMLMediaElementSeekable* {.importc:"HTMLMediaElement.seekable", nodecl.}: TimeRanges
...
var HTMLMediaElementTextTracks* {.importc:"HTMLMediaElement.textTracks", nodecl.}: TextTrackList
var HTMLMediaElementVideoTracks* {.importc:"HTMLMediaElement.videoTracks", nodecl.}: VideoTrackList
var HTMLMediaElementVolume* {.importc:"HTMLMediaElement.volume", nodecl.}: float
var HTMLMediaElementHAVE_CURRENT_DATA* {.importc:"HTMLMediaElement.HAVE_CURRENT_DATA", nodecl.}: float
var HTMLMediaElementHAVE_ENOUGH_DATA* {.importc:"HTMLMediaElement.HAVE_ENOUGH_DATA", nodecl.}: float
var HTMLMediaElementHAVE_FUTURE_DATA* {.importc:"HTMLMediaElement.HAVE_FUTURE_DATA", nodecl.}: float
var HTMLMediaElementHAVE_METADATA* {.importc:"HTMLMediaElement.HAVE_METADATA", nodecl.}: float
var HTMLMediaElementHAVE_NOTHING* {.importc:"HTMLMediaElement.HAVE_NOTHING", nodecl.}: float
var HTMLMediaElementNETWORK_EMPTY* {.importc:"HTMLMediaElement.NETWORK_EMPTY", nodecl.}: float
var HTMLMediaElementNETWORK_IDLE* {.importc:"HTMLMediaElement.NETWORK_IDLE", nodecl.}: float
var HTMLMediaElementNETWORK_LOADING* {.importc:"HTMLMediaElement.NETWORK_LOADING", nodecl.}: float
var HTMLMediaElementNETWORK_NO_SOURCE* {.importc:"HTMLMediaElement.NETWORK_NO_SOURCE", nodecl.}: float
proc HTMLMediaElementAddTextTrack*(kind: cstring, label: cstring, language: cstring) : TextTrack {.importc:"HTMLMediaElement.addTextTrack".}
...
proc HTMLMediaElementAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"HTMLMediaElement.addEventListener".}
proc HTMLMediaElementAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"HTMLMediaElement.addEventListener".}
...
proc connect*(self: AudioNode, destination: AudioNode, output: float, input: float) : void {.importcpp.}
proc disconnect*(self: AudioNode, output: float) : void {.importcpp.}
var WaveShaperNodeCurve* {.importc:"WaveShaperNode.curve", nodecl.}: Float32Array
var WaveShaperNodeOversample* {.importc:"WaveShaperNode.oversample", nodecl.}: cstring
var StereoPannerNodePan* {.importc:"StereoPannerNode.pan", nodecl.}: AudioParam
proc addEventListener*(self: ScriptProcessorNode, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: ScriptProcessorNode, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var ScriptProcessorNodeBufferSize* {.importc:"ScriptProcessorNode.bufferSize", nodecl.}: float
proc ScriptProcessorNodeAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"ScriptProcessorNode.addEventListener".}
proc ScriptProcessorNodeAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"ScriptProcessorNode.addEventListener".}
proc setOrientation*(self: PannerNode, x: float, y: float, z: float) : void {.importcpp.}
proc setPosition*(self: PannerNode, x: float, y: float, z: float) : void {.importcpp.}
proc setVelocity*(self: PannerNode, x: float, y: float, z: float) : void {.importcpp.}
var PannerNodeConeInnerAngle* {.importc:"PannerNode.coneInnerAngle", nodecl.}: float
var PannerNodeConeOuterAngle* {.importc:"PannerNode.coneOuterAngle", nodecl.}: float
var PannerNodeConeOuterGain* {.importc:"PannerNode.coneOuterGain", nodecl.}: float
var PannerNodeDistanceModel* {.importc:"PannerNode.distanceModel", nodecl.}: cstring
var PannerNodeMaxDistance* {.importc:"PannerNode.maxDistance", nodecl.}: float
var PannerNodePanningModel* {.importc:"PannerNode.panningModel", nodecl.}: cstring
var PannerNodeRefDistance* {.importc:"PannerNode.refDistance", nodecl.}: float
var PannerNodeRolloffFactor* {.importc:"PannerNode.rolloffFactor", nodecl.}: float
proc PannerNodeSetOrientation*(x: float, y: float, z: float) : void {.importc:"PannerNode.setOrientation".}
proc PannerNodeSetPosition*(x: float, y: float, z: float) : void {.importc:"PannerNode.setPosition".}
proc PannerNodeSetVelocity*(x: float, y: float, z: float) : void {.importc:"PannerNode.setVelocity".}
proc setPeriodicWave*(self: OscillatorNode, periodicWave: PeriodicWave) : void {.importcpp.}
proc start*(self: OscillatorNode, xWhen: float) : void {.importcpp.}
proc stop*(self: OscillatorNode, xWhen: float) : void {.importcpp.}
proc addEventListener*(self: OscillatorNode, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: OscillatorNode, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var OscillatorNodeDetune* {.importc:"OscillatorNode.detune", nodecl.}: AudioParam
var OscillatorNodeFrequency* {.importc:"OscillatorNode.frequency", nodecl.}: AudioParam
...
proc OscillatorNodeAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"OscillatorNode.addEventListener".}
proc OscillatorNodeAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"OscillatorNode.addEventListener".}
var GainNodeGain* {.importc:"GainNode.gain", nodecl.}: AudioParam
var DynamicsCompressorNodeAttack* {.importc:"DynamicsCompressorNode.attack", nodecl.}: AudioParam
var DynamicsCompressorNodeKnee* {.importc:"DynamicsCompressorNode.knee", nodecl.}: AudioParam
var DynamicsCompressorNodeRatio* {.importc:"DynamicsCompressorNode.ratio", nodecl.}: AudioParam
var DynamicsCompressorNodeReduction* {.importc:"DynamicsCompressorNode.reduction", nodecl.}: AudioParam
var DynamicsCompressorNodeRelease* {.importc:"DynamicsCompressorNode.release", nodecl.}: AudioParam
var DynamicsCompressorNodeThreshold* {.importc:"DynamicsCompressorNode.threshold", nodecl.}: AudioParam
var DelayNodeDelayTime* {.importc:"DelayNode.delayTime", nodecl.}: AudioParam
var ConvolverNodeBuffer* {.importc:"ConvolverNode.buffer", nodecl.}: AudioBuffer
...
proc start*(self: AudioBufferSourceNode, xWhen: float, offset: float, duration: float) : void {.importcpp.}
proc stop*(self: AudioBufferSourceNode, xWhen: float) : void {.importcpp.}
proc addEventListener*(self: AudioBufferSourceNode, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: AudioBufferSourceNode, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
proc getFrequencyResponse*(self: BiquadFilterNode, frequencyHz: Float32Array, magResponse: Float32Array, phaseResponse: Float32Array) : void {.importcpp.}
var BiquadFilterNodeQ* {.importc:"BiquadFilterNode.Q", nodecl.}: AudioParam
var BiquadFilterNodeDetune* {.importc:"BiquadFilterNode.detune", nodecl.}: AudioParam
var BiquadFilterNodeFrequency* {.importc:"BiquadFilterNode.frequency", nodecl.}: AudioParam
var BiquadFilterNodeGain* {.importc:"BiquadFilterNode.gain", nodecl.}: AudioParam
var BiquadFilterNodeType* {.importc:"BiquadFilterNode.type", nodecl.}: cstring
proc BiquadFilterNodeGetFrequencyResponse*(frequencyHz: Float32Array, magResponse: Float32Array, phaseResponse: Float32Array) : void {.importc:"BiquadFilterNode.getFrequencyResponse".}
var AudioDestinationNodeMaxChannelCount* {.importc:"AudioDestinationNode.maxChannelCount", nodecl.}: float
...
proc createBuffer*(self: AudioContext, numberOfChannels: float, length: float, sampleRate: float) : AudioBuffer {.importcpp.}
proc createBufferSource*(self: AudioContext) : AudioBufferSourceNode {.importcpp.}
proc createChannelMerger*(self: AudioContext, numberOfInputs: float) : ChannelMergerNode {.importcpp.}
proc createChannelSplitter*(self: AudioContext, numberOfOutputs: float) : ChannelSplitterNode {.importcpp.}
...
proc createMediaElementSource*(self: AudioContext, mediaElement: HTMLMediaElement) : MediaElementAudioSourceNode {.importcpp.}
proc createOscillator*(self: AudioContext) : OscillatorNode {.importcpp.}
proc createPanner*(self: AudioContext) : PannerNode {.importcpp.}
proc createPeriodicWave*(self: AudioContext, real: Float32Array, imag: Float32Array) : PeriodicWave {.importcpp.}
proc createScriptProcessor*(self: AudioContext, bufferSize: float, numberOfInputChannels: float, numberOfOutputChannels: float) : ScriptProcessorNode {.importcpp.}
...
proc decodeAudioData*(self: AudioContext, audioData: ArrayBuffer, successCallback: DecodeSuccessCallback, errorCallback: DecodeErrorCallback) : void {.importcpp.}
var AudioContextCurrentTime* {.importc:"AudioContext.currentTime", nodecl.}: float
var AudioContextDestination* {.importc:"AudioContext.destination", nodecl.}: AudioDestinationNode
var AudioContextListener* {.importc:"AudioContext.listener", nodecl.}: AudioListener
var AudioContextSampleRate* {.importc:"AudioContext.sampleRate", nodecl.}: float
...
proc AudioContextCreateBuffer*(numberOfChannels: float, length: float, sampleRate: float) : AudioBuffer {.importc:"AudioContext.createBuffer".}
...
proc AudioContextCreateChannelSplitter*(numberOfOutputs: float) : ChannelSplitterNode {.importc:"AudioContext.createChannelSplitter".}
...
proc AudioContextCreateMediaElementSource*(mediaElement: HTMLMediaElement) : MediaElementAudioSourceNode {.importc:"AudioContext.createMediaElementSource".}
...
proc AudioContextCreatePeriodicWave*(real: Float32Array, imag: Float32Array) : PeriodicWave {.importc:"AudioContext.createPeriodicWave".}
proc AudioContextCreateScriptProcessor*(bufferSize: float, numberOfInputChannels: float, numberOfOutputChannels: float) : ScriptProcessorNode {.importc:"AudioContext.createScriptProcessor".}
...
proc AudioContextDecodeAudioData*(audioData: ArrayBuffer, successCallback: DecodeSuccessCallback, errorCallback: DecodeErrorCallback) : void {.importc:"AudioContext.decodeAudioData".}
proc newAnalyserNode*() : AnalyserNode {.importcpp:"new AnalyserNode".}
proc getByteFrequencyData*(self: AnalyserNode, array: Uint8Array) : void {.importcpp.}
proc getByteTimeDomainData*(self: AnalyserNode, array: Uint8Array) : void {.importcpp.}
proc getFloatFrequencyData*(self: AnalyserNode, array: Float32Array) : void {.importcpp.}
proc getFloatTimeDomainData*(self: AnalyserNode, array: Float32Array) : void {.importcpp.}
...
proc initAnimationEvent*(self: AnimationEvent, typeArg: cstring, canBubbleArg: bool, cancelableArg: bool, animationNameArg: cstring, elapsedTimeArg: float) : void {.importcpp.}

type AriaRequestEvent* {.importc.} = ref object of Event
    attributeName* {.importc.}: cstring
    attributeValue* {.importc.}: cstring
proc newAriaRequestEvent*(xType: cstring, eventInitDict: AriaRequestEventInit) : AriaRequestEvent {.importcpp:"new AriaRequestEvent(@)".}
...
proc slice*(self: Blob, start: float, xEnd: float, contentType: cstring) : Blob {.importcpp.}
...
type StyleSheetPageList* {.importc.} = ref object of RootObj
    length* {.importc.}: float
var StyleSheetPageListLength* {.importc:"StyleSheetPageList.length", nodecl.}: float
...
proc addImport*(self: CSSStyleSheet, bstrURL: cstring, lIndex: float) : float {.importcpp.}
proc addPageRule*(self: CSSStyleSheet, bstrSelector: cstring, bstrStyle: cstring, lIndex: float) : float {.importcpp.}
proc addRule*(self: CSSStyleSheet, bstrSelector: cstring, bstrStyle: cstring, lIndex: float) : float {.importcpp.}
proc deleteRule*(self: CSSStyleSheet, index: float) : void {.importcpp.}
proc insertRule*(self: CSSStyleSheet, rule: cstring, index: float) : float {.importcpp.}
...
proc addColorStop*(self: CanvasGradient, offset: float, color: cstring) : void {.importcpp.}
...
var HTMLCanvasElementHeight* {.importc:"HTMLCanvasElement.height", nodecl.}: float
var HTMLCanvasElementWidth* {.importc:"HTMLCanvasElement.width", nodecl.}: float
...
type HTMLImageElement* {.importc.} = ref object of HTMLElement
    ...
    x* {.importc.}: float
    y* {.importc.}: float
var HTMLImageElementAlign* {.importc:"HTMLImageElement.align", nodecl.}: cstring
var HTMLImageElementAlt* {.importc:"HTMLImageElement.alt", nodecl.}: cstring
var HTMLImageElementBorder* {.importc:"HTMLImageElement.border", nodecl.}: cstring
var HTMLImageElementComplete* {.importc:"HTMLImageElement.complete", nodecl.}: bool
var HTMLImageElementCrossOrigin* {.importc:"HTMLImageElement.crossOrigin", nodecl.}: cstring
var HTMLImageElementCurrentSrc* {.importc:"HTMLImageElement.currentSrc", nodecl.}: cstring
var HTMLImageElementHeight* {.importc:"HTMLImageElement.height", nodecl.}: float
var HTMLImageElementHspace* {.importc:"HTMLImageElement.hspace", nodecl.}: float
var HTMLImageElementIsMap* {.importc:"HTMLImageElement.isMap", nodecl.}: bool
var HTMLImageElementLongDesc* {.importc:"HTMLImageElement.longDesc", nodecl.}: cstring
var HTMLImageElementMsPlayToDisabled* {.importc:"HTMLImageElement.msPlayToDisabled", nodecl.}: bool
var HTMLImageElementMsPlayToPreferredSourceUri* {.importc:"HTMLImageElement.msPlayToPreferredSourceUri", nodecl.}: cstring
...
var HTMLImageElementNaturalHeight* {.importc:"HTMLImageElement.naturalHeight", nodecl.}: float
var HTMLImageElementNaturalWidth* {.importc:"HTMLImageElement.naturalWidth", nodecl.}: float
var HTMLImageElementSrc* {.importc:"HTMLImageElement.src", nodecl.}: cstring
var HTMLImageElementSrcset* {.importc:"HTMLImageElement.srcset", nodecl.}: cstring
var HTMLImageElementUseMap* {.importc:"HTMLImageElement.useMap", nodecl.}: cstring
var HTMLImageElementVspace* {.importc:"HTMLImageElement.vspace", nodecl.}: float
...
var VideoPlaybackQualityCorruptedVideoFrames* {.importc:"VideoPlaybackQuality.corruptedVideoFrames", nodecl.}: float
var VideoPlaybackQualityCreationTime* {.importc:"VideoPlaybackQuality.creationTime", nodecl.}: float
var VideoPlaybackQualityDroppedVideoFrames* {.importc:"VideoPlaybackQuality.droppedVideoFrames", nodecl.}: float
var VideoPlaybackQualityTotalFrameDelay* {.importc:"VideoPlaybackQuality.totalFrameDelay", nodecl.}: float
var VideoPlaybackQualityTotalVideoFrames* {.importc:"VideoPlaybackQuality.totalVideoFrames", nodecl.}: float
...
proc msSetVideoRectangle*(self: HTMLVideoElement, left: float, top: float, right: float, bottom: float) : void {.importcpp.}
...
proc addEventListener*(self: HTMLVideoElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: HTMLVideoElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var HTMLVideoElementHeight* {.importc:"HTMLVideoElement.height", nodecl.}: float
var HTMLVideoElementMsHorizontalMirror* {.importc:"HTMLVideoElement.msHorizontalMirror", nodecl.}: bool
var HTMLVideoElementMsIsLayoutOptimalForPlayback* {.importc:"HTMLVideoElement.msIsLayoutOptimalForPlayback", nodecl.}: bool
var HTMLVideoElementMsIsStereo3D* {.importc:"HTMLVideoElement.msIsStereo3D", nodecl.}: bool
var HTMLVideoElementMsStereo3DPackingMode* {.importc:"HTMLVideoElement.msStereo3DPackingMode", nodecl.}: cstring
var HTMLVideoElementMsStereo3DRenderMode* {.importc:"HTMLVideoElement.msStereo3DRenderMode", nodecl.}: cstring
var HTMLVideoElementMsZoom* {.importc:"HTMLVideoElement.msZoom", nodecl.}: bool
var HTMLVideoElementPoster* {.importc:"HTMLVideoElement.poster", nodecl.}: cstring
var HTMLVideoElementVideoHeight* {.importc:"HTMLVideoElement.videoHeight", nodecl.}: float
var HTMLVideoElementVideoWidth* {.importc:"HTMLVideoElement.videoWidth", nodecl.}: float
var HTMLVideoElementWebkitDisplayingFullscreen* {.importc:"HTMLVideoElement.webkitDisplayingFullscreen", nodecl.}: bool
var HTMLVideoElementWebkitSupportsFullscreen* {.importc:"HTMLVideoElement.webkitSupportsFullscreen", nodecl.}: bool
...
proc HTMLVideoElementMsSetVideoRectangle*(left: float, top: float, right: float, bottom: float) : void {.importc:"HTMLVideoElement.msSetVideoRectangle".}
...
proc HTMLVideoElementAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"HTMLVideoElement.addEventListener".}
proc HTMLVideoElementAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"HTMLVideoElement.addEventListener".}
...
proc arc*(self: CanvasRenderingContext2D, x: float, y: float, radius: float, startAngle: float, endAngle: float, anticlockwise: bool) : void {.importcpp.}
proc arcTo*(self: CanvasRenderingContext2D, x1: float, y1: float, x2: float, y2: float, radius: float) : void {.importcpp.}
proc beginPath*(self: CanvasRenderingContext2D) : void {.importcpp.}
proc bezierCurveTo*(self: CanvasRenderingContext2D, cp1x: float, cp1y: float, cp2x: float, cp2y: float, x: float, y: float) : void {.importcpp.}
proc clearRect*(self: CanvasRenderingContext2D, x: float, y: float, w: float, h: float) : void {.importcpp.}
proc clip*(self: CanvasRenderingContext2D, fillRule: cstring) : void {.importcpp.}
proc closePath*(self: CanvasRenderingContext2D) : void {.importcpp.}
proc createImageData*(self: CanvasRenderingContext2D, imageDataOrSw: float, sh: float) : ImageData {.importcpp.}
proc createImageData*(self: CanvasRenderingContext2D, imageDataOrSw: ImageData, sh: float) : ImageData {.importcpp.}
proc createLinearGradient*(self: CanvasRenderingContext2D, x0: float, y0: float, x1: float, y1: float) : CanvasGradient {.importcpp.}
proc createPattern*(self: CanvasRenderingContext2D, image: HTMLImageElement, repetition: cstring) : CanvasPattern {.importcpp.}
proc createPattern*(self: CanvasRenderingContext2D, image: HTMLCanvasElement, repetition: cstring) : CanvasPattern {.importcpp.}
proc createPattern*(self: CanvasRenderingContext2D, image: HTMLVideoElement, repetition: cstring) : CanvasPattern {.importcpp.}
proc createRadialGradient*(self: CanvasRenderingContext2D, x0: float, y0: float, r0: float, x1: float, y1: float, r1: float) : CanvasGradient {.importcpp.}
proc drawImage*(self: CanvasRenderingContext2D, image: HTMLImageElement, offsetX: float, offsetY: float, width: float, height: float, canvasOffsetX: float, canvasOffsetY: float, canvasImageWidth: float, canvasImageHeight: float) : void {.importcpp.}
proc drawImage*(self: CanvasRenderingContext2D, image: HTMLCanvasElement, offsetX: float, offsetY: float, width: float, height: float, canvasOffsetX: float, canvasOffsetY: float, canvasImageWidth: float, canvasImageHeight: float) : void {.importcpp.}
proc drawImage*(self: CanvasRenderingContext2D, image: HTMLVideoElement, offsetX: float, offsetY: float, width: float, height: float, canvasOffsetX: float, canvasOffsetY: float, canvasImageWidth: float, canvasImageHeight: float) : void {.importcpp.}
proc fill*(self: CanvasRenderingContext2D, fillRule: cstring) : void {.importcpp.}
proc fillRect*(self: CanvasRenderingContext2D, x: float, y: float, w: float, h: float) : void {.importcpp.}
proc fillText*(self: CanvasRenderingContext2D, text: cstring, x: float, y: float, maxWidth: float) : void {.importcpp.}
proc getImageData*(self: CanvasRenderingContext2D, sx: float, sy: float, sw: float, sh: float) : ImageData {.importcpp.}
proc isPointInPath*(self: CanvasRenderingContext2D, x: float, y: float, fillRule: cstring) : bool {.importcpp.}
proc lineTo*(self: CanvasRenderingContext2D, x: float, y: float) : void {.importcpp.}
proc measureText*(self: CanvasRenderingContext2D, text: cstring) : TextMetrics {.importcpp.}
proc moveTo*(self: CanvasRenderingContext2D, x: float, y: float) : void {.importcpp.}
proc putImageData*(self: CanvasRenderingContext2D, imagedata: ImageData, dx: float, dy: float, dirtyX: float, dirtyY: float, dirtyWidth: float, dirtyHeight: float) : void {.importcpp.}
proc quadraticCurveTo*(self: CanvasRenderingContext2D, cpx: float, cpy: float, x: float, y: float) : void {.importcpp.}
proc rect*(self: CanvasRenderingContext2D, x: float, y: float, w: float, h: float) : void {.importcpp.}
...
proc scale*(self: CanvasRenderingContext2D, x: float, y: float) : void {.importcpp.}
proc setTransform*(self: CanvasRenderingContext2D, m11: float, m12: float, m21: float, m22: float, dx: float, dy: float) : void {.importcpp.}
proc stroke*(self: CanvasRenderingContext2D) : void {.importcpp.}
proc strokeRect*(self: CanvasRenderingContext2D, x: float, y: float, w: float, h: float) : void {.importcpp.}
proc strokeText*(self: CanvasRenderingContext2D, text: cstring, x: float, y: float, maxWidth: float) : void {.importcpp.}
proc transform*(self: CanvasRenderingContext2D, m11: float, m12: float, m21: float, m22: float, dx: float, dy: float) : void {.importcpp.}
proc translate*(self: CanvasRenderingContext2D, x: float, y: float) : void {.importcpp.}
...
proc getAsString*(self: DataTransferItem, zCallback: FunctionStringCallback) : void {.importcpp.}
...
var DataTransferItemListLength* {.importc:"DataTransferItemList.length", nodecl.}: float
...
proc setData*(self: DataTransfer, format: cstring, data: cstring) : bool {.importcpp.}
var DataTransferDropEffect* {.importc:"DataTransfer.dropEffect", nodecl.}: cstring
var DataTransferEffectAllowed* {.importc:"DataTransfer.effectAllowed", nodecl.}: cstring
var DataTransferFiles* {.importc:"DataTransfer.files", nodecl.}: FileList
var DataTransferItems* {.importc:"DataTransfer.items", nodecl.}: DataTransferItemList
...
proc DataTransferSetData*(format: cstring, data: cstring) : bool {.importc:"DataTransfer.setData".}
...
proc initCloseEvent*(self: CloseEvent, typeArg: cstring, canBubbleArg: bool, cancelableArg: bool, wasCleanArg: bool, codeArg: float, reasonArg: cstring) : void {.importcpp.}
...
proc initUIEvent*(self: UIEvent, typeArg: cstring, canBubbleArg: bool, cancelableArg: bool, viewArg: Window, detailArg: float) : void {.importcpp.}

type CompositionEvent* {.importc.} = ref object of UIEvent
    data* {.importc.}: cstring
    locale* {.importc.}: cstring
proc newCompositionEvent*(typeArg: cstring, eventInitDict: CompositionEventInit) : CompositionEvent {.importcpp:"new CompositionEvent(@)".}
proc initCompositionEvent*(self: CompositionEvent, typeArg: cstring, canBubbleArg: bool, cancelableArg: bool, viewArg: Window, dataArg: cstring, locale: cstring) : void {.importcpp.}
...
proc msIsIndependentlyComposed*(self: Console, element: Element) : bool {.importcpp.}
...
var DOMExceptionDATA_CLONE_ERR* {.importc:"DOMException.DATA_CLONE_ERR", nodecl.}: float
var DOMExceptionDOMSTRING_SIZE_ERR* {.importc:"DOMException.DOMSTRING_SIZE_ERR", nodecl.}: float
var DOMExceptionHIERARCHY_REQUEST_ERR* {.importc:"DOMException.HIERARCHY_REQUEST_ERR", nodecl.}: float
var DOMExceptionINDEX_SIZE_ERR* {.importc:"DOMException.INDEX_SIZE_ERR", nodecl.}: float
var DOMExceptionINUSE_ATTRIBUTE_ERR* {.importc:"DOMException.INUSE_ATTRIBUTE_ERR", nodecl.}: float
var DOMExceptionINVALID_ACCESS_ERR* {.importc:"DOMException.INVALID_ACCESS_ERR", nodecl.}: float
var DOMExceptionINVALID_CHARACTER_ERR* {.importc:"DOMException.INVALID_CHARACTER_ERR", nodecl.}: float
var DOMExceptionINVALID_MODIFICATION_ERR* {.importc:"DOMException.INVALID_MODIFICATION_ERR", nodecl.}: float
var DOMExceptionINVALID_NODE_TYPE_ERR* {.importc:"DOMException.INVALID_NODE_TYPE_ERR", nodecl.}: float
var DOMExceptionINVALID_STATE_ERR* {.importc:"DOMException.INVALID_STATE_ERR", nodecl.}: float
var DOMExceptionNAMESPACE_ERR* {.importc:"DOMException.NAMESPACE_ERR", nodecl.}: float
var DOMExceptionNETWORK_ERR* {.importc:"DOMException.NETWORK_ERR", nodecl.}: float
var DOMExceptionNOT_FOUND_ERR* {.importc:"DOMException.NOT_FOUND_ERR", nodecl.}: float
var DOMExceptionNOT_SUPPORTED_ERR* {.importc:"DOMException.NOT_SUPPORTED_ERR", nodecl.}: float
var DOMExceptionNO_DATA_ALLOWED_ERR* {.importc:"DOMException.NO_DATA_ALLOWED_ERR", nodecl.}: float
var DOMExceptionNO_MODIFICATION_ALLOWED_ERR* {.importc:"DOMException.NO_MODIFICATION_ALLOWED_ERR", nodecl.}: float
var DOMExceptionPARSE_ERR* {.importc:"DOMException.PARSE_ERR", nodecl.}: float
var DOMExceptionQUOTA_EXCEEDED_ERR* {.importc:"DOMException.QUOTA_EXCEEDED_ERR", nodecl.}: float
var DOMExceptionSECURITY_ERR* {.importc:"DOMException.SECURITY_ERR", nodecl.}: float
var DOMExceptionSERIALIZE_ERR* {.importc:"DOMException.SERIALIZE_ERR", nodecl.}: float
var DOMExceptionSYNTAX_ERR* {.importc:"DOMException.SYNTAX_ERR", nodecl.}: float
var DOMExceptionTIMEOUT_ERR* {.importc:"DOMException.TIMEOUT_ERR", nodecl.}: float
var DOMExceptionTYPE_MISMATCH_ERR* {.importc:"DOMException.TYPE_MISMATCH_ERR", nodecl.}: float
var DOMExceptionURL_MISMATCH_ERR* {.importc:"DOMException.URL_MISMATCH_ERR", nodecl.}: float
var DOMExceptionVALIDATION_ERR* {.importc:"DOMException.VALIDATION_ERR", nodecl.}: float
var DOMExceptionWRONG_DOCUMENT_ERR* {.importc:"DOMException.WRONG_DOCUMENT_ERR", nodecl.}: float

type DOMParser* {.importc.} = ref object of RootObj
proc newDOMParser*() : DOMParser {.importcpp:"new DOMParser".}
proc parseFromString*(self: DOMParser, source: cstring, mimeType: cstring) : Document {.importcpp.}
...
type DeviceRotationRate* {.importc.} = ref object of RootObj
    ...
    beta* {.importc.}: float
    gamma* {.importc.}: float
var DeviceRotationRateAlpha* {.importc:"DeviceRotationRate.alpha", nodecl.}: float
var DeviceRotationRateBeta* {.importc:"DeviceRotationRate.beta", nodecl.}: float
var DeviceRotationRateGamma* {.importc:"DeviceRotationRate.gamma", nodecl.}: float
...
proc initDeviceMotionEvent*(self: DeviceMotionEvent, xType: cstring, bubbles: bool, cancelable: bool, acceleration: DeviceAccelerationDict, accelerationIncludingGravity: DeviceAccelerationDict, rotationRate: DeviceRotationRateDict, interval: float) : void {.importcpp.}
...
proc initDeviceOrientationEvent*(self: DeviceOrientationEvent, xType: cstring, bubbles: bool, cancelable: bool, alpha: float, beta: float, gamma: float, absolute: bool) : void {.importcpp.}
...
var MouseEventFromElement* {.importc:"MouseEvent.fromElement", nodecl.}: Element
...
var MouseEventRelatedTarget* {.importc:"MouseEvent.relatedTarget", nodecl.}: EventTarget
...
proc MouseEventInitMouseEvent*(typeArg: cstring, canBubbleArg: bool, cancelableArg: bool, viewArg: Window, detailArg: float, screenXArg: float, screenYArg: float, clientXArg: float, clientYArg: float, ctrlKeyArg: bool, altKeyArg: bool, shiftKeyArg: bool, metaKeyArg: bool, buttonArg: float, relatedTargetArg: EventTarget) : void {.importc:"MouseEvent.initMouseEvent".}

type DragEvent* {.importc.} = ref object of MouseEvent
    dataTransfer* {.importc.}: DataTransfer
proc initDragEvent*(self: DragEvent, typeArg: cstring, canBubbleArg: bool, cancelableArg: bool, viewArg: Window, detailArg: float, screenXArg: float, screenYArg: float, clientXArg: float, clientYArg: float, ctrlKeyArg: bool, altKeyArg: bool, shiftKeyArg: bool, metaKeyArg: bool, buttonArg: float, relatedTargetArg: EventTarget, dataTransferArg: DataTransfer) : void {.importcpp.}
proc msConvertURL*(self: DragEvent, file: File, targetType: cstring, targetURL: cstring) : void {.importcpp.}
var DragEventDataTransfer* {.importc:"DragEvent.dataTransfer", nodecl.}: DataTransfer
proc DragEventInitDragEvent*(typeArg: cstring, canBubbleArg: bool, cancelableArg: bool, viewArg: Window, detailArg: float, screenXArg: float, screenYArg: float, clientXArg: float, clientYArg: float, ctrlKeyArg: bool, altKeyArg: bool, shiftKeyArg: bool, metaKeyArg: bool, buttonArg: float, relatedTargetArg: EventTarget, dataTransferArg: DataTransfer) : void {.importc:"DragEvent.initDragEvent".}
proc DragEventMsConvertURL*(file: File, targetType: cstring, targetURL: cstring) : void {.importc:"DragEvent.msConvertURL".}
...
var EXT_texture_filter_anisotropicMAX_TEXTURE_MAX_ANISOTROPY_EXT* {.importc:"EXT_texture_filter_anisotropic.MAX_TEXTURE_MAX_ANISOTROPY_EXT", nodecl.}: float
var EXT_texture_filter_anisotropicTEXTURE_MAX_ANISOTROPY_EXT* {.importc:"EXT_texture_filter_anisotropic.TEXTURE_MAX_ANISOTROPY_EXT", nodecl.}: float
...
proc initErrorEvent*(self: ErrorEvent, typeArg: cstring, canBubbleArg: bool, cancelableArg: bool, messageArg: cstring, filenameArg: cstring, linenoArg: float) : void {.importcpp.}
...
proc readAsText*(self: FileReader, blob: Blob, encoding: cstring) : void {.importcpp.}
proc addEventListener*(self: FileReader, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: FileReader, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}

type FocusEvent* {.importc.} = ref object of UIEvent
    relatedTarget* {.importc.}: EventTarget
proc initFocusEvent*(self: FocusEvent, typeArg: cstring, canBubbleArg: bool, cancelableArg: bool, viewArg: Window, detailArg: float, relatedTargetArg: EventTarget) : void {.importcpp.}
var FocusEventRelatedTarget* {.importc:"FocusEvent.relatedTarget", nodecl.}: EventTarget
proc FocusEventInitFocusEvent*(typeArg: cstring, canBubbleArg: bool, cancelableArg: bool, viewArg: Window, detailArg: float, relatedTargetArg: EventTarget) : void {.importc:"FocusEvent.initFocusEvent".}
...
var HTMLFormElementAcceptCharset* {.importc:"HTMLFormElement.acceptCharset", nodecl.}: cstring
var HTMLFormElementAction* {.importc:"HTMLFormElement.action", nodecl.}: cstring
var HTMLFormElementAutocomplete* {.importc:"HTMLFormElement.autocomplete", nodecl.}: cstring
var HTMLFormElementElements* {.importc:"HTMLFormElement.elements", nodecl.}: HTMLCollection
var HTMLFormElementEncoding* {.importc:"HTMLFormElement.encoding", nodecl.}: cstring
var HTMLFormElementEnctype* {.importc:"HTMLFormElement.enctype", nodecl.}: cstring
var HTMLFormElementLength* {.importc:"HTMLFormElement.length", nodecl.}: float
var HTMLFormElementMethod* {.importc:"HTMLFormElement.method", nodecl.}: cstring
...
var HTMLFormElementTarget* {.importc:"HTMLFormElement.target", nodecl.}: cstring
...
proc getCurrentPosition*(self: Geolocation, successCallback: PositionCallback, errorCallback: PositionErrorCallback, options: PositionOptions) : void {.importcpp.}
proc watchPosition*(self: Geolocation, successCallback: PositionCallback, errorCallback: PositionErrorCallback, options: PositionOptions) : float {.importcpp.}
...
proc add*(self: HTMLAreasCollection, element: HTMLElement, before: HTMLElement) : void {.importcpp.}
proc add*(self: HTMLAreasCollection, element: HTMLElement, before: float) : void {.importcpp.}
...
proc addEventListener*(self: HTMLBaseFontElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: HTMLBaseFontElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc compareEndPoints*(self: TextRange, how: cstring, sourceRange: TextRange) : float {.importcpp.}
...
proc findText*(self: TextRange, string: cstring, count: float, flags: float) : bool {.importcpp.}
...
proc moveStart*(self: TextRange, unit: cstring, count: float) : float {.importcpp.}
...
proc setEndPoint*(self: TextRange, how: cstring, SourceRange: TextRange) : void {.importcpp.}
var TextRangeBoundingHeight* {.importc:"TextRange.boundingHeight", nodecl.}: float
...
var TextRangeBoundingWidth* {.importc:"TextRange.boundingWidth", nodecl.}: float
...
proc TextRangeCompareEndPoints*(how: cstring, sourceRange: TextRange) : float {.importc:"TextRange.compareEndPoints".}
...
proc TextRangeFindText*(string: cstring, count: float, flags: float) : bool {.importc:"TextRange.findText".}
...
proc TextRangeSetEndPoint*(how: cstring, SourceRange: TextRange) : void {.importc:"TextRange.setEndPoint".}
...
proc addEventListener*(self: HTMLBodyElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: HTMLBodyElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc setCustomValidity*(self: HTMLButtonElement, error: cstring) : void {.importcpp.}
...
proc addEventListener*(self: HTMLEmbedElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: HTMLEmbedElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc setCustomValidity*(self: HTMLFieldSetElement, error: cstring) : void {.importcpp.}
...
proc addEventListener*(self: HTMLFontElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: HTMLFontElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: HTMLFrameElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: HTMLFrameElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: HTMLFrameSetElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: HTMLFrameSetElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: HTMLHRElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: HTMLHRElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: HTMLIFrameElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: HTMLIFrameElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc setCustomValidity*(self: HTMLInputElement, error: cstring) : void {.importcpp.}
proc setSelectionRange*(self: HTMLInputElement, start: float, xEnd: float) : void {.importcpp.}
...
proc addEventListener*(self: HTMLLinkElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: HTMLLinkElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: HTMLMarqueeElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: HTMLMarqueeElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc setCustomValidity*(self: HTMLObjectElement, error: cstring) : void {.importcpp.}
proc addEventListener*(self: HTMLObjectElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: HTMLObjectElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc add*(self: HTMLSelectElement, element: HTMLElement, before: HTMLElement) : void {.importcpp.}
proc add*(self: HTMLSelectElement, element: HTMLElement, before: float) : void {.importcpp.}
proc checkValidity*(self: HTMLSelectElement) : bool {.importcpp.}
proc remove*(self: HTMLSelectElement, index: float) : void {.importcpp.}
proc setCustomValidity*(self: HTMLSelectElement, error: cstring) : void {.importcpp.}
...
proc addEventListener*(self: HTMLStyleElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: HTMLStyleElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: HTMLTableCellElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: HTMLTableCellElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: HTMLTableColElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: HTMLTableColElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc insertCell*(self: HTMLTableRowElement, index: float) : HTMLTableCellElement {.importcpp.}
proc addEventListener*(self: HTMLTableRowElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: HTMLTableRowElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var HTMLTableRowElementAlign* {.importc:"HTMLTableRowElement.align", nodecl.}: cstring
var HTMLTableRowElementCells* {.importc:"HTMLTableRowElement.cells", nodecl.}: HTMLCollection
var HTMLTableRowElementRowIndex* {.importc:"HTMLTableRowElement.rowIndex", nodecl.}: float
var HTMLTableRowElementSectionRowIndex* {.importc:"HTMLTableRowElement.sectionRowIndex", nodecl.}: float
...
proc HTMLTableRowElementAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"HTMLTableRowElement.addEventListener".}
proc HTMLTableRowElementAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"HTMLTableRowElement.addEventListener".}
...
proc insertRow*(self: HTMLTableSectionElement, index: float) : HTMLTableRowElement {.importcpp.}
proc addEventListener*(self: HTMLTableSectionElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: HTMLTableSectionElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var HTMLTableSectionElementAlign* {.importc:"HTMLTableSectionElement.align", nodecl.}: cstring
var HTMLTableSectionElementRows* {.importc:"HTMLTableSectionElement.rows", nodecl.}: HTMLCollection
...
proc HTMLTableSectionElementAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"HTMLTableSectionElement.addEventListener".}
proc HTMLTableSectionElementAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"HTMLTableSectionElement.addEventListener".}
...
proc setCustomValidity*(self: HTMLTextAreaElement, error: cstring) : void {.importcpp.}
proc setSelectionRange*(self: HTMLTextAreaElement, start: float, xEnd: float) : void {.importcpp.}
...
var HTMLTrackElementLOADED* {.importc:"HTMLTrackElement.LOADED", nodecl.}: float
var HTMLTrackElementLOADING* {.importc:"HTMLTrackElement.LOADING", nodecl.}: float
...
type HashChangeEvent* {.importc.} = ref object of Event
    newURL* {.importc.}: cstring
    oldURL* {.importc.}: cstring
var HashChangeEventNewURL* {.importc:"HashChangeEvent.newURL", nodecl.}: cstring
var HashChangeEventOldURL* {.importc:"HashChangeEvent.oldURL", nodecl.}: cstring
...
proc openCursor*(self: IDBIndex, range: IDBKeyRange, direction: cstring) : IDBRequest {.importcpp.}
proc openKeyCursor*(self: IDBIndex, range: IDBKeyRange, direction: cstring) : IDBRequest {.importcpp.}
...
var IDBObjectStoreIndexNames* {.importc:"IDBObjectStore.indexNames", nodecl.}: DOMStringList
var IDBObjectStoreKeyPath* {.importc:"IDBObjectStore.keyPath", nodecl.}: cstring
var IDBObjectStoreName* {.importc:"IDBObjectStore.name", nodecl.}: cstring
var IDBObjectStoreTransaction* {.importc:"IDBObjectStore.transaction", nodecl.}: IDBTransaction
...
proc createObjectStore*(self: IDBDatabase, name: cstring, optionalParameters: IDBObjectStoreParameters) : IDBObjectStore {.importcpp.}
proc deleteObjectStore*(self: IDBDatabase, name: cstring) : void {.importcpp.}
proc addEventListener*(self: IDBDatabase, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: IDBDatabase, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
proc abort*(self: IDBTransaction) : void {.importcpp.}
proc objectStore*(self: IDBTransaction, name: cstring) : IDBObjectStore {.importcpp.}
proc addEventListener*(self: IDBTransaction, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: IDBTransaction, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
var IDBTransactionREAD_ONLY* {.importc:"IDBTransaction.READ_ONLY", nodecl.}: cstring
var IDBTransactionREAD_WRITE* {.importc:"IDBTransaction.READ_WRITE", nodecl.}: cstring
var IDBTransactionVERSION_CHANGE* {.importc:"IDBTransaction.VERSION_CHANGE", nodecl.}: cstring
...
proc IDBTransactionAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"IDBTransaction.addEventListener".}
proc IDBTransactionAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"IDBTransaction.addEventListener".}
proc addEventListener*(self: IDBRequest, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: IDBRequest, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
var IDBRequestTransaction* {.importc:"IDBRequest.transaction", nodecl.}: IDBTransaction
proc IDBRequestAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"IDBRequest.addEventListener".}
proc IDBRequestAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"IDBRequest.addEventListener".}
...
var IDBCursorNEXT_NO_DUPLICATE* {.importc:"IDBCursor.NEXT_NO_DUPLICATE", nodecl.}: cstring
var IDBCursorPREV* {.importc:"IDBCursor.PREV", nodecl.}: cstring
var IDBCursorPREV_NO_DUPLICATE* {.importc:"IDBCursor.PREV_NO_DUPLICATE", nodecl.}: cstring
...
proc addEventListener*(self: IDBOpenDBRequest, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: IDBOpenDBRequest, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
proc IDBOpenDBRequestAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"IDBOpenDBRequest.addEventListener".}
proc IDBOpenDBRequestAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"IDBOpenDBRequest.addEventListener".}
...
proc open*(self: IDBFactory, name: cstring, version: float) : IDBOpenDBRequest {.importcpp.}

type IDBVersionChangeEvent* {.importc.} = ref object of Event
    newVersion* {.importc.}: float
    oldVersion* {.importc.}: float
var IDBVersionChangeEventNewVersion* {.importc:"IDBVersionChangeEvent.newVersion", nodecl.}: float
var IDBVersionChangeEventOldVersion* {.importc:"IDBVersionChangeEvent.oldVersion", nodecl.}: float
...
proc initKeyboardEvent*(self: KeyboardEvent, typeArg: cstring, canBubbleArg: bool, cancelableArg: bool, viewArg: Window, keyArg: cstring, locationArg: float, modifiersListArg: cstring, repeat: bool, locale: cstring) : void {.importcpp.}
...
var KeyboardEventDOM_KEY_LOCATION_JOYSTICK* {.importc:"KeyboardEvent.DOM_KEY_LOCATION_JOYSTICK", nodecl.}: float
var KeyboardEventDOM_KEY_LOCATION_LEFT* {.importc:"KeyboardEvent.DOM_KEY_LOCATION_LEFT", nodecl.}: float
var KeyboardEventDOM_KEY_LOCATION_MOBILE* {.importc:"KeyboardEvent.DOM_KEY_LOCATION_MOBILE", nodecl.}: float
var KeyboardEventDOM_KEY_LOCATION_NUMPAD* {.importc:"KeyboardEvent.DOM_KEY_LOCATION_NUMPAD", nodecl.}: float
var KeyboardEventDOM_KEY_LOCATION_RIGHT* {.importc:"KeyboardEvent.DOM_KEY_LOCATION_RIGHT", nodecl.}: float
var KeyboardEventDOM_KEY_LOCATION_STANDARD* {.importc:"KeyboardEvent.DOM_KEY_LOCATION_STANDARD", nodecl.}: float
proc KeyboardEventGetModifierState*(keyArg: cstring) : bool {.importc:"KeyboardEvent.getModifierState".}
proc KeyboardEventInitKeyboardEvent*(typeArg: cstring, canBubbleArg: bool, cancelableArg: bool, viewArg: Window, keyArg: cstring, locationArg: float, modifiersListArg: cstring, repeat: bool, locale: cstring) : void {.importc:"KeyboardEvent.initKeyboardEvent".}
...
proc addEventListener*(self: MSAppAsyncOperation, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: MSAppAsyncOperation, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var MSAppAsyncOperationError* {.importc:"MSAppAsyncOperation.error", nodecl.}: DOMError
var MSAppAsyncOperationReadyState* {.importc:"MSAppAsyncOperation.readyState", nodecl.}: float
var MSAppAsyncOperationCOMPLETED* {.importc:"MSAppAsyncOperation.COMPLETED", nodecl.}: float
var MSAppAsyncOperationSTARTED* {.importc:"MSAppAsyncOperation.STARTED", nodecl.}: float
proc MSAppAsyncOperationStart*() : void {.importc:"MSAppAsyncOperation.start".}
proc MSAppAsyncOperationAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"MSAppAsyncOperation.addEventListener".}
proc MSAppAsyncOperationAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"MSAppAsyncOperation.addEventListener".}
...
proc isTaskScheduledAtPriorityOrHigher*(self: MSApp, priority: cstring) : bool {.importcpp.}
proc pageHandlesAllApplicationActivations*(self: MSApp, enabled: bool) : void {.importcpp.}
proc suppressSubdownloadCredentialPrompts*(self: MSApp, suppress: bool) : void {.importcpp.}
...
proc MSAppIsTaskScheduledAtPriorityOrHigher*(priority: cstring) : bool {.importc:"MSApp.isTaskScheduledAtPriorityOrHigher".}
proc MSAppPageHandlesAllApplicationActivations*(enabled: bool) : void {.importc:"MSApp.pageHandlesAllApplicationActivations".}
proc MSAppSuppressSubdownloadCredentialPrompts*(suppress: bool) : void {.importc:"MSApp.suppressSubdownloadCredentialPrompts".}
...
proc rotate*(self: MSCSSMatrix, angleX: float, angleY: float, angleZ: float) : MSCSSMatrix {.importcpp.}
proc rotateAxisAngle*(self: MSCSSMatrix, x: float, y: float, z: float, angle: float) : MSCSSMatrix {.importcpp.}
proc scale*(self: MSCSSMatrix, scaleX: float, scaleY: float, scaleZ: float) : MSCSSMatrix {.importcpp.}
...
proc translate*(self: MSCSSMatrix, x: float, y: float, z: float) : MSCSSMatrix {.importcpp.}
...
var MSGestureEventExpansion* {.importc:"MSGestureEvent.expansion", nodecl.}: float
var MSGestureEventHwTimestamp* {.importc:"MSGestureEvent.hwTimestamp", nodecl.}: float
...
var MSGestureEventRotation* {.importc:"MSGestureEvent.rotation", nodecl.}: float
...
var MSGestureEventTranslationX* {.importc:"MSGestureEvent.translationX", nodecl.}: float
var MSGestureEventTranslationY* {.importc:"MSGestureEvent.translationY", nodecl.}: float
var MSGestureEventVelocityAngular* {.importc:"MSGestureEvent.velocityAngular", nodecl.}: float
var MSGestureEventVelocityExpansion* {.importc:"MSGestureEvent.velocityExpansion", nodecl.}: float
var MSGestureEventVelocityX* {.importc:"MSGestureEvent.velocityX", nodecl.}: float
var MSGestureEventVelocityY* {.importc:"MSGestureEvent.velocityY", nodecl.}: float
var MSGestureEventMSGESTURE_FLAG_BEGIN* {.importc:"MSGestureEvent.MSGESTURE_FLAG_BEGIN", nodecl.}: float
var MSGestureEventMSGESTURE_FLAG_CANCEL* {.importc:"MSGestureEvent.MSGESTURE_FLAG_CANCEL", nodecl.}: float
var MSGestureEventMSGESTURE_FLAG_END* {.importc:"MSGestureEvent.MSGESTURE_FLAG_END", nodecl.}: float
var MSGestureEventMSGESTURE_FLAG_INERTIA* {.importc:"MSGestureEvent.MSGESTURE_FLAG_INERTIA", nodecl.}: float
var MSGestureEventMSGESTURE_FLAG_NONE* {.importc:"MSGestureEvent.MSGESTURE_FLAG_NONE", nodecl.}: float
proc MSGestureEventInitGestureEvent*(typeArg: cstring, canBubbleArg: bool, cancelableArg: bool, viewArg: Window, detailArg: float, screenXArg: float, screenYArg: float, clientXArg: float, clientYArg: float, offsetXArg: float, offsetYArg: float, translationXArg: float, translationYArg: float, scaleArg: float, expansionArg: float, rotationArg: float, velocityXArg: float, velocityYArg: float, velocityExpansionArg: float, velocityAngularArg: float, hwTimestampArg: float) : void {.importc:"MSGestureEvent.initGestureEvent".}

type MSWebViewSettings* {.importc.} = ref object of RootObj
    isIndexedDBEnabled* {.importc.}: bool
    isJavaScriptEnabled* {.importc.}: bool
var MSWebViewSettingsIsIndexedDBEnabled* {.importc:"MSWebViewSettings.isIndexedDBEnabled", nodecl.}: bool
var MSWebViewSettingsIsJavaScriptEnabled* {.importc:"MSWebViewSettings.isJavaScriptEnabled", nodecl.}: bool
...
proc addEventListener*(self: MSWebViewAsyncOperation, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: MSWebViewAsyncOperation, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var MSWebViewAsyncOperationError* {.importc:"MSWebViewAsyncOperation.error", nodecl.}: DOMError
var MSWebViewAsyncOperationReadyState* {.importc:"MSWebViewAsyncOperation.readyState", nodecl.}: float
var MSWebViewAsyncOperationTarget* {.importc:"MSWebViewAsyncOperation.target", nodecl.}: MSHTMLWebViewElement
var MSWebViewAsyncOperationType* {.importc:"MSWebViewAsyncOperation.type", nodecl.}: float
var MSWebViewAsyncOperationCOMPLETED* {.importc:"MSWebViewAsyncOperation.COMPLETED", nodecl.}: float
var MSWebViewAsyncOperationSTARTED* {.importc:"MSWebViewAsyncOperation.STARTED", nodecl.}: float
var MSWebViewAsyncOperationTYPE_CAPTURE_PREVIEW_TO_RANDOM_ACCESS_STREAM* {.importc:"MSWebViewAsyncOperation.TYPE_CAPTURE_PREVIEW_TO_RANDOM_ACCESS_STREAM", nodecl.}: float
var MSWebViewAsyncOperationTYPE_CREATE_DATA_PACKAGE_FROM_SELECTION* {.importc:"MSWebViewAsyncOperation.TYPE_CREATE_DATA_PACKAGE_FROM_SELECTION", nodecl.}: float
var MSWebViewAsyncOperationTYPE_INVOKE_SCRIPT* {.importc:"MSWebViewAsyncOperation.TYPE_INVOKE_SCRIPT", nodecl.}: float
proc MSWebViewAsyncOperationStart*() : void {.importc:"MSWebViewAsyncOperation.start".}
proc MSWebViewAsyncOperationAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"MSWebViewAsyncOperation.addEventListener".}
proc MSWebViewAsyncOperationAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"MSWebViewAsyncOperation.addEventListener".}
proc newMSHTMLWebViewElement*() : MSHTMLWebViewElement {.importcpp:"new MSHTMLWebViewElement".}
proc buildLocalStreamUri*(self: MSHTMLWebViewElement, contentIdentifier: cstring, relativePath: cstring) : cstring {.importcpp.}
proc capturePreviewToBlobAsync*(self: MSHTMLWebViewElement) : MSWebViewAsyncOperation {.importcpp.}
proc captureSelectedContentToDataPackageAsync*(self: MSHTMLWebViewElement) : MSWebViewAsyncOperation {.importcpp.}
proc getDeferredPermissionRequestById*(self: MSHTMLWebViewElement, id: float) : DeferredPermissionRequest {.importcpp.}
...
proc navigateToString*(self: MSHTMLWebViewElement, contents: cstring) : void {.importcpp.}
...
proc initMSManipulationEvent*(self: MSManipulationEvent, typeArg: cstring, canBubbleArg: bool, cancelableArg: bool, viewArg: Window, detailArg: float, lastState: float, currentState: float) : void {.importcpp.}
var MSManipulationEventCurrentState* {.importc:"MSManipulationEvent.currentState", nodecl.}: float
var MSManipulationEventInertiaDestinationX* {.importc:"MSManipulationEvent.inertiaDestinationX", nodecl.}: float
var MSManipulationEventInertiaDestinationY* {.importc:"MSManipulationEvent.inertiaDestinationY", nodecl.}: float
var MSManipulationEventLastState* {.importc:"MSManipulationEvent.lastState", nodecl.}: float
var MSManipulationEventMS_MANIPULATION_STATE_ACTIVE* {.importc:"MSManipulationEvent.MS_MANIPULATION_STATE_ACTIVE", nodecl.}: float
var MSManipulationEventMS_MANIPULATION_STATE_CANCELLED* {.importc:"MSManipulationEvent.MS_MANIPULATION_STATE_CANCELLED", nodecl.}: float
var MSManipulationEventMS_MANIPULATION_STATE_COMMITTED* {.importc:"MSManipulationEvent.MS_MANIPULATION_STATE_COMMITTED", nodecl.}: float
var MSManipulationEventMS_MANIPULATION_STATE_DRAGGING* {.importc:"MSManipulationEvent.MS_MANIPULATION_STATE_DRAGGING", nodecl.}: float
var MSManipulationEventMS_MANIPULATION_STATE_INERTIA* {.importc:"MSManipulationEvent.MS_MANIPULATION_STATE_INERTIA", nodecl.}: float
var MSManipulationEventMS_MANIPULATION_STATE_PRESELECT* {.importc:"MSManipulationEvent.MS_MANIPULATION_STATE_PRESELECT", nodecl.}: float
var MSManipulationEventMS_MANIPULATION_STATE_SELECTING* {.importc:"MSManipulationEvent.MS_MANIPULATION_STATE_SELECTING", nodecl.}: float
var MSManipulationEventMS_MANIPULATION_STATE_STOPPED* {.importc:"MSManipulationEvent.MS_MANIPULATION_STATE_STOPPED", nodecl.}: float
proc MSManipulationEventInitMSManipulationEvent*(typeArg: cstring, canBubbleArg: bool, cancelableArg: bool, viewArg: Window, detailArg: float, lastState: float, currentState: float) : void {.importc:"MSManipulationEvent.initMSManipulationEvent".}
...
var MSMediaKeyNeededEventInitData* {.importc:"MSMediaKeyNeededEvent.initData", nodecl.}: Uint8Array
...
type MSPointerEvent* {.importc.} = ref object of MouseEvent
    ...
    tiltY* {.importc.}: float
    width* {.importc.}: float
proc getCurrentPoint*(self: MSPointerEvent, element: Element) : void {.importcpp.}
proc getIntermediatePoints*(self: MSPointerEvent, element: Element) : void {.importcpp.}
var MSPointerEventHeight* {.importc:"MSPointerEvent.height", nodecl.}: float
var MSPointerEventHwTimestamp* {.importc:"MSPointerEvent.hwTimestamp", nodecl.}: float
var MSPointerEventIsPrimary* {.importc:"MSPointerEvent.isPrimary", nodecl.}: bool
var MSPointerEventPointerId* {.importc:"MSPointerEvent.pointerId", nodecl.}: float
var MSPointerEventPressure* {.importc:"MSPointerEvent.pressure", nodecl.}: float
var MSPointerEventRotation* {.importc:"MSPointerEvent.rotation", nodecl.}: float
...
proc MSPointerEventGetIntermediatePoints*(element: Element) : void {.importc:"MSPointerEvent.getIntermediatePoints".}

type MSSiteModeEvent* {.importc.} = ref object of Event
    actionURL* {.importc.}: cstring
    buttonID* {.importc.}: float
var MSSiteModeEventActionURL* {.importc:"MSSiteModeEvent.actionURL", nodecl.}: cstring
var MSSiteModeEventButtonID* {.importc:"MSSiteModeEvent.buttonID", nodecl.}: float

type MSStreamReader* {.importc.} = ref object of EventTarget
    error* {.importc.}: DOMError
proc newMSStreamReader*() : MSStreamReader {.importcpp:"new MSStreamReader".}
proc readAsArrayBuffer*(self: MSStreamReader, stream: MSStream, size: float) : void {.importcpp.}
proc readAsBinaryString*(self: MSStreamReader, stream: MSStream, size: float) : void {.importcpp.}
proc readAsBlob*(self: MSStreamReader, stream: MSStream, size: float) : void {.importcpp.}
proc readAsDataURL*(self: MSStreamReader, stream: MSStream, size: float) : void {.importcpp.}
proc readAsText*(self: MSStreamReader, stream: MSStream, encoding: cstring, size: float) : void {.importcpp.}
proc addEventListener*(self: MSStreamReader, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: MSStreamReader, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
var SourceBufferListLength* {.importc:"SourceBufferList.length", nodecl.}: float
...
proc addSourceBuffer*(self: MediaSource, xType: cstring) : SourceBuffer {.importcpp.}
proc endOfStream*(self: MediaSource, error: float) : void {.importcpp.}
proc removeSourceBuffer*(self: MediaSource, sourceBuffer: SourceBuffer) : void {.importcpp.}
...
proc addEventListener*(self: MessagePort, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: MessagePort, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
proc MessagePortClose*() : void {.importc:"MessagePort.close".}
proc MessagePortStart*() : void {.importc:"MessagePort.start".}
proc MessagePortAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"MessagePort.addEventListener".}
proc MessagePortAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"MessagePort.addEventListener".}
...
proc initMouseWheelEvent*(self: MouseWheelEvent, typeArg: cstring, canBubbleArg: bool, cancelableArg: bool, viewArg: Window, detailArg: float, screenXArg: float, screenYArg: float, clientXArg: float, clientYArg: float, buttonArg: float, relatedTargetArg: EventTarget, modifiersListArg: cstring, wheelDeltaArg: float) : void {.importcpp.}
var MouseWheelEventWheelDelta* {.importc:"MouseWheelEvent.wheelDelta", nodecl.}: float
var MouseWheelEventWheelDeltaX* {.importc:"MouseWheelEvent.wheelDeltaX", nodecl.}: float
var MouseWheelEventWheelDeltaY* {.importc:"MouseWheelEvent.wheelDeltaY", nodecl.}: float
proc MouseWheelEventInitMouseWheelEvent*(typeArg: cstring, canBubbleArg: bool, cancelableArg: bool, viewArg: Window, detailArg: float, screenXArg: float, screenYArg: float, clientXArg: float, clientYArg: float, buttonArg: float, relatedTargetArg: EventTarget, modifiersListArg: cstring, wheelDeltaArg: float) : void {.importc:"MouseWheelEvent.initMouseWheelEvent".}
...
proc initMutationEvent*(self: MutationEvent, typeArg: cstring, canBubbleArg: bool, cancelableArg: bool, relatedNodeArg: Node, prevValueArg: cstring, newValueArg: cstring, attrNameArg: cstring, attrChangeArg: float) : void {.importcpp.}
var MutationEventADDITION* {.importc:"MutationEvent.ADDITION", nodecl.}: float
var MutationEventMODIFICATION* {.importc:"MutationEvent.MODIFICATION", nodecl.}: float
...
proc observe*(self: MutationObserver, target: Node, options: MutationObserverInit) : void {.importcpp.}
...
var OES_standard_derivativesFRAGMENT_SHADER_DERIVATIVE_HINT_OES* {.importc:"OES_standard_derivatives.FRAGMENT_SHADER_DERIVATIVE_HINT_OES", nodecl.}: float
...
proc newOfflineAudioContext*(numberOfChannels: float, length: float, sampleRate: float) : OfflineAudioContext {.importcpp:"new OfflineAudioContext(@)".}
proc startRendering*(self: OfflineAudioContext) : void {.importcpp.}
proc addEventListener*(self: OfflineAudioContext, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: OfflineAudioContext, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: PerfWidgetExternal, eventType: cstring, callback: Function) : void {.importcpp.}
...
proc removeEventListener*(self: PerfWidgetExternal, eventType: cstring, callback: Function) : void {.importcpp.}
proc repositionWindow*(self: PerfWidgetExternal, x: float, y: float) : void {.importcpp.}
proc resizeWindow*(self: PerfWidgetExternal, width: float, height: float) : void {.importcpp.}
...
proc getIntermediatePoints*(self: PointerEvent, element: Element) : void {.importcpp.}
var PointerEventHeight* {.importc:"PointerEvent.height", nodecl.}: float
var PointerEventHwTimestamp* {.importc:"PointerEvent.hwTimestamp", nodecl.}: float
...
proc PointerEventGetIntermediatePoints*(element: Element) : void {.importc:"PointerEvent.getIntermediatePoints".}
...
var PositionErrorPERMISSION_DENIED* {.importc:"PositionError.PERMISSION_DENIED", nodecl.}: float
var PositionErrorPOSITION_UNAVAILABLE* {.importc:"PositionError.POSITION_UNAVAILABLE", nodecl.}: float
...
type ProgressEvent* {.importc.} = ref object of Event
    ...
    loaded* {.importc.}: float
    total* {.importc.}: float
proc initProgressEvent*(self: ProgressEvent, typeArg: cstring, canBubbleArg: bool, cancelableArg: bool, lengthComputableArg: bool, loadedArg: float, totalArg: float) : void {.importcpp.}
...
proc ProgressEventInitProgressEvent*(typeArg: cstring, canBubbleArg: bool, cancelableArg: bool, lengthComputableArg: bool, loadedArg: float, totalArg: float) : void {.importc:"ProgressEvent.initProgressEvent".}

type SVGAnimatedString* {.importc.} = ref object of RootObj
    animVal* {.importc.}: cstring
    baseVal* {.importc.}: cstring
var SVGAnimatedStringAnimVal* {.importc:"SVGAnimatedString.animVal", nodecl.}: cstring
var SVGAnimatedStringBaseVal* {.importc:"SVGAnimatedString.baseVal", nodecl.}: cstring
...
proc addEventListener*(self: SVGAElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGAElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc insertItemBefore*(self: SVGLengthList, newItem: SVGLength, index: float) : SVGLength {.importcpp.}
proc removeItem*(self: SVGLengthList, index: float) : SVGLength {.importcpp.}
proc replaceItem*(self: SVGLengthList, newItem: SVGLength, index: float) : SVGLength {.importcpp.}
var SVGLengthListNumberOfItems* {.importc:"SVGLengthList.numberOfItems", nodecl.}: float
...
proc SVGLengthListInsertItemBefore*(newItem: SVGLength, index: float) : SVGLength {.importc:"SVGLengthList.insertItemBefore".}
proc SVGLengthListRemoveItem*(index: float) : SVGLength {.importc:"SVGLengthList.removeItem".}
proc SVGLengthListReplaceItem*(newItem: SVGLength, index: float) : SVGLength {.importc:"SVGLengthList.replaceItem".}
...
proc insertItemBefore*(self: SVGNumberList, newItem: SVGNumber, index: float) : SVGNumber {.importcpp.}
proc removeItem*(self: SVGNumberList, index: float) : SVGNumber {.importcpp.}
proc replaceItem*(self: SVGNumberList, newItem: SVGNumber, index: float) : SVGNumber {.importcpp.}
var SVGNumberListNumberOfItems* {.importc:"SVGNumberList.numberOfItems", nodecl.}: float
...
proc SVGNumberListInsertItemBefore*(newItem: SVGNumber, index: float) : SVGNumber {.importc:"SVGNumberList.insertItemBefore".}
proc SVGNumberListRemoveItem*(index: float) : SVGNumber {.importc:"SVGNumberList.removeItem".}
proc SVGNumberListReplaceItem*(newItem: SVGNumber, index: float) : SVGNumber {.importc:"SVGNumberList.replaceItem".}
...
var SVGPreserveAspectRatioAlign* {.importc:"SVGPreserveAspectRatio.align", nodecl.}: float
var SVGPreserveAspectRatioMeetOrSlice* {.importc:"SVGPreserveAspectRatio.meetOrSlice", nodecl.}: float
var SVGPreserveAspectRatioSVG_MEETORSLICE_MEET* {.importc:"SVGPreserveAspectRatio.SVG_MEETORSLICE_MEET", nodecl.}: float
var SVGPreserveAspectRatioSVG_MEETORSLICE_SLICE* {.importc:"SVGPreserveAspectRatio.SVG_MEETORSLICE_SLICE", nodecl.}: float
var SVGPreserveAspectRatioSVG_MEETORSLICE_UNKNOWN* {.importc:"SVGPreserveAspectRatio.SVG_MEETORSLICE_UNKNOWN", nodecl.}: float
var SVGPreserveAspectRatioSVG_PRESERVEASPECTRATIO_NONE* {.importc:"SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_NONE", nodecl.}: float
var SVGPreserveAspectRatioSVG_PRESERVEASPECTRATIO_UNKNOWN* {.importc:"SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_UNKNOWN", nodecl.}: float
var SVGPreserveAspectRatioSVG_PRESERVEASPECTRATIO_XMAXYMAX* {.importc:"SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_XMAXYMAX", nodecl.}: float
var SVGPreserveAspectRatioSVG_PRESERVEASPECTRATIO_XMAXYMID* {.importc:"SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_XMAXYMID", nodecl.}: float
var SVGPreserveAspectRatioSVG_PRESERVEASPECTRATIO_XMAXYMIN* {.importc:"SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_XMAXYMIN", nodecl.}: float
var SVGPreserveAspectRatioSVG_PRESERVEASPECTRATIO_XMIDYMAX* {.importc:"SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_XMIDYMAX", nodecl.}: float
var SVGPreserveAspectRatioSVG_PRESERVEASPECTRATIO_XMIDYMID* {.importc:"SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_XMIDYMID", nodecl.}: float
var SVGPreserveAspectRatioSVG_PRESERVEASPECTRATIO_XMIDYMIN* {.importc:"SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_XMIDYMIN", nodecl.}: float
var SVGPreserveAspectRatioSVG_PRESERVEASPECTRATIO_XMINYMAX* {.importc:"SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_XMINYMAX", nodecl.}: float
var SVGPreserveAspectRatioSVG_PRESERVEASPECTRATIO_XMINYMID* {.importc:"SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_XMINYMID", nodecl.}: float
var SVGPreserveAspectRatioSVG_PRESERVEASPECTRATIO_XMINYMIN* {.importc:"SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_XMINYMIN", nodecl.}: float
...
type SVGTransformList* {.importc.} = ref object of RootObj
    numberOfItems* {.importc.}: float
proc appendItem*(self: SVGTransformList, newItem: SVGTransform) : SVGTransform {.importcpp.}
proc clear*(self: SVGTransformList) : void {.importcpp.}
proc consolidate*(self: SVGTransformList) : SVGTransform {.importcpp.}
proc createSVGTransformFromMatrix*(self: SVGTransformList, matrix: SVGMatrix) : SVGTransform {.importcpp.}
proc getItem*(self: SVGTransformList, index: float) : SVGTransform {.importcpp.}
proc initialize*(self: SVGTransformList, newItem: SVGTransform) : SVGTransform {.importcpp.}
proc insertItemBefore*(self: SVGTransformList, newItem: SVGTransform, index: float) : SVGTransform {.importcpp.}
proc removeItem*(self: SVGTransformList, index: float) : SVGTransform {.importcpp.}
proc replaceItem*(self: SVGTransformList, newItem: SVGTransform, index: float) : SVGTransform {.importcpp.}
var SVGTransformListNumberOfItems* {.importc:"SVGTransformList.numberOfItems", nodecl.}: float
...
proc SVGTransformListCreateSVGTransformFromMatrix*(matrix: SVGMatrix) : SVGTransform {.importc:"SVGTransformList.createSVGTransformFromMatrix".}
...
proc SVGTransformListInsertItemBefore*(newItem: SVGTransform, index: float) : SVGTransform {.importc:"SVGTransformList.insertItemBefore".}
proc SVGTransformListRemoveItem*(index: float) : SVGTransform {.importc:"SVGTransformList.removeItem".}
proc SVGTransformListReplaceItem*(newItem: SVGTransform, index: float) : SVGTransform {.importc:"SVGTransformList.replaceItem".}
...
proc addEventListener*(self: SVGCircleElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGCircleElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: SVGClipPathElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGClipPathElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}

type SVGComponentTransferFunctionElement* {.importc.} = ref object of SVGElement
...
var SVGComponentTransferFunctionElementSVG_FECOMPONENTTRANSFER_TYPE_DISCRETE* {.importc:"SVGComponentTransferFunctionElement.SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE", nodecl.}: float
var SVGComponentTransferFunctionElementSVG_FECOMPONENTTRANSFER_TYPE_GAMMA* {.importc:"SVGComponentTransferFunctionElement.SVG_FECOMPONENTTRANSFER_TYPE_GAMMA", nodecl.}: float
var SVGComponentTransferFunctionElementSVG_FECOMPONENTTRANSFER_TYPE_IDENTITY* {.importc:"SVGComponentTransferFunctionElement.SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY", nodecl.}: float
var SVGComponentTransferFunctionElementSVG_FECOMPONENTTRANSFER_TYPE_LINEAR* {.importc:"SVGComponentTransferFunctionElement.SVG_FECOMPONENTTRANSFER_TYPE_LINEAR", nodecl.}: float
var SVGComponentTransferFunctionElementSVG_FECOMPONENTTRANSFER_TYPE_TABLE* {.importc:"SVGComponentTransferFunctionElement.SVG_FECOMPONENTTRANSFER_TYPE_TABLE", nodecl.}: float
var SVGComponentTransferFunctionElementSVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN* {.importc:"SVGComponentTransferFunctionElement.SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN", nodecl.}: float

type SVGDefsElement* {.importc.} = ref object of SVGElement
proc newSVGDefsElement*() : SVGDefsElement {.importcpp:"new SVGDefsElement".}
proc addEventListener*(self: SVGDefsElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGDefsElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}

type SVGDescElement* {.importc.} = ref object of SVGElement
proc newSVGDescElement*() : SVGDescElement {.importcpp:"new SVGDescElement".}
proc addEventListener*(self: SVGDescElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGDescElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: SVGUseElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGUseElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var SVGUseElementAnimatedInstanceRoot* {.importc:"SVGUseElement.animatedInstanceRoot", nodecl.}: SVGElementInstance
var SVGUseElementHeight* {.importc:"SVGUseElement.height", nodecl.}: SVGAnimatedLength
var SVGUseElementInstanceRoot* {.importc:"SVGUseElement.instanceRoot", nodecl.}: SVGElementInstance
var SVGUseElementWidth* {.importc:"SVGUseElement.width", nodecl.}: SVGAnimatedLength
...
proc SVGUseElementAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"SVGUseElement.addEventListener".}
proc SVGUseElementAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"SVGUseElement.addEventListener".}
proc item*(self: SVGElementInstanceList, index: float) : SVGElementInstance {.importcpp.}
var SVGElementInstanceListLength* {.importc:"SVGElementInstanceList.length", nodecl.}: float
...
proc addEventListener*(self: SVGEllipseElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGEllipseElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: SVGFEBlendElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGFEBlendElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var SVGFEBlendElementSVG_FEBLEND_MODE_COLOR* {.importc:"SVGFEBlendElement.SVG_FEBLEND_MODE_COLOR", nodecl.}: float
var SVGFEBlendElementSVG_FEBLEND_MODE_COLOR_BURN* {.importc:"SVGFEBlendElement.SVG_FEBLEND_MODE_COLOR_BURN", nodecl.}: float
var SVGFEBlendElementSVG_FEBLEND_MODE_COLOR_DODGE* {.importc:"SVGFEBlendElement.SVG_FEBLEND_MODE_COLOR_DODGE", nodecl.}: float
var SVGFEBlendElementSVG_FEBLEND_MODE_DARKEN* {.importc:"SVGFEBlendElement.SVG_FEBLEND_MODE_DARKEN", nodecl.}: float
var SVGFEBlendElementSVG_FEBLEND_MODE_DIFFERENCE* {.importc:"SVGFEBlendElement.SVG_FEBLEND_MODE_DIFFERENCE", nodecl.}: float
var SVGFEBlendElementSVG_FEBLEND_MODE_EXCLUSION* {.importc:"SVGFEBlendElement.SVG_FEBLEND_MODE_EXCLUSION", nodecl.}: float
var SVGFEBlendElementSVG_FEBLEND_MODE_HARD_LIGHT* {.importc:"SVGFEBlendElement.SVG_FEBLEND_MODE_HARD_LIGHT", nodecl.}: float
var SVGFEBlendElementSVG_FEBLEND_MODE_HUE* {.importc:"SVGFEBlendElement.SVG_FEBLEND_MODE_HUE", nodecl.}: float
var SVGFEBlendElementSVG_FEBLEND_MODE_LIGHTEN* {.importc:"SVGFEBlendElement.SVG_FEBLEND_MODE_LIGHTEN", nodecl.}: float
var SVGFEBlendElementSVG_FEBLEND_MODE_LUMINOSITY* {.importc:"SVGFEBlendElement.SVG_FEBLEND_MODE_LUMINOSITY", nodecl.}: float
var SVGFEBlendElementSVG_FEBLEND_MODE_MULTIPLY* {.importc:"SVGFEBlendElement.SVG_FEBLEND_MODE_MULTIPLY", nodecl.}: float
var SVGFEBlendElementSVG_FEBLEND_MODE_NORMAL* {.importc:"SVGFEBlendElement.SVG_FEBLEND_MODE_NORMAL", nodecl.}: float
var SVGFEBlendElementSVG_FEBLEND_MODE_OVERLAY* {.importc:"SVGFEBlendElement.SVG_FEBLEND_MODE_OVERLAY", nodecl.}: float
var SVGFEBlendElementSVG_FEBLEND_MODE_SATURATION* {.importc:"SVGFEBlendElement.SVG_FEBLEND_MODE_SATURATION", nodecl.}: float
var SVGFEBlendElementSVG_FEBLEND_MODE_SCREEN* {.importc:"SVGFEBlendElement.SVG_FEBLEND_MODE_SCREEN", nodecl.}: float
var SVGFEBlendElementSVG_FEBLEND_MODE_SOFT_LIGHT* {.importc:"SVGFEBlendElement.SVG_FEBLEND_MODE_SOFT_LIGHT", nodecl.}: float
var SVGFEBlendElementSVG_FEBLEND_MODE_UNKNOWN* {.importc:"SVGFEBlendElement.SVG_FEBLEND_MODE_UNKNOWN", nodecl.}: float
...
proc addEventListener*(self: SVGFEColorMatrixElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGFEColorMatrixElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var SVGFEColorMatrixElementSVG_FECOLORMATRIX_TYPE_HUEROTATE* {.importc:"SVGFEColorMatrixElement.SVG_FECOLORMATRIX_TYPE_HUEROTATE", nodecl.}: float
var SVGFEColorMatrixElementSVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA* {.importc:"SVGFEColorMatrixElement.SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA", nodecl.}: float
var SVGFEColorMatrixElementSVG_FECOLORMATRIX_TYPE_MATRIX* {.importc:"SVGFEColorMatrixElement.SVG_FECOLORMATRIX_TYPE_MATRIX", nodecl.}: float
var SVGFEColorMatrixElementSVG_FECOLORMATRIX_TYPE_SATURATE* {.importc:"SVGFEColorMatrixElement.SVG_FECOLORMATRIX_TYPE_SATURATE", nodecl.}: float
var SVGFEColorMatrixElementSVG_FECOLORMATRIX_TYPE_UNKNOWN* {.importc:"SVGFEColorMatrixElement.SVG_FECOLORMATRIX_TYPE_UNKNOWN", nodecl.}: float
...
proc addEventListener*(self: SVGFEComponentTransferElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGFEComponentTransferElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: SVGFECompositeElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGFECompositeElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var SVGFECompositeElementSVG_FECOMPOSITE_OPERATOR_ARITHMETIC* {.importc:"SVGFECompositeElement.SVG_FECOMPOSITE_OPERATOR_ARITHMETIC", nodecl.}: float
var SVGFECompositeElementSVG_FECOMPOSITE_OPERATOR_ATOP* {.importc:"SVGFECompositeElement.SVG_FECOMPOSITE_OPERATOR_ATOP", nodecl.}: float
var SVGFECompositeElementSVG_FECOMPOSITE_OPERATOR_IN* {.importc:"SVGFECompositeElement.SVG_FECOMPOSITE_OPERATOR_IN", nodecl.}: float
var SVGFECompositeElementSVG_FECOMPOSITE_OPERATOR_OUT* {.importc:"SVGFECompositeElement.SVG_FECOMPOSITE_OPERATOR_OUT", nodecl.}: float
var SVGFECompositeElementSVG_FECOMPOSITE_OPERATOR_OVER* {.importc:"SVGFECompositeElement.SVG_FECOMPOSITE_OPERATOR_OVER", nodecl.}: float
var SVGFECompositeElementSVG_FECOMPOSITE_OPERATOR_UNKNOWN* {.importc:"SVGFECompositeElement.SVG_FECOMPOSITE_OPERATOR_UNKNOWN", nodecl.}: float
var SVGFECompositeElementSVG_FECOMPOSITE_OPERATOR_XOR* {.importc:"SVGFECompositeElement.SVG_FECOMPOSITE_OPERATOR_XOR", nodecl.}: float
...
proc addEventListener*(self: SVGFEConvolveMatrixElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGFEConvolveMatrixElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var SVGFEConvolveMatrixElementSVG_EDGEMODE_DUPLICATE* {.importc:"SVGFEConvolveMatrixElement.SVG_EDGEMODE_DUPLICATE", nodecl.}: float
var SVGFEConvolveMatrixElementSVG_EDGEMODE_NONE* {.importc:"SVGFEConvolveMatrixElement.SVG_EDGEMODE_NONE", nodecl.}: float
var SVGFEConvolveMatrixElementSVG_EDGEMODE_UNKNOWN* {.importc:"SVGFEConvolveMatrixElement.SVG_EDGEMODE_UNKNOWN", nodecl.}: float
var SVGFEConvolveMatrixElementSVG_EDGEMODE_WRAP* {.importc:"SVGFEConvolveMatrixElement.SVG_EDGEMODE_WRAP", nodecl.}: float
...
proc addEventListener*(self: SVGFEDiffuseLightingElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGFEDiffuseLightingElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: SVGFEDisplacementMapElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGFEDisplacementMapElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var SVGFEDisplacementMapElementSVG_CHANNEL_A* {.importc:"SVGFEDisplacementMapElement.SVG_CHANNEL_A", nodecl.}: float
var SVGFEDisplacementMapElementSVG_CHANNEL_B* {.importc:"SVGFEDisplacementMapElement.SVG_CHANNEL_B", nodecl.}: float
var SVGFEDisplacementMapElementSVG_CHANNEL_G* {.importc:"SVGFEDisplacementMapElement.SVG_CHANNEL_G", nodecl.}: float
var SVGFEDisplacementMapElementSVG_CHANNEL_R* {.importc:"SVGFEDisplacementMapElement.SVG_CHANNEL_R", nodecl.}: float
var SVGFEDisplacementMapElementSVG_CHANNEL_UNKNOWN* {.importc:"SVGFEDisplacementMapElement.SVG_CHANNEL_UNKNOWN", nodecl.}: float
...
proc addEventListener*(self: SVGFEFloodElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGFEFloodElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc setStdDeviation*(self: SVGFEGaussianBlurElement, stdDeviationX: float, stdDeviationY: float) : void {.importcpp.}
proc addEventListener*(self: SVGFEGaussianBlurElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGFEGaussianBlurElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: SVGFEImageElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGFEImageElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: SVGFEMergeElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGFEMergeElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: SVGFEMorphologyElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGFEMorphologyElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var SVGFEMorphologyElementSVG_MORPHOLOGY_OPERATOR_DILATE* {.importc:"SVGFEMorphologyElement.SVG_MORPHOLOGY_OPERATOR_DILATE", nodecl.}: float
var SVGFEMorphologyElementSVG_MORPHOLOGY_OPERATOR_ERODE* {.importc:"SVGFEMorphologyElement.SVG_MORPHOLOGY_OPERATOR_ERODE", nodecl.}: float
var SVGFEMorphologyElementSVG_MORPHOLOGY_OPERATOR_UNKNOWN* {.importc:"SVGFEMorphologyElement.SVG_MORPHOLOGY_OPERATOR_UNKNOWN", nodecl.}: float
...
proc addEventListener*(self: SVGFEOffsetElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGFEOffsetElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: SVGFESpecularLightingElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGFESpecularLightingElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: SVGFETileElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGFETileElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: SVGFETurbulenceElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGFETurbulenceElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var SVGFETurbulenceElementSVG_STITCHTYPE_NOSTITCH* {.importc:"SVGFETurbulenceElement.SVG_STITCHTYPE_NOSTITCH", nodecl.}: float
var SVGFETurbulenceElementSVG_STITCHTYPE_STITCH* {.importc:"SVGFETurbulenceElement.SVG_STITCHTYPE_STITCH", nodecl.}: float
var SVGFETurbulenceElementSVG_STITCHTYPE_UNKNOWN* {.importc:"SVGFETurbulenceElement.SVG_STITCHTYPE_UNKNOWN", nodecl.}: float
var SVGFETurbulenceElementSVG_TURBULENCE_TYPE_FRACTALNOISE* {.importc:"SVGFETurbulenceElement.SVG_TURBULENCE_TYPE_FRACTALNOISE", nodecl.}: float
var SVGFETurbulenceElementSVG_TURBULENCE_TYPE_TURBULENCE* {.importc:"SVGFETurbulenceElement.SVG_TURBULENCE_TYPE_TURBULENCE", nodecl.}: float
var SVGFETurbulenceElementSVG_TURBULENCE_TYPE_UNKNOWN* {.importc:"SVGFETurbulenceElement.SVG_TURBULENCE_TYPE_UNKNOWN", nodecl.}: float
...
proc setFilterRes*(self: SVGFilterElement, filterResX: float, filterResY: float) : void {.importcpp.}
proc addEventListener*(self: SVGFilterElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGFilterElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: SVGForeignObjectElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGForeignObjectElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}

type SVGGElement* {.importc.} = ref object of SVGElement
proc newSVGGElement*() : SVGGElement {.importcpp:"new SVGGElement".}
proc addEventListener*(self: SVGGElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGGElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: SVGGradientElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGGradientElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var SVGGradientElementSVG_SPREADMETHOD_PAD* {.importc:"SVGGradientElement.SVG_SPREADMETHOD_PAD", nodecl.}: float
var SVGGradientElementSVG_SPREADMETHOD_REFLECT* {.importc:"SVGGradientElement.SVG_SPREADMETHOD_REFLECT", nodecl.}: float
var SVGGradientElementSVG_SPREADMETHOD_REPEAT* {.importc:"SVGGradientElement.SVG_SPREADMETHOD_REPEAT", nodecl.}: float
var SVGGradientElementSVG_SPREADMETHOD_UNKNOWN* {.importc:"SVGGradientElement.SVG_SPREADMETHOD_UNKNOWN", nodecl.}: float
...
proc addEventListener*(self: SVGImageElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGImageElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: SVGLineElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGLineElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc setOrientToAngle*(self: SVGMarkerElement, angle: SVGAngle) : void {.importcpp.}
proc setOrientToAuto*(self: SVGMarkerElement) : void {.importcpp.}
proc addEventListener*(self: SVGMarkerElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGMarkerElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var SVGMarkerElementSVG_MARKERUNITS_STROKEWIDTH* {.importc:"SVGMarkerElement.SVG_MARKERUNITS_STROKEWIDTH", nodecl.}: float
var SVGMarkerElementSVG_MARKERUNITS_UNKNOWN* {.importc:"SVGMarkerElement.SVG_MARKERUNITS_UNKNOWN", nodecl.}: float
var SVGMarkerElementSVG_MARKERUNITS_USERSPACEONUSE* {.importc:"SVGMarkerElement.SVG_MARKERUNITS_USERSPACEONUSE", nodecl.}: float
var SVGMarkerElementSVG_MARKER_ORIENT_ANGLE* {.importc:"SVGMarkerElement.SVG_MARKER_ORIENT_ANGLE", nodecl.}: float
var SVGMarkerElementSVG_MARKER_ORIENT_AUTO* {.importc:"SVGMarkerElement.SVG_MARKER_ORIENT_AUTO", nodecl.}: float
var SVGMarkerElementSVG_MARKER_ORIENT_UNKNOWN* {.importc:"SVGMarkerElement.SVG_MARKER_ORIENT_UNKNOWN", nodecl.}: float
...
proc addEventListener*(self: SVGMaskElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGMaskElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
type SVGPathSegCurvetoCubicAbs* {.importc.} = ref object of SVGPathSeg
    ...
    y1* {.importc.}: float
    y2* {.importc.}: float
var SVGPathSegCurvetoCubicAbsX* {.importc:"SVGPathSegCurvetoCubicAbs.x", nodecl.}: float
var SVGPathSegCurvetoCubicAbsX1* {.importc:"SVGPathSegCurvetoCubicAbs.x1", nodecl.}: float
var SVGPathSegCurvetoCubicAbsX2* {.importc:"SVGPathSegCurvetoCubicAbs.x2", nodecl.}: float
var SVGPathSegCurvetoCubicAbsY* {.importc:"SVGPathSegCurvetoCubicAbs.y", nodecl.}: float
var SVGPathSegCurvetoCubicAbsY1* {.importc:"SVGPathSegCurvetoCubicAbs.y1", nodecl.}: float
var SVGPathSegCurvetoCubicAbsY2* {.importc:"SVGPathSegCurvetoCubicAbs.y2", nodecl.}: float
...
type SVGPathSegCurvetoCubicRel* {.importc.} = ref object of SVGPathSeg
    ...
    y1* {.importc.}: float
    y2* {.importc.}: float
var SVGPathSegCurvetoCubicRelX* {.importc:"SVGPathSegCurvetoCubicRel.x", nodecl.}: float
var SVGPathSegCurvetoCubicRelX1* {.importc:"SVGPathSegCurvetoCubicRel.x1", nodecl.}: float
var SVGPathSegCurvetoCubicRelX2* {.importc:"SVGPathSegCurvetoCubicRel.x2", nodecl.}: float
var SVGPathSegCurvetoCubicRelY* {.importc:"SVGPathSegCurvetoCubicRel.y", nodecl.}: float
var SVGPathSegCurvetoCubicRelY1* {.importc:"SVGPathSegCurvetoCubicRel.y1", nodecl.}: float
var SVGPathSegCurvetoCubicRelY2* {.importc:"SVGPathSegCurvetoCubicRel.y2", nodecl.}: float
...
type SVGPathSegCurvetoCubicSmoothAbs* {.importc.} = ref object of SVGPathSeg
    ...
    y* {.importc.}: float
    y2* {.importc.}: float
var SVGPathSegCurvetoCubicSmoothAbsX* {.importc:"SVGPathSegCurvetoCubicSmoothAbs.x", nodecl.}: float
var SVGPathSegCurvetoCubicSmoothAbsX2* {.importc:"SVGPathSegCurvetoCubicSmoothAbs.x2", nodecl.}: float
var SVGPathSegCurvetoCubicSmoothAbsY* {.importc:"SVGPathSegCurvetoCubicSmoothAbs.y", nodecl.}: float
var SVGPathSegCurvetoCubicSmoothAbsY2* {.importc:"SVGPathSegCurvetoCubicSmoothAbs.y2", nodecl.}: float
...
type SVGPathSegCurvetoCubicSmoothRel* {.importc.} = ref object of SVGPathSeg
    ...
    y* {.importc.}: float
    y2* {.importc.}: float
var SVGPathSegCurvetoCubicSmoothRelX* {.importc:"SVGPathSegCurvetoCubicSmoothRel.x", nodecl.}: float
var SVGPathSegCurvetoCubicSmoothRelX2* {.importc:"SVGPathSegCurvetoCubicSmoothRel.x2", nodecl.}: float
var SVGPathSegCurvetoCubicSmoothRelY* {.importc:"SVGPathSegCurvetoCubicSmoothRel.y", nodecl.}: float
var SVGPathSegCurvetoCubicSmoothRelY2* {.importc:"SVGPathSegCurvetoCubicSmoothRel.y2", nodecl.}: float
...
type SVGPathSegCurvetoQuadraticAbs* {.importc.} = ref object of SVGPathSeg
    ...
    y* {.importc.}: float
    y1* {.importc.}: float
var SVGPathSegCurvetoQuadraticAbsX* {.importc:"SVGPathSegCurvetoQuadraticAbs.x", nodecl.}: float
var SVGPathSegCurvetoQuadraticAbsX1* {.importc:"SVGPathSegCurvetoQuadraticAbs.x1", nodecl.}: float
var SVGPathSegCurvetoQuadraticAbsY* {.importc:"SVGPathSegCurvetoQuadraticAbs.y", nodecl.}: float
var SVGPathSegCurvetoQuadraticAbsY1* {.importc:"SVGPathSegCurvetoQuadraticAbs.y1", nodecl.}: float
...
type SVGPathSegCurvetoQuadraticRel* {.importc.} = ref object of SVGPathSeg
    ...
    y* {.importc.}: float
    y1* {.importc.}: float
var SVGPathSegCurvetoQuadraticRelX* {.importc:"SVGPathSegCurvetoQuadraticRel.x", nodecl.}: float
var SVGPathSegCurvetoQuadraticRelX1* {.importc:"SVGPathSegCurvetoQuadraticRel.x1", nodecl.}: float
var SVGPathSegCurvetoQuadraticRelY* {.importc:"SVGPathSegCurvetoQuadraticRel.y", nodecl.}: float
var SVGPathSegCurvetoQuadraticRelY1* {.importc:"SVGPathSegCurvetoQuadraticRel.y1", nodecl.}: float

type SVGPathSegCurvetoQuadraticSmoothAbs* {.importc.} = ref object of SVGPathSeg
    x* {.importc.}: float
    y* {.importc.}: float
var SVGPathSegCurvetoQuadraticSmoothAbsX* {.importc:"SVGPathSegCurvetoQuadraticSmoothAbs.x", nodecl.}: float
var SVGPathSegCurvetoQuadraticSmoothAbsY* {.importc:"SVGPathSegCurvetoQuadraticSmoothAbs.y", nodecl.}: float

type SVGPathSegCurvetoQuadraticSmoothRel* {.importc.} = ref object of SVGPathSeg
    x* {.importc.}: float
    y* {.importc.}: float
var SVGPathSegCurvetoQuadraticSmoothRelX* {.importc:"SVGPathSegCurvetoQuadraticSmoothRel.x", nodecl.}: float
var SVGPathSegCurvetoQuadraticSmoothRelY* {.importc:"SVGPathSegCurvetoQuadraticSmoothRel.y", nodecl.}: float
...
type SVGPathSegLinetoHorizontalAbs* {.importc.} = ref object of SVGPathSeg
    x* {.importc.}: float
var SVGPathSegLinetoHorizontalAbsX* {.importc:"SVGPathSegLinetoHorizontalAbs.x", nodecl.}: float

type SVGPathSegLinetoHorizontalRel* {.importc.} = ref object of SVGPathSeg
    x* {.importc.}: float
var SVGPathSegLinetoHorizontalRelX* {.importc:"SVGPathSegLinetoHorizontalRel.x", nodecl.}: float
...
type SVGPathSegLinetoVerticalAbs* {.importc.} = ref object of SVGPathSeg
    y* {.importc.}: float
var SVGPathSegLinetoVerticalAbsY* {.importc:"SVGPathSegLinetoVerticalAbs.y", nodecl.}: float

type SVGPathSegLinetoVerticalRel* {.importc.} = ref object of SVGPathSeg
    y* {.importc.}: float
var SVGPathSegLinetoVerticalRelY* {.importc:"SVGPathSegLinetoVerticalRel.y", nodecl.}: float
...
proc createSVGPathSegArcAbs*(self: SVGPathElement, x: float, y: float, r1: float, r2: float, angle: float, largeArcFlag: bool, sweepFlag: bool) : SVGPathSegArcAbs {.importcpp.}
proc createSVGPathSegArcRel*(self: SVGPathElement, x: float, y: float, r1: float, r2: float, angle: float, largeArcFlag: bool, sweepFlag: bool) : SVGPathSegArcRel {.importcpp.}
proc createSVGPathSegClosePath*(self: SVGPathElement) : SVGPathSegClosePath {.importcpp.}
proc createSVGPathSegCurvetoCubicAbs*(self: SVGPathElement, x: float, y: float, x1: float, y1: float, x2: float, y2: float) : SVGPathSegCurvetoCubicAbs {.importcpp.}
proc createSVGPathSegCurvetoCubicRel*(self: SVGPathElement, x: float, y: float, x1: float, y1: float, x2: float, y2: float) : SVGPathSegCurvetoCubicRel {.importcpp.}
proc createSVGPathSegCurvetoCubicSmoothAbs*(self: SVGPathElement, x: float, y: float, x2: float, y2: float) : SVGPathSegCurvetoCubicSmoothAbs {.importcpp.}
proc createSVGPathSegCurvetoCubicSmoothRel*(self: SVGPathElement, x: float, y: float, x2: float, y2: float) : SVGPathSegCurvetoCubicSmoothRel {.importcpp.}
proc createSVGPathSegCurvetoQuadraticAbs*(self: SVGPathElement, x: float, y: float, x1: float, y1: float) : SVGPathSegCurvetoQuadraticAbs {.importcpp.}
proc createSVGPathSegCurvetoQuadraticRel*(self: SVGPathElement, x: float, y: float, x1: float, y1: float) : SVGPathSegCurvetoQuadraticRel {.importcpp.}
proc createSVGPathSegCurvetoQuadraticSmoothAbs*(self: SVGPathElement, x: float, y: float) : SVGPathSegCurvetoQuadraticSmoothAbs {.importcpp.}
proc createSVGPathSegCurvetoQuadraticSmoothRel*(self: SVGPathElement, x: float, y: float) : SVGPathSegCurvetoQuadraticSmoothRel {.importcpp.}
proc createSVGPathSegLinetoAbs*(self: SVGPathElement, x: float, y: float) : SVGPathSegLinetoAbs {.importcpp.}
proc createSVGPathSegLinetoHorizontalAbs*(self: SVGPathElement, x: float) : SVGPathSegLinetoHorizontalAbs {.importcpp.}
proc createSVGPathSegLinetoHorizontalRel*(self: SVGPathElement, x: float) : SVGPathSegLinetoHorizontalRel {.importcpp.}
proc createSVGPathSegLinetoRel*(self: SVGPathElement, x: float, y: float) : SVGPathSegLinetoRel {.importcpp.}
proc createSVGPathSegLinetoVerticalAbs*(self: SVGPathElement, y: float) : SVGPathSegLinetoVerticalAbs {.importcpp.}
proc createSVGPathSegLinetoVerticalRel*(self: SVGPathElement, y: float) : SVGPathSegLinetoVerticalRel {.importcpp.}
proc createSVGPathSegMovetoAbs*(self: SVGPathElement, x: float, y: float) : SVGPathSegMovetoAbs {.importcpp.}
proc createSVGPathSegMovetoRel*(self: SVGPathElement, x: float, y: float) : SVGPathSegMovetoRel {.importcpp.}
proc getPathSegAtLength*(self: SVGPathElement, distance: float) : float {.importcpp.}
proc getPointAtLength*(self: SVGPathElement, distance: float) : SVGPoint {.importcpp.}
proc getTotalLength*(self: SVGPathElement) : float {.importcpp.}
proc addEventListener*(self: SVGPathElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGPathElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc insertItemBefore*(self: SVGPathSegList, newItem: SVGPathSeg, index: float) : SVGPathSeg {.importcpp.}
proc removeItem*(self: SVGPathSegList, index: float) : SVGPathSeg {.importcpp.}
proc replaceItem*(self: SVGPathSegList, newItem: SVGPathSeg, index: float) : SVGPathSeg {.importcpp.}
...
proc addEventListener*(self: SVGPatternElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGPatternElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc insertItemBefore*(self: SVGPointList, newItem: SVGPoint, index: float) : SVGPoint {.importcpp.}
proc removeItem*(self: SVGPointList, index: float) : SVGPoint {.importcpp.}
proc replaceItem*(self: SVGPointList, newItem: SVGPoint, index: float) : SVGPoint {.importcpp.}
...
proc addEventListener*(self: SVGPolygonElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGPolygonElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: SVGPolylineElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGPolylineElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: SVGRectElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGRectElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: SVGScriptElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGScriptElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}

type SVGStopElement* {.importc.} = ref object of SVGElement
    offset* {.importc.}: SVGAnimatedNumber
proc newSVGStopElement*() : SVGStopElement {.importcpp:"new SVGStopElement".}
proc addEventListener*(self: SVGStopElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGStopElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc insertItemBefore*(self: SVGStringList, newItem: cstring, index: float) : cstring {.importcpp.}
proc removeItem*(self: SVGStringList, index: float) : cstring {.importcpp.}
proc replaceItem*(self: SVGStringList, newItem: cstring, index: float) : cstring {.importcpp.}
...
proc addEventListener*(self: SVGStyleElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGStyleElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: SVGSwitchElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGSwitchElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: SVGSymbolElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGSymbolElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc getCharNumAtPosition*(self: SVGTextContentElement, point: SVGPoint) : float {.importcpp.}
proc getComputedTextLength*(self: SVGTextContentElement) : float {.importcpp.}
proc getEndPositionOfChar*(self: SVGTextContentElement, charnum: float) : SVGPoint {.importcpp.}
proc getExtentOfChar*(self: SVGTextContentElement, charnum: float) : SVGRect {.importcpp.}
proc getNumberOfChars*(self: SVGTextContentElement) : float {.importcpp.}
proc getRotationOfChar*(self: SVGTextContentElement, charnum: float) : float {.importcpp.}
proc getStartPositionOfChar*(self: SVGTextContentElement, charnum: float) : SVGPoint {.importcpp.}
proc getSubStringLength*(self: SVGTextContentElement, charnum: float, nchars: float) : float {.importcpp.}
proc selectSubString*(self: SVGTextContentElement, charnum: float, nchars: float) : void {.importcpp.}
proc addEventListener*(self: SVGTextContentElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGTextContentElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: SVGTextElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGTextElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: SVGTextPathElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGTextPathElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var SVGTextPathElementTEXTPATH_METHODTYPE_ALIGN* {.importc:"SVGTextPathElement.TEXTPATH_METHODTYPE_ALIGN", nodecl.}: float
var SVGTextPathElementTEXTPATH_METHODTYPE_STRETCH* {.importc:"SVGTextPathElement.TEXTPATH_METHODTYPE_STRETCH", nodecl.}: float
var SVGTextPathElementTEXTPATH_METHODTYPE_UNKNOWN* {.importc:"SVGTextPathElement.TEXTPATH_METHODTYPE_UNKNOWN", nodecl.}: float
var SVGTextPathElementTEXTPATH_SPACINGTYPE_AUTO* {.importc:"SVGTextPathElement.TEXTPATH_SPACINGTYPE_AUTO", nodecl.}: float
var SVGTextPathElementTEXTPATH_SPACINGTYPE_EXACT* {.importc:"SVGTextPathElement.TEXTPATH_SPACINGTYPE_EXACT", nodecl.}: float
var SVGTextPathElementTEXTPATH_SPACINGTYPE_UNKNOWN* {.importc:"SVGTextPathElement.TEXTPATH_SPACINGTYPE_UNKNOWN", nodecl.}: float
...
proc addEventListener*(self: SVGTitleElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGTitleElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
var SVGUnitTypesSVG_UNIT_TYPE_OBJECTBOUNDINGBOX* {.importc:"SVGUnitTypes.SVG_UNIT_TYPE_OBJECTBOUNDINGBOX", nodecl.}: float
var SVGUnitTypesSVG_UNIT_TYPE_UNKNOWN* {.importc:"SVGUnitTypes.SVG_UNIT_TYPE_UNKNOWN", nodecl.}: float
var SVGUnitTypesSVG_UNIT_TYPE_USERSPACEONUSE* {.importc:"SVGUnitTypes.SVG_UNIT_TYPE_USERSPACEONUSE", nodecl.}: float
...
proc addEventListener*(self: SVGViewElement, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: SVGViewElement, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
var SVGZoomAndPanSVG_ZOOMANDPAN_DISABLE* {.importc:"SVGZoomAndPan.SVG_ZOOMANDPAN_DISABLE", nodecl.}: float
var SVGZoomAndPanSVG_ZOOMANDPAN_MAGNIFY* {.importc:"SVGZoomAndPan.SVG_ZOOMANDPAN_MAGNIFY", nodecl.}: float
var SVGZoomAndPanSVG_ZOOMANDPAN_UNKNOWN* {.importc:"SVGZoomAndPan.SVG_ZOOMANDPAN_UNKNOWN", nodecl.}: float
...
var SVGZoomEventNewTranslate* {.importc:"SVGZoomEvent.newTranslate", nodecl.}: SVGPoint
var SVGZoomEventPreviousScale* {.importc:"SVGZoomEvent.previousScale", nodecl.}: float
var SVGZoomEventPreviousTranslate* {.importc:"SVGZoomEvent.previousTranslate", nodecl.}: SVGPoint
var SVGZoomEventZoomRectScreen* {.importc:"SVGZoomEvent.zoomRectScreen", nodecl.}: SVGRect
...
var StorageEventStorageArea* {.importc:"StorageEvent.storageArea", nodecl.}: Storage
...
proc initTextEvent*(self: TextEvent, typeArg: cstring, canBubbleArg: bool, cancelableArg: bool, viewArg: Window, dataArg: cstring, inputMethod: float, locale: cstring) : void {.importcpp.}
var TextEventDOM_INPUT_METHOD_DROP* {.importc:"TextEvent.DOM_INPUT_METHOD_DROP", nodecl.}: float
var TextEventDOM_INPUT_METHOD_HANDWRITING* {.importc:"TextEvent.DOM_INPUT_METHOD_HANDWRITING", nodecl.}: float
var TextEventDOM_INPUT_METHOD_IME* {.importc:"TextEvent.DOM_INPUT_METHOD_IME", nodecl.}: float
var TextEventDOM_INPUT_METHOD_KEYBOARD* {.importc:"TextEvent.DOM_INPUT_METHOD_KEYBOARD", nodecl.}: float
var TextEventDOM_INPUT_METHOD_MULTIMODAL* {.importc:"TextEvent.DOM_INPUT_METHOD_MULTIMODAL", nodecl.}: float
var TextEventDOM_INPUT_METHOD_OPTION* {.importc:"TextEvent.DOM_INPUT_METHOD_OPTION", nodecl.}: float
var TextEventDOM_INPUT_METHOD_PASTE* {.importc:"TextEvent.DOM_INPUT_METHOD_PASTE", nodecl.}: float
var TextEventDOM_INPUT_METHOD_SCRIPT* {.importc:"TextEvent.DOM_INPUT_METHOD_SCRIPT", nodecl.}: float
var TextEventDOM_INPUT_METHOD_UNKNOWN* {.importc:"TextEvent.DOM_INPUT_METHOD_UNKNOWN", nodecl.}: float
var TextEventDOM_INPUT_METHOD_VOICE* {.importc:"TextEvent.DOM_INPUT_METHOD_VOICE", nodecl.}: float
...
var TouchEventChangedTouches* {.importc:"TouchEvent.changedTouches", nodecl.}: TouchList
...
var TouchEventTargetTouches* {.importc:"TouchEvent.targetTouches", nodecl.}: TouchList
...
proc initTransitionEvent*(self: TransitionEvent, typeArg: cstring, canBubbleArg: bool, cancelableArg: bool, propertyNameArg: cstring, elapsedTimeArg: float) : void {.importcpp.}
...
var WEBGL_compressed_texture_s3tcCOMPRESSED_RGBA_S3TC_DXT1_EXT* {.importc:"WEBGL_compressed_texture_s3tc.COMPRESSED_RGBA_S3TC_DXT1_EXT", nodecl.}: float
var WEBGL_compressed_texture_s3tcCOMPRESSED_RGBA_S3TC_DXT3_EXT* {.importc:"WEBGL_compressed_texture_s3tc.COMPRESSED_RGBA_S3TC_DXT3_EXT", nodecl.}: float
var WEBGL_compressed_texture_s3tcCOMPRESSED_RGBA_S3TC_DXT5_EXT* {.importc:"WEBGL_compressed_texture_s3tc.COMPRESSED_RGBA_S3TC_DXT5_EXT", nodecl.}: float
var WEBGL_compressed_texture_s3tcCOMPRESSED_RGB_S3TC_DXT1_EXT* {.importc:"WEBGL_compressed_texture_s3tc.COMPRESSED_RGB_S3TC_DXT1_EXT", nodecl.}: float
...
var WEBGL_debug_renderer_infoUNMASKED_RENDERER_WEBGL* {.importc:"WEBGL_debug_renderer_info.UNMASKED_RENDERER_WEBGL", nodecl.}: float
var WEBGL_debug_renderer_infoUNMASKED_VENDOR_WEBGL* {.importc:"WEBGL_debug_renderer_info.UNMASKED_VENDOR_WEBGL", nodecl.}: float
...
var WEBGL_depth_textureUNSIGNED_INT_24_8_WEBGL* {.importc:"WEBGL_depth_texture.UNSIGNED_INT_24_8_WEBGL", nodecl.}: float
...
var WebGLShaderPrecisionFormatPrecision* {.importc:"WebGLShaderPrecisionFormat.precision", nodecl.}: float
var WebGLShaderPrecisionFormatRangeMax* {.importc:"WebGLShaderPrecisionFormat.rangeMax", nodecl.}: float
var WebGLShaderPrecisionFormatRangeMin* {.importc:"WebGLShaderPrecisionFormat.rangeMin", nodecl.}: float
...
proc activeTexture*(self: WebGLRenderingContext, texture: float) : void {.importcpp.}
proc attachShader*(self: WebGLRenderingContext, program: WebGLProgram, shader: WebGLShader) : void {.importcpp.}
proc bindAttribLocation*(self: WebGLRenderingContext, program: WebGLProgram, index: float, name: cstring) : void {.importcpp.}
proc bindBuffer*(self: WebGLRenderingContext, target: float, buffer: WebGLBuffer) : void {.importcpp.}
proc bindFramebuffer*(self: WebGLRenderingContext, target: float, framebuffer: WebGLFramebuffer) : void {.importcpp.}
proc bindRenderbuffer*(self: WebGLRenderingContext, target: float, renderbuffer: WebGLRenderbuffer) : void {.importcpp.}
proc bindTexture*(self: WebGLRenderingContext, target: float, texture: WebGLTexture) : void {.importcpp.}
proc blendColor*(self: WebGLRenderingContext, red: float, green: float, blue: float, alpha: float) : void {.importcpp.}
proc blendEquation*(self: WebGLRenderingContext, mode: float) : void {.importcpp.}
proc blendEquationSeparate*(self: WebGLRenderingContext, modeRGB: float, modeAlpha: float) : void {.importcpp.}
proc blendFunc*(self: WebGLRenderingContext, sfactor: float, dfactor: float) : void {.importcpp.}
proc blendFuncSeparate*(self: WebGLRenderingContext, srcRGB: float, dstRGB: float, srcAlpha: float, dstAlpha: float) : void {.importcpp.}
proc bufferData*(self: WebGLRenderingContext, target: float, size: float, usage: float) : void {.importcpp.}
proc bufferData*(self: WebGLRenderingContext, target: float, size: ArrayBufferView, usage: float) : void {.importcpp.}
proc bufferData*(self: WebGLRenderingContext, target: float, size: ArrayBuffer, usage: float) : void {.importcpp.}
proc bufferSubData*(self: WebGLRenderingContext, target: float, offset: float, data: ArrayBufferView) : void {.importcpp.}
proc bufferSubData*(self: WebGLRenderingContext, target: float, offset: float, data: ArrayBuffer) : void {.importcpp.}
proc checkFramebufferStatus*(self: WebGLRenderingContext, target: float) : float {.importcpp.}
proc clear*(self: WebGLRenderingContext, mask: float) : void {.importcpp.}
proc clearColor*(self: WebGLRenderingContext, red: float, green: float, blue: float, alpha: float) : void {.importcpp.}
...
proc colorMask*(self: WebGLRenderingContext, red: bool, green: bool, blue: bool, alpha: bool) : void {.importcpp.}
proc compileShader*(self: WebGLRenderingContext, shader: WebGLShader) : void {.importcpp.}
proc compressedTexImage2D*(self: WebGLRenderingContext, target: float, level: float, internalformat: float, width: float, height: float, border: float, data: ArrayBufferView) : void {.importcpp.}
proc compressedTexSubImage2D*(self: WebGLRenderingContext, target: float, level: float, xoffset: float, yoffset: float, width: float, height: float, format: float, data: ArrayBufferView) : void {.importcpp.}
proc copyTexImage2D*(self: WebGLRenderingContext, target: float, level: float, internalformat: float, x: float, y: float, width: float, height: float, border: float) : void {.importcpp.}
proc copyTexSubImage2D*(self: WebGLRenderingContext, target: float, level: float, xoffset: float, yoffset: float, x: float, y: float, width: float, height: float) : void {.importcpp.}
...
proc createShader*(self: WebGLRenderingContext, xType: float) : WebGLShader {.importcpp.}
...
proc deleteBuffer*(self: WebGLRenderingContext, buffer: WebGLBuffer) : void {.importcpp.}
proc deleteFramebuffer*(self: WebGLRenderingContext, framebuffer: WebGLFramebuffer) : void {.importcpp.}
proc deleteProgram*(self: WebGLRenderingContext, program: WebGLProgram) : void {.importcpp.}
proc deleteRenderbuffer*(self: WebGLRenderingContext, renderbuffer: WebGLRenderbuffer) : void {.importcpp.}
proc deleteShader*(self: WebGLRenderingContext, shader: WebGLShader) : void {.importcpp.}
proc deleteTexture*(self: WebGLRenderingContext, texture: WebGLTexture) : void {.importcpp.}
...
proc depthRange*(self: WebGLRenderingContext, zNear: float, zFar: float) : void {.importcpp.}
proc detachShader*(self: WebGLRenderingContext, program: WebGLProgram, shader: WebGLShader) : void {.importcpp.}
proc disable*(self: WebGLRenderingContext, cap: float) : void {.importcpp.}
proc disableVertexAttribArray*(self: WebGLRenderingContext, index: float) : void {.importcpp.}
proc drawArrays*(self: WebGLRenderingContext, mode: float, first: float, count: float) : void {.importcpp.}
proc drawElements*(self: WebGLRenderingContext, mode: float, count: float, xType: float, offset: float) : void {.importcpp.}
proc enable*(self: WebGLRenderingContext, cap: float) : void {.importcpp.}
proc enableVertexAttribArray*(self: WebGLRenderingContext, index: float) : void {.importcpp.}
proc finish*(self: WebGLRenderingContext) : void {.importcpp.}
proc flush*(self: WebGLRenderingContext) : void {.importcpp.}
proc framebufferRenderbuffer*(self: WebGLRenderingContext, target: float, attachment: float, renderbuffertarget: float, renderbuffer: WebGLRenderbuffer) : void {.importcpp.}
proc framebufferTexture2D*(self: WebGLRenderingContext, target: float, attachment: float, textarget: float, texture: WebGLTexture, level: float) : void {.importcpp.}
proc frontFace*(self: WebGLRenderingContext, mode: float) : void {.importcpp.}
proc generateMipmap*(self: WebGLRenderingContext, target: float) : void {.importcpp.}
proc getActiveAttrib*(self: WebGLRenderingContext, program: WebGLProgram, index: float) : WebGLActiveInfo {.importcpp.}
proc getActiveUniform*(self: WebGLRenderingContext, program: WebGLProgram, index: float) : WebGLActiveInfo {.importcpp.}
proc getAttribLocation*(self: WebGLRenderingContext, program: WebGLProgram, name: cstring) : float {.importcpp.}
...
proc getProgramInfoLog*(self: WebGLRenderingContext, program: WebGLProgram) : cstring {.importcpp.}
proc getShaderInfoLog*(self: WebGLRenderingContext, shader: WebGLShader) : cstring {.importcpp.}
proc getShaderPrecisionFormat*(self: WebGLRenderingContext, shadertype: float, precisiontype: float) : WebGLShaderPrecisionFormat {.importcpp.}
proc getShaderSource*(self: WebGLRenderingContext, shader: WebGLShader) : cstring {.importcpp.}
proc getUniformLocation*(self: WebGLRenderingContext, program: WebGLProgram, name: cstring) : WebGLUniformLocation {.importcpp.}
proc getVertexAttribOffset*(self: WebGLRenderingContext, index: float, pname: float) : float {.importcpp.}
proc hint*(self: WebGLRenderingContext, target: float, mode: float) : void {.importcpp.}
proc isBuffer*(self: WebGLRenderingContext, buffer: WebGLBuffer) : bool {.importcpp.}
...
proc isFramebuffer*(self: WebGLRenderingContext, framebuffer: WebGLFramebuffer) : bool {.importcpp.}
proc isProgram*(self: WebGLRenderingContext, program: WebGLProgram) : bool {.importcpp.}
proc isRenderbuffer*(self: WebGLRenderingContext, renderbuffer: WebGLRenderbuffer) : bool {.importcpp.}
proc isShader*(self: WebGLRenderingContext, shader: WebGLShader) : bool {.importcpp.}
proc isTexture*(self: WebGLRenderingContext, texture: WebGLTexture) : bool {.importcpp.}
proc lineWidth*(self: WebGLRenderingContext, width: float) : void {.importcpp.}
proc linkProgram*(self: WebGLRenderingContext, program: WebGLProgram) : void {.importcpp.}
proc pixelStorei*(self: WebGLRenderingContext, pname: float, param: float) : void {.importcpp.}
proc polygonOffset*(self: WebGLRenderingContext, factor: float, units: float) : void {.importcpp.}
proc readPixels*(self: WebGLRenderingContext, x: float, y: float, width: float, height: float, format: float, xType: float, pixels: ArrayBufferView) : void {.importcpp.}
proc renderbufferStorage*(self: WebGLRenderingContext, target: float, internalformat: float, width: float, height: float) : void {.importcpp.}
proc sampleCoverage*(self: WebGLRenderingContext, value: float, invert: bool) : void {.importcpp.}
proc scissor*(self: WebGLRenderingContext, x: float, y: float, width: float, height: float) : void {.importcpp.}
proc shaderSource*(self: WebGLRenderingContext, shader: WebGLShader, source: cstring) : void {.importcpp.}
proc stencilFunc*(self: WebGLRenderingContext, xFunc: float, xRef: float, mask: float) : void {.importcpp.}
proc stencilFuncSeparate*(self: WebGLRenderingContext, face: float, xFunc: float, xRef: float, mask: float) : void {.importcpp.}
proc stencilMask*(self: WebGLRenderingContext, mask: float) : void {.importcpp.}
proc stencilMaskSeparate*(self: WebGLRenderingContext, face: float, mask: float) : void {.importcpp.}
proc stencilOp*(self: WebGLRenderingContext, fail: float, zfail: float, zpass: float) : void {.importcpp.}
proc stencilOpSeparate*(self: WebGLRenderingContext, face: float, fail: float, zfail: float, zpass: float) : void {.importcpp.}
proc texImage2D*(self: WebGLRenderingContext, target: float, level: float, internalformat: float, width: float, height: float, border: float, format: float, xType: float, pixels: ArrayBufferView) : void {.importcpp.}
proc texImage2D*(self: WebGLRenderingContext, target: float, level: float, internalformat: float, format: float, xType: float, image: HTMLImageElement) : void {.importcpp.}
proc texImage2D*(self: WebGLRenderingContext, target: float, level: float, internalformat: float, format: float, xType: float, canvas: HTMLCanvasElement) : void {.importcpp.}
proc texImage2D*(self: WebGLRenderingContext, target: float, level: float, internalformat: float, format: float, xType: float, video: HTMLVideoElement) : void {.importcpp.}
proc texImage2D*(self: WebGLRenderingContext, target: float, level: float, internalformat: float, format: float, xType: float, pixels: ImageData) : void {.importcpp.}
proc texParameterf*(self: WebGLRenderingContext, target: float, pname: float, param: float) : void {.importcpp.}
proc texParameteri*(self: WebGLRenderingContext, target: float, pname: float, param: float) : void {.importcpp.}
proc texSubImage2D*(self: WebGLRenderingContext, target: float, level: float, xoffset: float, yoffset: float, width: float, height: float, format: float, xType: float, pixels: ArrayBufferView) : void {.importcpp.}
proc texSubImage2D*(self: WebGLRenderingContext, target: float, level: float, xoffset: float, yoffset: float, format: float, xType: float, image: HTMLImageElement) : void {.importcpp.}
proc texSubImage2D*(self: WebGLRenderingContext, target: float, level: float, xoffset: float, yoffset: float, format: float, xType: float, canvas: HTMLCanvasElement) : void {.importcpp.}
proc texSubImage2D*(self: WebGLRenderingContext, target: float, level: float, xoffset: float, yoffset: float, format: float, xType: float, video: HTMLVideoElement) : void {.importcpp.}
proc texSubImage2D*(self: WebGLRenderingContext, target: float, level: float, xoffset: float, yoffset: float, format: float, xType: float, pixels: ImageData) : void {.importcpp.}
proc uniform1f*(self: WebGLRenderingContext, location: WebGLUniformLocation, x: float) : void {.importcpp.}
proc uniform1fv*(self: WebGLRenderingContext, location: WebGLUniformLocation, v: Float32Array) : void {.importcpp.}
proc uniform1i*(self: WebGLRenderingContext, location: WebGLUniformLocation, x: float) : void {.importcpp.}
proc uniform1iv*(self: WebGLRenderingContext, location: WebGLUniformLocation, v: Int32Array) : void {.importcpp.}
proc uniform2f*(self: WebGLRenderingContext, location: WebGLUniformLocation, x: float, y: float) : void {.importcpp.}
proc uniform2fv*(self: WebGLRenderingContext, location: WebGLUniformLocation, v: Float32Array) : void {.importcpp.}
proc uniform2i*(self: WebGLRenderingContext, location: WebGLUniformLocation, x: float, y: float) : void {.importcpp.}
proc uniform2iv*(self: WebGLRenderingContext, location: WebGLUniformLocation, v: Int32Array) : void {.importcpp.}
proc uniform3f*(self: WebGLRenderingContext, location: WebGLUniformLocation, x: float, y: float, z: float) : void {.importcpp.}
proc uniform3fv*(self: WebGLRenderingContext, location: WebGLUniformLocation, v: Float32Array) : void {.importcpp.}
proc uniform3i*(self: WebGLRenderingContext, location: WebGLUniformLocation, x: float, y: float, z: float) : void {.importcpp.}
proc uniform3iv*(self: WebGLRenderingContext, location: WebGLUniformLocation, v: Int32Array) : void {.importcpp.}
proc uniform4f*(self: WebGLRenderingContext, location: WebGLUniformLocation, x: float, y: float, z: float, w: float) : void {.importcpp.}
proc uniform4fv*(self: WebGLRenderingContext, location: WebGLUniformLocation, v: Float32Array) : void {.importcpp.}
proc uniform4i*(self: WebGLRenderingContext, location: WebGLUniformLocation, x: float, y: float, z: float, w: float) : void {.importcpp.}
proc uniform4iv*(self: WebGLRenderingContext, location: WebGLUniformLocation, v: Int32Array) : void {.importcpp.}
proc uniformMatrix2fv*(self: WebGLRenderingContext, location: WebGLUniformLocation, transpose: bool, value: Float32Array) : void {.importcpp.}
proc uniformMatrix3fv*(self: WebGLRenderingContext, location: WebGLUniformLocation, transpose: bool, value: Float32Array) : void {.importcpp.}
proc uniformMatrix4fv*(self: WebGLRenderingContext, location: WebGLUniformLocation, transpose: bool, value: Float32Array) : void {.importcpp.}
proc useProgram*(self: WebGLRenderingContext, program: WebGLProgram) : void {.importcpp.}
proc validateProgram*(self: WebGLRenderingContext, program: WebGLProgram) : void {.importcpp.}
proc vertexAttrib1f*(self: WebGLRenderingContext, indx: float, x: float) : void {.importcpp.}
proc vertexAttrib1fv*(self: WebGLRenderingContext, indx: float, values: Float32Array) : void {.importcpp.}
proc vertexAttrib2f*(self: WebGLRenderingContext, indx: float, x: float, y: float) : void {.importcpp.}
proc vertexAttrib2fv*(self: WebGLRenderingContext, indx: float, values: Float32Array) : void {.importcpp.}
proc vertexAttrib3f*(self: WebGLRenderingContext, indx: float, x: float, y: float, z: float) : void {.importcpp.}
proc vertexAttrib3fv*(self: WebGLRenderingContext, indx: float, values: Float32Array) : void {.importcpp.}
proc vertexAttrib4f*(self: WebGLRenderingContext, indx: float, x: float, y: float, z: float, w: float) : void {.importcpp.}
proc vertexAttrib4fv*(self: WebGLRenderingContext, indx: float, values: Float32Array) : void {.importcpp.}
proc vertexAttribPointer*(self: WebGLRenderingContext, indx: float, size: float, xType: float, normalized: bool, stride: float, offset: float) : void {.importcpp.}
proc viewport*(self: WebGLRenderingContext, x: float, y: float, width: float, height: float) : void {.importcpp.}
var WebGLRenderingContextACTIVE_ATTRIBUTES* {.importc:"WebGLRenderingContext.ACTIVE_ATTRIBUTES", nodecl.}: float
var WebGLRenderingContextACTIVE_TEXTURE* {.importc:"WebGLRenderingContext.ACTIVE_TEXTURE", nodecl.}: float
var WebGLRenderingContextACTIVE_UNIFORMS* {.importc:"WebGLRenderingContext.ACTIVE_UNIFORMS", nodecl.}: float
var WebGLRenderingContextALIASED_LINE_WIDTH_RANGE* {.importc:"WebGLRenderingContext.ALIASED_LINE_WIDTH_RANGE", nodecl.}: float
var WebGLRenderingContextALIASED_POINT_SIZE_RANGE* {.importc:"WebGLRenderingContext.ALIASED_POINT_SIZE_RANGE", nodecl.}: float
var WebGLRenderingContextALPHA* {.importc:"WebGLRenderingContext.ALPHA", nodecl.}: float
var WebGLRenderingContextALPHA_BITS* {.importc:"WebGLRenderingContext.ALPHA_BITS", nodecl.}: float
var WebGLRenderingContextALWAYS* {.importc:"WebGLRenderingContext.ALWAYS", nodecl.}: float
var WebGLRenderingContextARRAY_BUFFER* {.importc:"WebGLRenderingContext.ARRAY_BUFFER", nodecl.}: float
var WebGLRenderingContextARRAY_BUFFER_BINDING* {.importc:"WebGLRenderingContext.ARRAY_BUFFER_BINDING", nodecl.}: float
var WebGLRenderingContextATTACHED_SHADERS* {.importc:"WebGLRenderingContext.ATTACHED_SHADERS", nodecl.}: float
var WebGLRenderingContextBACK* {.importc:"WebGLRenderingContext.BACK", nodecl.}: float
var WebGLRenderingContextBLEND* {.importc:"WebGLRenderingContext.BLEND", nodecl.}: float
var WebGLRenderingContextBLEND_COLOR* {.importc:"WebGLRenderingContext.BLEND_COLOR", nodecl.}: float
var WebGLRenderingContextBLEND_DST_ALPHA* {.importc:"WebGLRenderingContext.BLEND_DST_ALPHA", nodecl.}: float
var WebGLRenderingContextBLEND_DST_RGB* {.importc:"WebGLRenderingContext.BLEND_DST_RGB", nodecl.}: float
var WebGLRenderingContextBLEND_EQUATION* {.importc:"WebGLRenderingContext.BLEND_EQUATION", nodecl.}: float
var WebGLRenderingContextBLEND_EQUATION_ALPHA* {.importc:"WebGLRenderingContext.BLEND_EQUATION_ALPHA", nodecl.}: float
var WebGLRenderingContextBLEND_EQUATION_RGB* {.importc:"WebGLRenderingContext.BLEND_EQUATION_RGB", nodecl.}: float
var WebGLRenderingContextBLEND_SRC_ALPHA* {.importc:"WebGLRenderingContext.BLEND_SRC_ALPHA", nodecl.}: float
var WebGLRenderingContextBLEND_SRC_RGB* {.importc:"WebGLRenderingContext.BLEND_SRC_RGB", nodecl.}: float
var WebGLRenderingContextBLUE_BITS* {.importc:"WebGLRenderingContext.BLUE_BITS", nodecl.}: float
var WebGLRenderingContextBOOL* {.importc:"WebGLRenderingContext.BOOL", nodecl.}: float
var WebGLRenderingContextBOOL_VEC2* {.importc:"WebGLRenderingContext.BOOL_VEC2", nodecl.}: float
var WebGLRenderingContextBOOL_VEC3* {.importc:"WebGLRenderingContext.BOOL_VEC3", nodecl.}: float
var WebGLRenderingContextBOOL_VEC4* {.importc:"WebGLRenderingContext.BOOL_VEC4", nodecl.}: float
var WebGLRenderingContextBROWSER_DEFAULT_WEBGL* {.importc:"WebGLRenderingContext.BROWSER_DEFAULT_WEBGL", nodecl.}: float
var WebGLRenderingContextBUFFER_SIZE* {.importc:"WebGLRenderingContext.BUFFER_SIZE", nodecl.}: float
var WebGLRenderingContextBUFFER_USAGE* {.importc:"WebGLRenderingContext.BUFFER_USAGE", nodecl.}: float
var WebGLRenderingContextBYTE* {.importc:"WebGLRenderingContext.BYTE", nodecl.}: float
var WebGLRenderingContextCCW* {.importc:"WebGLRenderingContext.CCW", nodecl.}: float
var WebGLRenderingContextCLAMP_TO_EDGE* {.importc:"WebGLRenderingContext.CLAMP_TO_EDGE", nodecl.}: float
var WebGLRenderingContextCOLOR_ATTACHMENT0* {.importc:"WebGLRenderingContext.COLOR_ATTACHMENT0", nodecl.}: float
var WebGLRenderingContextCOLOR_BUFFER_BIT* {.importc:"WebGLRenderingContext.COLOR_BUFFER_BIT", nodecl.}: float
var WebGLRenderingContextCOLOR_CLEAR_VALUE* {.importc:"WebGLRenderingContext.COLOR_CLEAR_VALUE", nodecl.}: float
var WebGLRenderingContextCOLOR_WRITEMASK* {.importc:"WebGLRenderingContext.COLOR_WRITEMASK", nodecl.}: float
var WebGLRenderingContextCOMPILE_STATUS* {.importc:"WebGLRenderingContext.COMPILE_STATUS", nodecl.}: float
var WebGLRenderingContextCOMPRESSED_TEXTURE_FORMATS* {.importc:"WebGLRenderingContext.COMPRESSED_TEXTURE_FORMATS", nodecl.}: float
var WebGLRenderingContextCONSTANT_ALPHA* {.importc:"WebGLRenderingContext.CONSTANT_ALPHA", nodecl.}: float
var WebGLRenderingContextCONSTANT_COLOR* {.importc:"WebGLRenderingContext.CONSTANT_COLOR", nodecl.}: float
var WebGLRenderingContextCONTEXT_LOST_WEBGL* {.importc:"WebGLRenderingContext.CONTEXT_LOST_WEBGL", nodecl.}: float
var WebGLRenderingContextCULL_FACE* {.importc:"WebGLRenderingContext.CULL_FACE", nodecl.}: float
var WebGLRenderingContextCULL_FACE_MODE* {.importc:"WebGLRenderingContext.CULL_FACE_MODE", nodecl.}: float
var WebGLRenderingContextCURRENT_PROGRAM* {.importc:"WebGLRenderingContext.CURRENT_PROGRAM", nodecl.}: float
var WebGLRenderingContextCURRENT_VERTEX_ATTRIB* {.importc:"WebGLRenderingContext.CURRENT_VERTEX_ATTRIB", nodecl.}: float
var WebGLRenderingContextCW* {.importc:"WebGLRenderingContext.CW", nodecl.}: float
var WebGLRenderingContextDECR* {.importc:"WebGLRenderingContext.DECR", nodecl.}: float
var WebGLRenderingContextDECR_WRAP* {.importc:"WebGLRenderingContext.DECR_WRAP", nodecl.}: float
var WebGLRenderingContextDELETE_STATUS* {.importc:"WebGLRenderingContext.DELETE_STATUS", nodecl.}: float
var WebGLRenderingContextDEPTH_ATTACHMENT* {.importc:"WebGLRenderingContext.DEPTH_ATTACHMENT", nodecl.}: float
var WebGLRenderingContextDEPTH_BITS* {.importc:"WebGLRenderingContext.DEPTH_BITS", nodecl.}: float
var WebGLRenderingContextDEPTH_BUFFER_BIT* {.importc:"WebGLRenderingContext.DEPTH_BUFFER_BIT", nodecl.}: float
var WebGLRenderingContextDEPTH_CLEAR_VALUE* {.importc:"WebGLRenderingContext.DEPTH_CLEAR_VALUE", nodecl.}: float
var WebGLRenderingContextDEPTH_COMPONENT* {.importc:"WebGLRenderingContext.DEPTH_COMPONENT", nodecl.}: float
var WebGLRenderingContextDEPTH_COMPONENT16* {.importc:"WebGLRenderingContext.DEPTH_COMPONENT16", nodecl.}: float
var WebGLRenderingContextDEPTH_FUNC* {.importc:"WebGLRenderingContext.DEPTH_FUNC", nodecl.}: float
var WebGLRenderingContextDEPTH_RANGE* {.importc:"WebGLRenderingContext.DEPTH_RANGE", nodecl.}: float
var WebGLRenderingContextDEPTH_STENCIL* {.importc:"WebGLRenderingContext.DEPTH_STENCIL", nodecl.}: float
var WebGLRenderingContextDEPTH_STENCIL_ATTACHMENT* {.importc:"WebGLRenderingContext.DEPTH_STENCIL_ATTACHMENT", nodecl.}: float
var WebGLRenderingContextDEPTH_TEST* {.importc:"WebGLRenderingContext.DEPTH_TEST", nodecl.}: float
var WebGLRenderingContextDEPTH_WRITEMASK* {.importc:"WebGLRenderingContext.DEPTH_WRITEMASK", nodecl.}: float
var WebGLRenderingContextDITHER* {.importc:"WebGLRenderingContext.DITHER", nodecl.}: float
var WebGLRenderingContextDONT_CARE* {.importc:"WebGLRenderingContext.DONT_CARE", nodecl.}: float
var WebGLRenderingContextDST_ALPHA* {.importc:"WebGLRenderingContext.DST_ALPHA", nodecl.}: float
var WebGLRenderingContextDST_COLOR* {.importc:"WebGLRenderingContext.DST_COLOR", nodecl.}: float
var WebGLRenderingContextDYNAMIC_DRAW* {.importc:"WebGLRenderingContext.DYNAMIC_DRAW", nodecl.}: float
var WebGLRenderingContextELEMENT_ARRAY_BUFFER* {.importc:"WebGLRenderingContext.ELEMENT_ARRAY_BUFFER", nodecl.}: float
var WebGLRenderingContextELEMENT_ARRAY_BUFFER_BINDING* {.importc:"WebGLRenderingContext.ELEMENT_ARRAY_BUFFER_BINDING", nodecl.}: float
var WebGLRenderingContextEQUAL* {.importc:"WebGLRenderingContext.EQUAL", nodecl.}: float
var WebGLRenderingContextFASTEST* {.importc:"WebGLRenderingContext.FASTEST", nodecl.}: float
var WebGLRenderingContextFLOAT* {.importc:"WebGLRenderingContext.FLOAT", nodecl.}: float
var WebGLRenderingContextFLOAT_MAT2* {.importc:"WebGLRenderingContext.FLOAT_MAT2", nodecl.}: float
var WebGLRenderingContextFLOAT_MAT3* {.importc:"WebGLRenderingContext.FLOAT_MAT3", nodecl.}: float
var WebGLRenderingContextFLOAT_MAT4* {.importc:"WebGLRenderingContext.FLOAT_MAT4", nodecl.}: float
var WebGLRenderingContextFLOAT_VEC2* {.importc:"WebGLRenderingContext.FLOAT_VEC2", nodecl.}: float
var WebGLRenderingContextFLOAT_VEC3* {.importc:"WebGLRenderingContext.FLOAT_VEC3", nodecl.}: float
var WebGLRenderingContextFLOAT_VEC4* {.importc:"WebGLRenderingContext.FLOAT_VEC4", nodecl.}: float
var WebGLRenderingContextFRAGMENT_SHADER* {.importc:"WebGLRenderingContext.FRAGMENT_SHADER", nodecl.}: float
var WebGLRenderingContextFRAMEBUFFER* {.importc:"WebGLRenderingContext.FRAMEBUFFER", nodecl.}: float
var WebGLRenderingContextFRAMEBUFFER_ATTACHMENT_OBJECT_NAME* {.importc:"WebGLRenderingContext.FRAMEBUFFER_ATTACHMENT_OBJECT_NAME", nodecl.}: float
var WebGLRenderingContextFRAMEBUFFER_ATTACHMENT_OBJECT_TYPE* {.importc:"WebGLRenderingContext.FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE", nodecl.}: float
var WebGLRenderingContextFRAMEBUFFER_ATTACHMENT_TEXTURE_CUBE_MAP_FACE* {.importc:"WebGLRenderingContext.FRAMEBUFFER_ATTACHMENT_TEXTURE_CUBE_MAP_FACE", nodecl.}: float
var WebGLRenderingContextFRAMEBUFFER_ATTACHMENT_TEXTURE_LEVEL* {.importc:"WebGLRenderingContext.FRAMEBUFFER_ATTACHMENT_TEXTURE_LEVEL", nodecl.}: float
var WebGLRenderingContextFRAMEBUFFER_BINDING* {.importc:"WebGLRenderingContext.FRAMEBUFFER_BINDING", nodecl.}: float
var WebGLRenderingContextFRAMEBUFFER_COMPLETE* {.importc:"WebGLRenderingContext.FRAMEBUFFER_COMPLETE", nodecl.}: float
var WebGLRenderingContextFRAMEBUFFER_INCOMPLETE_ATTACHMENT* {.importc:"WebGLRenderingContext.FRAMEBUFFER_INCOMPLETE_ATTACHMENT", nodecl.}: float
var WebGLRenderingContextFRAMEBUFFER_INCOMPLETE_DIMENSIONS* {.importc:"WebGLRenderingContext.FRAMEBUFFER_INCOMPLETE_DIMENSIONS", nodecl.}: float
var WebGLRenderingContextFRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT* {.importc:"WebGLRenderingContext.FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT", nodecl.}: float
var WebGLRenderingContextFRAMEBUFFER_UNSUPPORTED* {.importc:"WebGLRenderingContext.FRAMEBUFFER_UNSUPPORTED", nodecl.}: float
var WebGLRenderingContextFRONT* {.importc:"WebGLRenderingContext.FRONT", nodecl.}: float
var WebGLRenderingContextFRONT_AND_BACK* {.importc:"WebGLRenderingContext.FRONT_AND_BACK", nodecl.}: float
var WebGLRenderingContextFRONT_FACE* {.importc:"WebGLRenderingContext.FRONT_FACE", nodecl.}: float
var WebGLRenderingContextFUNC_ADD* {.importc:"WebGLRenderingContext.FUNC_ADD", nodecl.}: float
var WebGLRenderingContextFUNC_REVERSE_SUBTRACT* {.importc:"WebGLRenderingContext.FUNC_REVERSE_SUBTRACT", nodecl.}: float
var WebGLRenderingContextFUNC_SUBTRACT* {.importc:"WebGLRenderingContext.FUNC_SUBTRACT", nodecl.}: float
var WebGLRenderingContextGENERATE_MIPMAP_HINT* {.importc:"WebGLRenderingContext.GENERATE_MIPMAP_HINT", nodecl.}: float
var WebGLRenderingContextGEQUAL* {.importc:"WebGLRenderingContext.GEQUAL", nodecl.}: float
var WebGLRenderingContextGREATER* {.importc:"WebGLRenderingContext.GREATER", nodecl.}: float
var WebGLRenderingContextGREEN_BITS* {.importc:"WebGLRenderingContext.GREEN_BITS", nodecl.}: float
var WebGLRenderingContextHIGH_FLOAT* {.importc:"WebGLRenderingContext.HIGH_FLOAT", nodecl.}: float
var WebGLRenderingContextHIGH_INT* {.importc:"WebGLRenderingContext.HIGH_INT", nodecl.}: float
var WebGLRenderingContextIMPLEMENTATION_COLOR_READ_FORMAT* {.importc:"WebGLRenderingContext.IMPLEMENTATION_COLOR_READ_FORMAT", nodecl.}: float
var WebGLRenderingContextIMPLEMENTATION_COLOR_READ_TYPE* {.importc:"WebGLRenderingContext.IMPLEMENTATION_COLOR_READ_TYPE", nodecl.}: float
var WebGLRenderingContextINCR* {.importc:"WebGLRenderingContext.INCR", nodecl.}: float
var WebGLRenderingContextINCR_WRAP* {.importc:"WebGLRenderingContext.INCR_WRAP", nodecl.}: float
var WebGLRenderingContextINT* {.importc:"WebGLRenderingContext.INT", nodecl.}: float
var WebGLRenderingContextINT_VEC2* {.importc:"WebGLRenderingContext.INT_VEC2", nodecl.}: float
var WebGLRenderingContextINT_VEC3* {.importc:"WebGLRenderingContext.INT_VEC3", nodecl.}: float
var WebGLRenderingContextINT_VEC4* {.importc:"WebGLRenderingContext.INT_VEC4", nodecl.}: float
var WebGLRenderingContextINVALID_ENUM* {.importc:"WebGLRenderingContext.INVALID_ENUM", nodecl.}: float
var WebGLRenderingContextINVALID_FRAMEBUFFER_OPERATION* {.importc:"WebGLRenderingContext.INVALID_FRAMEBUFFER_OPERATION", nodecl.}: float
var WebGLRenderingContextINVALID_OPERATION* {.importc:"WebGLRenderingContext.INVALID_OPERATION", nodecl.}: float
var WebGLRenderingContextINVALID_VALUE* {.importc:"WebGLRenderingContext.INVALID_VALUE", nodecl.}: float
var WebGLRenderingContextINVERT* {.importc:"WebGLRenderingContext.INVERT", nodecl.}: float
var WebGLRenderingContextKEEP* {.importc:"WebGLRenderingContext.KEEP", nodecl.}: float
var WebGLRenderingContextLEQUAL* {.importc:"WebGLRenderingContext.LEQUAL", nodecl.}: float
var WebGLRenderingContextLESS* {.importc:"WebGLRenderingContext.LESS", nodecl.}: float
var WebGLRenderingContextLINEAR* {.importc:"WebGLRenderingContext.LINEAR", nodecl.}: float
var WebGLRenderingContextLINEAR_MIPMAP_LINEAR* {.importc:"WebGLRenderingContext.LINEAR_MIPMAP_LINEAR", nodecl.}: float
var WebGLRenderingContextLINEAR_MIPMAP_NEAREST* {.importc:"WebGLRenderingContext.LINEAR_MIPMAP_NEAREST", nodecl.}: float
var WebGLRenderingContextLINES* {.importc:"WebGLRenderingContext.LINES", nodecl.}: float
var WebGLRenderingContextLINE_LOOP* {.importc:"WebGLRenderingContext.LINE_LOOP", nodecl.}: float
var WebGLRenderingContextLINE_STRIP* {.importc:"WebGLRenderingContext.LINE_STRIP", nodecl.}: float
var WebGLRenderingContextLINE_WIDTH* {.importc:"WebGLRenderingContext.LINE_WIDTH", nodecl.}: float
var WebGLRenderingContextLINK_STATUS* {.importc:"WebGLRenderingContext.LINK_STATUS", nodecl.}: float
var WebGLRenderingContextLOW_FLOAT* {.importc:"WebGLRenderingContext.LOW_FLOAT", nodecl.}: float
var WebGLRenderingContextLOW_INT* {.importc:"WebGLRenderingContext.LOW_INT", nodecl.}: float
var WebGLRenderingContextLUMINANCE* {.importc:"WebGLRenderingContext.LUMINANCE", nodecl.}: float
var WebGLRenderingContextLUMINANCE_ALPHA* {.importc:"WebGLRenderingContext.LUMINANCE_ALPHA", nodecl.}: float
var WebGLRenderingContextMAX_COMBINED_TEXTURE_IMAGE_UNITS* {.importc:"WebGLRenderingContext.MAX_COMBINED_TEXTURE_IMAGE_UNITS", nodecl.}: float
var WebGLRenderingContextMAX_CUBE_MAP_TEXTURE_SIZE* {.importc:"WebGLRenderingContext.MAX_CUBE_MAP_TEXTURE_SIZE", nodecl.}: float
var WebGLRenderingContextMAX_FRAGMENT_UNIFORM_VECTORS* {.importc:"WebGLRenderingContext.MAX_FRAGMENT_UNIFORM_VECTORS", nodecl.}: float
var WebGLRenderingContextMAX_RENDERBUFFER_SIZE* {.importc:"WebGLRenderingContext.MAX_RENDERBUFFER_SIZE", nodecl.}: float
var WebGLRenderingContextMAX_TEXTURE_IMAGE_UNITS* {.importc:"WebGLRenderingContext.MAX_TEXTURE_IMAGE_UNITS", nodecl.}: float
var WebGLRenderingContextMAX_TEXTURE_SIZE* {.importc:"WebGLRenderingContext.MAX_TEXTURE_SIZE", nodecl.}: float
var WebGLRenderingContextMAX_VARYING_VECTORS* {.importc:"WebGLRenderingContext.MAX_VARYING_VECTORS", nodecl.}: float
var WebGLRenderingContextMAX_VERTEX_ATTRIBS* {.importc:"WebGLRenderingContext.MAX_VERTEX_ATTRIBS", nodecl.}: float
var WebGLRenderingContextMAX_VERTEX_TEXTURE_IMAGE_UNITS* {.importc:"WebGLRenderingContext.MAX_VERTEX_TEXTURE_IMAGE_UNITS", nodecl.}: float
var WebGLRenderingContextMAX_VERTEX_UNIFORM_VECTORS* {.importc:"WebGLRenderingContext.MAX_VERTEX_UNIFORM_VECTORS", nodecl.}: float
var WebGLRenderingContextMAX_VIEWPORT_DIMS* {.importc:"WebGLRenderingContext.MAX_VIEWPORT_DIMS", nodecl.}: float
var WebGLRenderingContextMEDIUM_FLOAT* {.importc:"WebGLRenderingContext.MEDIUM_FLOAT", nodecl.}: float
var WebGLRenderingContextMEDIUM_INT* {.importc:"WebGLRenderingContext.MEDIUM_INT", nodecl.}: float
var WebGLRenderingContextMIRRORED_REPEAT* {.importc:"WebGLRenderingContext.MIRRORED_REPEAT", nodecl.}: float
var WebGLRenderingContextNEAREST* {.importc:"WebGLRenderingContext.NEAREST", nodecl.}: float
var WebGLRenderingContextNEAREST_MIPMAP_LINEAR* {.importc:"WebGLRenderingContext.NEAREST_MIPMAP_LINEAR", nodecl.}: float
var WebGLRenderingContextNEAREST_MIPMAP_NEAREST* {.importc:"WebGLRenderingContext.NEAREST_MIPMAP_NEAREST", nodecl.}: float
var WebGLRenderingContextNEVER* {.importc:"WebGLRenderingContext.NEVER", nodecl.}: float
var WebGLRenderingContextNICEST* {.importc:"WebGLRenderingContext.NICEST", nodecl.}: float
var WebGLRenderingContextNONE* {.importc:"WebGLRenderingContext.NONE", nodecl.}: float
var WebGLRenderingContextNOTEQUAL* {.importc:"WebGLRenderingContext.NOTEQUAL", nodecl.}: float
var WebGLRenderingContextNO_ERROR* {.importc:"WebGLRenderingContext.NO_ERROR", nodecl.}: float
var WebGLRenderingContextONE* {.importc:"WebGLRenderingContext.ONE", nodecl.}: float
var WebGLRenderingContextONE_MINUS_CONSTANT_ALPHA* {.importc:"WebGLRenderingContext.ONE_MINUS_CONSTANT_ALPHA", nodecl.}: float
var WebGLRenderingContextONE_MINUS_CONSTANT_COLOR* {.importc:"WebGLRenderingContext.ONE_MINUS_CONSTANT_COLOR", nodecl.}: float
var WebGLRenderingContextONE_MINUS_DST_ALPHA* {.importc:"WebGLRenderingContext.ONE_MINUS_DST_ALPHA", nodecl.}: float
var WebGLRenderingContextONE_MINUS_DST_COLOR* {.importc:"WebGLRenderingContext.ONE_MINUS_DST_COLOR", nodecl.}: float
var WebGLRenderingContextONE_MINUS_SRC_ALPHA* {.importc:"WebGLRenderingContext.ONE_MINUS_SRC_ALPHA", nodecl.}: float
var WebGLRenderingContextONE_MINUS_SRC_COLOR* {.importc:"WebGLRenderingContext.ONE_MINUS_SRC_COLOR", nodecl.}: float
var WebGLRenderingContextOUT_OF_MEMORY* {.importc:"WebGLRenderingContext.OUT_OF_MEMORY", nodecl.}: float
var WebGLRenderingContextPACK_ALIGNMENT* {.importc:"WebGLRenderingContext.PACK_ALIGNMENT", nodecl.}: float
var WebGLRenderingContextPOINTS* {.importc:"WebGLRenderingContext.POINTS", nodecl.}: float
var WebGLRenderingContextPOLYGON_OFFSET_FACTOR* {.importc:"WebGLRenderingContext.POLYGON_OFFSET_FACTOR", nodecl.}: float
var WebGLRenderingContextPOLYGON_OFFSET_FILL* {.importc:"WebGLRenderingContext.POLYGON_OFFSET_FILL", nodecl.}: float
var WebGLRenderingContextPOLYGON_OFFSET_UNITS* {.importc:"WebGLRenderingContext.POLYGON_OFFSET_UNITS", nodecl.}: float
var WebGLRenderingContextRED_BITS* {.importc:"WebGLRenderingContext.RED_BITS", nodecl.}: float
var WebGLRenderingContextRENDERBUFFER* {.importc:"WebGLRenderingContext.RENDERBUFFER", nodecl.}: float
var WebGLRenderingContextRENDERBUFFER_ALPHA_SIZE* {.importc:"WebGLRenderingContext.RENDERBUFFER_ALPHA_SIZE", nodecl.}: float
var WebGLRenderingContextRENDERBUFFER_BINDING* {.importc:"WebGLRenderingContext.RENDERBUFFER_BINDING", nodecl.}: float
var WebGLRenderingContextRENDERBUFFER_BLUE_SIZE* {.importc:"WebGLRenderingContext.RENDERBUFFER_BLUE_SIZE", nodecl.}: float
var WebGLRenderingContextRENDERBUFFER_DEPTH_SIZE* {.importc:"WebGLRenderingContext.RENDERBUFFER_DEPTH_SIZE", nodecl.}: float
var WebGLRenderingContextRENDERBUFFER_GREEN_SIZE* {.importc:"WebGLRenderingContext.RENDERBUFFER_GREEN_SIZE", nodecl.}: float
var WebGLRenderingContextRENDERBUFFER_HEIGHT* {.importc:"WebGLRenderingContext.RENDERBUFFER_HEIGHT", nodecl.}: float
var WebGLRenderingContextRENDERBUFFER_INTERNAL_FORMAT* {.importc:"WebGLRenderingContext.RENDERBUFFER_INTERNAL_FORMAT", nodecl.}: float
var WebGLRenderingContextRENDERBUFFER_RED_SIZE* {.importc:"WebGLRenderingContext.RENDERBUFFER_RED_SIZE", nodecl.}: float
var WebGLRenderingContextRENDERBUFFER_STENCIL_SIZE* {.importc:"WebGLRenderingContext.RENDERBUFFER_STENCIL_SIZE", nodecl.}: float
var WebGLRenderingContextRENDERBUFFER_WIDTH* {.importc:"WebGLRenderingContext.RENDERBUFFER_WIDTH", nodecl.}: float
var WebGLRenderingContextRENDERER* {.importc:"WebGLRenderingContext.RENDERER", nodecl.}: float
var WebGLRenderingContextREPEAT* {.importc:"WebGLRenderingContext.REPEAT", nodecl.}: float
var WebGLRenderingContextREPLACE* {.importc:"WebGLRenderingContext.REPLACE", nodecl.}: float
var WebGLRenderingContextRGB* {.importc:"WebGLRenderingContext.RGB", nodecl.}: float
var WebGLRenderingContextRGB565* {.importc:"WebGLRenderingContext.RGB565", nodecl.}: float
var WebGLRenderingContextRGB5_A1* {.importc:"WebGLRenderingContext.RGB5_A1", nodecl.}: float
var WebGLRenderingContextRGBA* {.importc:"WebGLRenderingContext.RGBA", nodecl.}: float
var WebGLRenderingContextRGBA4* {.importc:"WebGLRenderingContext.RGBA4", nodecl.}: float
var WebGLRenderingContextSAMPLER_2D* {.importc:"WebGLRenderingContext.SAMPLER_2D", nodecl.}: float
var WebGLRenderingContextSAMPLER_CUBE* {.importc:"WebGLRenderingContext.SAMPLER_CUBE", nodecl.}: float
var WebGLRenderingContextSAMPLES* {.importc:"WebGLRenderingContext.SAMPLES", nodecl.}: float
var WebGLRenderingContextSAMPLE_ALPHA_TO_COVERAGE* {.importc:"WebGLRenderingContext.SAMPLE_ALPHA_TO_COVERAGE", nodecl.}: float
var WebGLRenderingContextSAMPLE_BUFFERS* {.importc:"WebGLRenderingContext.SAMPLE_BUFFERS", nodecl.}: float
var WebGLRenderingContextSAMPLE_COVERAGE* {.importc:"WebGLRenderingContext.SAMPLE_COVERAGE", nodecl.}: float
var WebGLRenderingContextSAMPLE_COVERAGE_INVERT* {.importc:"WebGLRenderingContext.SAMPLE_COVERAGE_INVERT", nodecl.}: float
var WebGLRenderingContextSAMPLE_COVERAGE_VALUE* {.importc:"WebGLRenderingContext.SAMPLE_COVERAGE_VALUE", nodecl.}: float
var WebGLRenderingContextSCISSOR_BOX* {.importc:"WebGLRenderingContext.SCISSOR_BOX", nodecl.}: float
var WebGLRenderingContextSCISSOR_TEST* {.importc:"WebGLRenderingContext.SCISSOR_TEST", nodecl.}: float
var WebGLRenderingContextSHADER_TYPE* {.importc:"WebGLRenderingContext.SHADER_TYPE", nodecl.}: float
var WebGLRenderingContextSHADING_LANGUAGE_VERSION* {.importc:"WebGLRenderingContext.SHADING_LANGUAGE_VERSION", nodecl.}: float
var WebGLRenderingContextSHORT* {.importc:"WebGLRenderingContext.SHORT", nodecl.}: float
var WebGLRenderingContextSRC_ALPHA* {.importc:"WebGLRenderingContext.SRC_ALPHA", nodecl.}: float
var WebGLRenderingContextSRC_ALPHA_SATURATE* {.importc:"WebGLRenderingContext.SRC_ALPHA_SATURATE", nodecl.}: float
var WebGLRenderingContextSRC_COLOR* {.importc:"WebGLRenderingContext.SRC_COLOR", nodecl.}: float
var WebGLRenderingContextSTATIC_DRAW* {.importc:"WebGLRenderingContext.STATIC_DRAW", nodecl.}: float
var WebGLRenderingContextSTENCIL_ATTACHMENT* {.importc:"WebGLRenderingContext.STENCIL_ATTACHMENT", nodecl.}: float
var WebGLRenderingContextSTENCIL_BACK_FAIL* {.importc:"WebGLRenderingContext.STENCIL_BACK_FAIL", nodecl.}: float
var WebGLRenderingContextSTENCIL_BACK_FUNC* {.importc:"WebGLRenderingContext.STENCIL_BACK_FUNC", nodecl.}: float
var WebGLRenderingContextSTENCIL_BACK_PASS_DEPTH_FAIL* {.importc:"WebGLRenderingContext.STENCIL_BACK_PASS_DEPTH_FAIL", nodecl.}: float
var WebGLRenderingContextSTENCIL_BACK_PASS_DEPTH_PASS* {.importc:"WebGLRenderingContext.STENCIL_BACK_PASS_DEPTH_PASS", nodecl.}: float
var WebGLRenderingContextSTENCIL_BACK_REF* {.importc:"WebGLRenderingContext.STENCIL_BACK_REF", nodecl.}: float
var WebGLRenderingContextSTENCIL_BACK_VALUE_MASK* {.importc:"WebGLRenderingContext.STENCIL_BACK_VALUE_MASK", nodecl.}: float
var WebGLRenderingContextSTENCIL_BACK_WRITEMASK* {.importc:"WebGLRenderingContext.STENCIL_BACK_WRITEMASK", nodecl.}: float
var WebGLRenderingContextSTENCIL_BITS* {.importc:"WebGLRenderingContext.STENCIL_BITS", nodecl.}: float
var WebGLRenderingContextSTENCIL_BUFFER_BIT* {.importc:"WebGLRenderingContext.STENCIL_BUFFER_BIT", nodecl.}: float
var WebGLRenderingContextSTENCIL_CLEAR_VALUE* {.importc:"WebGLRenderingContext.STENCIL_CLEAR_VALUE", nodecl.}: float
var WebGLRenderingContextSTENCIL_FAIL* {.importc:"WebGLRenderingContext.STENCIL_FAIL", nodecl.}: float
var WebGLRenderingContextSTENCIL_FUNC* {.importc:"WebGLRenderingContext.STENCIL_FUNC", nodecl.}: float
var WebGLRenderingContextSTENCIL_INDEX* {.importc:"WebGLRenderingContext.STENCIL_INDEX", nodecl.}: float
var WebGLRenderingContextSTENCIL_INDEX8* {.importc:"WebGLRenderingContext.STENCIL_INDEX8", nodecl.}: float
var WebGLRenderingContextSTENCIL_PASS_DEPTH_FAIL* {.importc:"WebGLRenderingContext.STENCIL_PASS_DEPTH_FAIL", nodecl.}: float
var WebGLRenderingContextSTENCIL_PASS_DEPTH_PASS* {.importc:"WebGLRenderingContext.STENCIL_PASS_DEPTH_PASS", nodecl.}: float
var WebGLRenderingContextSTENCIL_REF* {.importc:"WebGLRenderingContext.STENCIL_REF", nodecl.}: float
var WebGLRenderingContextSTENCIL_TEST* {.importc:"WebGLRenderingContext.STENCIL_TEST", nodecl.}: float
var WebGLRenderingContextSTENCIL_VALUE_MASK* {.importc:"WebGLRenderingContext.STENCIL_VALUE_MASK", nodecl.}: float
var WebGLRenderingContextSTENCIL_WRITEMASK* {.importc:"WebGLRenderingContext.STENCIL_WRITEMASK", nodecl.}: float
var WebGLRenderingContextSTREAM_DRAW* {.importc:"WebGLRenderingContext.STREAM_DRAW", nodecl.}: float
var WebGLRenderingContextSUBPIXEL_BITS* {.importc:"WebGLRenderingContext.SUBPIXEL_BITS", nodecl.}: float
var WebGLRenderingContextTEXTURE* {.importc:"WebGLRenderingContext.TEXTURE", nodecl.}: float
var WebGLRenderingContextTEXTURE0* {.importc:"WebGLRenderingContext.TEXTURE0", nodecl.}: float
var WebGLRenderingContextTEXTURE1* {.importc:"WebGLRenderingContext.TEXTURE1", nodecl.}: float
var WebGLRenderingContextTEXTURE10* {.importc:"WebGLRenderingContext.TEXTURE10", nodecl.}: float
var WebGLRenderingContextTEXTURE11* {.importc:"WebGLRenderingContext.TEXTURE11", nodecl.}: float
var WebGLRenderingContextTEXTURE12* {.importc:"WebGLRenderingContext.TEXTURE12", nodecl.}: float
var WebGLRenderingContextTEXTURE13* {.importc:"WebGLRenderingContext.TEXTURE13", nodecl.}: float
var WebGLRenderingContextTEXTURE14* {.importc:"WebGLRenderingContext.TEXTURE14", nodecl.}: float
var WebGLRenderingContextTEXTURE15* {.importc:"WebGLRenderingContext.TEXTURE15", nodecl.}: float
var WebGLRenderingContextTEXTURE16* {.importc:"WebGLRenderingContext.TEXTURE16", nodecl.}: float
var WebGLRenderingContextTEXTURE17* {.importc:"WebGLRenderingContext.TEXTURE17", nodecl.}: float
var WebGLRenderingContextTEXTURE18* {.importc:"WebGLRenderingContext.TEXTURE18", nodecl.}: float
var WebGLRenderingContextTEXTURE19* {.importc:"WebGLRenderingContext.TEXTURE19", nodecl.}: float
var WebGLRenderingContextTEXTURE2* {.importc:"WebGLRenderingContext.TEXTURE2", nodecl.}: float
var WebGLRenderingContextTEXTURE20* {.importc:"WebGLRenderingContext.TEXTURE20", nodecl.}: float
var WebGLRenderingContextTEXTURE21* {.importc:"WebGLRenderingContext.TEXTURE21", nodecl.}: float
var WebGLRenderingContextTEXTURE22* {.importc:"WebGLRenderingContext.TEXTURE22", nodecl.}: float
var WebGLRenderingContextTEXTURE23* {.importc:"WebGLRenderingContext.TEXTURE23", nodecl.}: float
var WebGLRenderingContextTEXTURE24* {.importc:"WebGLRenderingContext.TEXTURE24", nodecl.}: float
var WebGLRenderingContextTEXTURE25* {.importc:"WebGLRenderingContext.TEXTURE25", nodecl.}: float
var WebGLRenderingContextTEXTURE26* {.importc:"WebGLRenderingContext.TEXTURE26", nodecl.}: float
var WebGLRenderingContextTEXTURE27* {.importc:"WebGLRenderingContext.TEXTURE27", nodecl.}: float
var WebGLRenderingContextTEXTURE28* {.importc:"WebGLRenderingContext.TEXTURE28", nodecl.}: float
var WebGLRenderingContextTEXTURE29* {.importc:"WebGLRenderingContext.TEXTURE29", nodecl.}: float
var WebGLRenderingContextTEXTURE3* {.importc:"WebGLRenderingContext.TEXTURE3", nodecl.}: float
var WebGLRenderingContextTEXTURE30* {.importc:"WebGLRenderingContext.TEXTURE30", nodecl.}: float
var WebGLRenderingContextTEXTURE31* {.importc:"WebGLRenderingContext.TEXTURE31", nodecl.}: float
var WebGLRenderingContextTEXTURE4* {.importc:"WebGLRenderingContext.TEXTURE4", nodecl.}: float
var WebGLRenderingContextTEXTURE5* {.importc:"WebGLRenderingContext.TEXTURE5", nodecl.}: float
var WebGLRenderingContextTEXTURE6* {.importc:"WebGLRenderingContext.TEXTURE6", nodecl.}: float
var WebGLRenderingContextTEXTURE7* {.importc:"WebGLRenderingContext.TEXTURE7", nodecl.}: float
var WebGLRenderingContextTEXTURE8* {.importc:"WebGLRenderingContext.TEXTURE8", nodecl.}: float
var WebGLRenderingContextTEXTURE9* {.importc:"WebGLRenderingContext.TEXTURE9", nodecl.}: float
var WebGLRenderingContextTEXTURE_2D* {.importc:"WebGLRenderingContext.TEXTURE_2D", nodecl.}: float
var WebGLRenderingContextTEXTURE_BINDING_2D* {.importc:"WebGLRenderingContext.TEXTURE_BINDING_2D", nodecl.}: float
var WebGLRenderingContextTEXTURE_BINDING_CUBE_MAP* {.importc:"WebGLRenderingContext.TEXTURE_BINDING_CUBE_MAP", nodecl.}: float
var WebGLRenderingContextTEXTURE_CUBE_MAP* {.importc:"WebGLRenderingContext.TEXTURE_CUBE_MAP", nodecl.}: float
var WebGLRenderingContextTEXTURE_CUBE_MAP_NEGATIVE_X* {.importc:"WebGLRenderingContext.TEXTURE_CUBE_MAP_NEGATIVE_X", nodecl.}: float
var WebGLRenderingContextTEXTURE_CUBE_MAP_NEGATIVE_Y* {.importc:"WebGLRenderingContext.TEXTURE_CUBE_MAP_NEGATIVE_Y", nodecl.}: float
var WebGLRenderingContextTEXTURE_CUBE_MAP_NEGATIVE_Z* {.importc:"WebGLRenderingContext.TEXTURE_CUBE_MAP_NEGATIVE_Z", nodecl.}: float
var WebGLRenderingContextTEXTURE_CUBE_MAP_POSITIVE_X* {.importc:"WebGLRenderingContext.TEXTURE_CUBE_MAP_POSITIVE_X", nodecl.}: float
var WebGLRenderingContextTEXTURE_CUBE_MAP_POSITIVE_Y* {.importc:"WebGLRenderingContext.TEXTURE_CUBE_MAP_POSITIVE_Y", nodecl.}: float
var WebGLRenderingContextTEXTURE_CUBE_MAP_POSITIVE_Z* {.importc:"WebGLRenderingContext.TEXTURE_CUBE_MAP_POSITIVE_Z", nodecl.}: float
var WebGLRenderingContextTEXTURE_MAG_FILTER* {.importc:"WebGLRenderingContext.TEXTURE_MAG_FILTER", nodecl.}: float
var WebGLRenderingContextTEXTURE_MIN_FILTER* {.importc:"WebGLRenderingContext.TEXTURE_MIN_FILTER", nodecl.}: float
var WebGLRenderingContextTEXTURE_WRAP_S* {.importc:"WebGLRenderingContext.TEXTURE_WRAP_S", nodecl.}: float
var WebGLRenderingContextTEXTURE_WRAP_T* {.importc:"WebGLRenderingContext.TEXTURE_WRAP_T", nodecl.}: float
var WebGLRenderingContextTRIANGLES* {.importc:"WebGLRenderingContext.TRIANGLES", nodecl.}: float
var WebGLRenderingContextTRIANGLE_FAN* {.importc:"WebGLRenderingContext.TRIANGLE_FAN", nodecl.}: float
var WebGLRenderingContextTRIANGLE_STRIP* {.importc:"WebGLRenderingContext.TRIANGLE_STRIP", nodecl.}: float
var WebGLRenderingContextUNPACK_ALIGNMENT* {.importc:"WebGLRenderingContext.UNPACK_ALIGNMENT", nodecl.}: float
var WebGLRenderingContextUNPACK_COLORSPACE_CONVERSION_WEBGL* {.importc:"WebGLRenderingContext.UNPACK_COLORSPACE_CONVERSION_WEBGL", nodecl.}: float
var WebGLRenderingContextUNPACK_FLIP_Y_WEBGL* {.importc:"WebGLRenderingContext.UNPACK_FLIP_Y_WEBGL", nodecl.}: float
var WebGLRenderingContextUNPACK_PREMULTIPLY_ALPHA_WEBGL* {.importc:"WebGLRenderingContext.UNPACK_PREMULTIPLY_ALPHA_WEBGL", nodecl.}: float
var WebGLRenderingContextUNSIGNED_BYTE* {.importc:"WebGLRenderingContext.UNSIGNED_BYTE", nodecl.}: float
var WebGLRenderingContextUNSIGNED_INT* {.importc:"WebGLRenderingContext.UNSIGNED_INT", nodecl.}: float
var WebGLRenderingContextUNSIGNED_SHORT* {.importc:"WebGLRenderingContext.UNSIGNED_SHORT", nodecl.}: float
var WebGLRenderingContextUNSIGNED_SHORT_4_4_4_4* {.importc:"WebGLRenderingContext.UNSIGNED_SHORT_4_4_4_4", nodecl.}: float
var WebGLRenderingContextUNSIGNED_SHORT_5_5_5_1* {.importc:"WebGLRenderingContext.UNSIGNED_SHORT_5_5_5_1", nodecl.}: float
var WebGLRenderingContextUNSIGNED_SHORT_5_6_5* {.importc:"WebGLRenderingContext.UNSIGNED_SHORT_5_6_5", nodecl.}: float
var WebGLRenderingContextVALIDATE_STATUS* {.importc:"WebGLRenderingContext.VALIDATE_STATUS", nodecl.}: float
var WebGLRenderingContextVENDOR* {.importc:"WebGLRenderingContext.VENDOR", nodecl.}: float
var WebGLRenderingContextVERSION* {.importc:"WebGLRenderingContext.VERSION", nodecl.}: float
var WebGLRenderingContextVERTEX_ATTRIB_ARRAY_BUFFER_BINDING* {.importc:"WebGLRenderingContext.VERTEX_ATTRIB_ARRAY_BUFFER_BINDING", nodecl.}: float
var WebGLRenderingContextVERTEX_ATTRIB_ARRAY_ENABLED* {.importc:"WebGLRenderingContext.VERTEX_ATTRIB_ARRAY_ENABLED", nodecl.}: float
var WebGLRenderingContextVERTEX_ATTRIB_ARRAY_NORMALIZED* {.importc:"WebGLRenderingContext.VERTEX_ATTRIB_ARRAY_NORMALIZED", nodecl.}: float
var WebGLRenderingContextVERTEX_ATTRIB_ARRAY_POINTER* {.importc:"WebGLRenderingContext.VERTEX_ATTRIB_ARRAY_POINTER", nodecl.}: float
var WebGLRenderingContextVERTEX_ATTRIB_ARRAY_SIZE* {.importc:"WebGLRenderingContext.VERTEX_ATTRIB_ARRAY_SIZE", nodecl.}: float
var WebGLRenderingContextVERTEX_ATTRIB_ARRAY_STRIDE* {.importc:"WebGLRenderingContext.VERTEX_ATTRIB_ARRAY_STRIDE", nodecl.}: float
var WebGLRenderingContextVERTEX_ATTRIB_ARRAY_TYPE* {.importc:"WebGLRenderingContext.VERTEX_ATTRIB_ARRAY_TYPE", nodecl.}: float
var WebGLRenderingContextVERTEX_SHADER* {.importc:"WebGLRenderingContext.VERTEX_SHADER", nodecl.}: float
var WebGLRenderingContextVIEWPORT* {.importc:"WebGLRenderingContext.VIEWPORT", nodecl.}: float
var WebGLRenderingContextZERO* {.importc:"WebGLRenderingContext.ZERO", nodecl.}: float
...
proc rotate*(self: WebKitCSSMatrix, angleX: float, angleY: float, angleZ: float) : WebKitCSSMatrix {.importcpp.}
proc rotateAxisAngle*(self: WebKitCSSMatrix, x: float, y: float, z: float, angle: float) : WebKitCSSMatrix {.importcpp.}
proc scale*(self: WebKitCSSMatrix, scaleX: float, scaleY: float, scaleZ: float) : WebKitCSSMatrix {.importcpp.}
...
proc translate*(self: WebKitCSSMatrix, x: float, y: float, z: float) : WebKitCSSMatrix {.importcpp.}
...
proc addEventListener*(self: WebSocket, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: WebSocket, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc initWheelEvent*(self: WheelEvent, typeArg: cstring, canBubbleArg: bool, cancelableArg: bool, viewArg: Window, detailArg: float, screenXArg: float, screenYArg: float, clientXArg: float, clientYArg: float, buttonArg: float, relatedTargetArg: EventTarget, modifiersListArg: cstring, deltaXArg: float, deltaYArg: float, deltaZArg: float, deltaMode: float) : void {.importcpp.}
var WheelEventDOM_DELTA_LINE* {.importc:"WheelEvent.DOM_DELTA_LINE", nodecl.}: float
var WheelEventDOM_DELTA_PAGE* {.importc:"WheelEvent.DOM_DELTA_PAGE", nodecl.}: float
var WheelEventDOM_DELTA_PIXEL* {.importc:"WheelEvent.DOM_DELTA_PIXEL", nodecl.}: float
...
proc addEventListener*(self: Worker, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: Worker, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: XMLHttpRequestUpload, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: XMLHttpRequestUpload, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
proc XMLHttpRequestUploadAddEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc:"XMLHttpRequestUpload.addEventListener".}
proc XMLHttpRequestUploadAddEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc:"XMLHttpRequestUpload.addEventListener".}
...
proc getResponseHeader*(self: XMLHttpRequest, header: cstring) : cstring {.importcpp.}
proc msCachingEnabled*(self: XMLHttpRequest) : bool {.importcpp.}
proc open*(self: XMLHttpRequest, xMethod: cstring, url: cstring, async: bool, user: cstring, password: cstring) : void {.importcpp.}
...
proc setRequestHeader*(self: XMLHttpRequest, header: cstring, value: cstring) : void {.importcpp.}
proc addEventListener*(self: XMLHttpRequest, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: XMLHttpRequest, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
var XMLHttpRequestDONE* {.importc:"XMLHttpRequest.DONE", nodecl.}: float
var XMLHttpRequestHEADERS_RECEIVED* {.importc:"XMLHttpRequest.HEADERS_RECEIVED", nodecl.}: float
...
proc serializeToString*(self: XMLSerializer, target: Node) : cstring {.importcpp.}

type XPathEvaluator* {.importc.} = ref object of RootObj
proc newXPathEvaluator*() : XPathEvaluator {.importcpp:"new XPathEvaluator".}
proc createExpression*(self: XPathEvaluator, expression: cstring, resolver: XPathNSResolver) : XPathExpression {.importcpp.}
proc createNSResolver*(self: XPathEvaluator, nodeResolver: Node) : XPathNSResolver {.importcpp.}
proc evaluate*(self: XPathEvaluator, expression: cstring, contextNode: Node, resolver: XPathNSResolver, xType: float, result: XPathResult) : XPathResult {.importcpp.}
...
proc removeParameter*(self: XSLTProcessor, namespaceURI: cstring, localName: cstring) : void {.importcpp.}
proc reset*(self: XSLTProcessor) : void {.importcpp.}
proc transformToDocument*(self: XSLTProcessor, source: Node) : Document {.importcpp.}
proc transformToFragment*(self: XSLTProcessor, source: Node, document: Document) : DocumentFragment {.importcpp.}

type AbstractWorker* {.importc.} = ref object of RootObj
proc addEventListener*(self: AbstractWorker, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: AbstractWorker, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: GlobalEventHandlers, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: GlobalEventHandlers, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc addEventListener*(self: MSBaseReader, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: MSBaseReader, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}

type MSFileSaver* {.importc.} = ref object of RootObj

type MSNavigatorDoNotTrack* {.importc.} = ref object of RootObj
proc confirmSiteSpecificTrackingException*(self: MSNavigatorDoNotTrack, args: ConfirmSiteSpecificExceptionsInformation) : bool {.importcpp.}
proc confirmWebWideTrackingException*(self: MSNavigatorDoNotTrack, args: ExceptionInformation) : bool {.importcpp.}
proc removeSiteSpecificTrackingException*(self: MSNavigatorDoNotTrack, args: ExceptionInformation) : void {.importcpp.}
proc removeWebWideTrackingException*(self: MSNavigatorDoNotTrack, args: ExceptionInformation) : void {.importcpp.}
proc storeSiteSpecificTrackingException*(self: MSNavigatorDoNotTrack, args: StoreSiteSpecificExceptionsInformation) : void {.importcpp.}
proc storeWebWideTrackingException*(self: MSNavigatorDoNotTrack, args: StoreExceptionsInformation) : void {.importcpp.}
...
proc getRandomValues*(self: RandomSource, array: ArrayBufferView) : ArrayBufferView {.importcpp.}
...
type SVGFilterPrimitiveStandardAttributes* {.importc.} = ref object of SVGStylable
    height* {.importc.}: SVGAnimatedLength
...
proc getTransformToElement*(self: SVGLocatable, element: SVGElement) : SVGMatrix {.importcpp.}
...
proc clearImmediate*(self: WindowTimersExtension, handle: float) : void {.importcpp.}
proc msClearImmediate*(self: WindowTimersExtension, handle: float) : void {.importcpp.}

type XMLHttpRequestEventTarget* {.importc.} = ref object of RootObj
proc addEventListener*(self: XMLHttpRequestEventTarget, xType: cstring, listener: EventListener, useCapture: bool) : void {.importcpp.}
proc addEventListener*(self: XMLHttpRequestEventTarget, xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importcpp.}
...
proc open*(url: cstring, target: cstring, features: cstring, replace: bool) : Window {.importc.}
...
proc webkitConvertPointFromNodeToPage*(node: Node, pt: WebKitPoint) : WebKitPoint {.importc.}

proc webkitConvertPointFromPageToNode*(node: Node, pt: WebKitPoint) : WebKitPoint {.importc.}

proc toString*() : cstring {.importc.}

proc addEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc.}
proc addEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc.}

proc dispatchEvent*(evt: Event) : bool {.importc.}

proc removeEventListener*(xType: cstring, listener: EventListener, useCapture: bool) : void {.importc.}
proc removeEventListener*(xType: cstring, listener: EventListenerObject, useCapture: bool) : void {.importc.}
...
proc WriteBlankLines*(self: TextStreamWriter, intLines: float) : void {.importcpp.}
...
proc testAssert*(condition: bool, message: cstring) : void {.importc.}

proc consoleLog*(message: cstring) : void {.importc.}

proc consoleError*(message: cstring) : void {.importc.}

proc float32Set*(a: Float32Array, k: float, v: float) : void {.importc.}

proc checkShader*(shader: WebGLShader) : void {.importc.}

proc checkProgram*(program: WebGLProgram) : void {.importc.}

var canvas* {.importc, nodecl.}: HTMLCanvasElement

var gl* {.importc, nodecl.}: WebGLRenderingContext

var drawCanvasCallback* {.importc, nodecl.}: proc () : void

proc resizeCanvas*() : void {.importc.}

proc animationLoop*() : void {.importc.}

proc startup*() : void {.importc.}
